...
public class BroadBandFirewallTest extends AutomaticsTestBase {
	...
	public void testToVerifyWantoLantrafficInCustomFirewall(Dut device) {
		...
		try {
			...
			LOGGER.info("STEP " + stepNumber
					+ ": ACTION : Execute set command for the following webpa params to set value to 'Custom', Device.X_CISCO_COM_Security.Firewall.FirewallLevelV6 ");
			LOGGER.info("STEP " + stepNumber
			...
			LOGGER.info("************************************************************************************");
			LOGGER.info("STEP " + stepNumber
					+ ": DESCRIPTION : Verify the Ping connection to the gateway IPv4 Address from WAN is successful before blocking ICMP IPv4 Traffic");
			LOGGER.info("STEP " + stepNumber
					+ ": ACTION : Execute the command from WAN(Jump Server): ping -c 4 <WAN IPv4> ");
			LOGGER.info(
					"STEP " + stepNumber + ": EXPECTED : Ping request to the gateway from WAN should be successful");
			LOGGER.info("************************************************************************************");
			...
			LOGGER.info("************************************************************************************");
			LOGGER.info("STEP " + stepNumber
					+ ": DESCRIPTION : Verify the Custom Secuirty is configured to 'Block ICMP' for IPv4 traffic");
			LOGGER.info("STEP " + stepNumber
					+ ": ACTION : Execute set command for the following webpa params to set value to 'true', Device.Firewall.X_RDKCENTRAL-COM_Security.V4.IPFloodDetect ");
			LOGGER.info("STEP " + stepNumber
					+ ": EXPECTED : Firewall Setting for IPv4 traffic should be set to 'Block ICMP' under Custom Security");
			LOGGER.info("************************************************************************************");
			...
			LOGGER.info("************************************************************************************");
			LOGGER.info("STEP " + stepNumber
					+ ": DESCRIPTION : Verify the Ping connection to the gateway IPv4 Address from WAN should fail when ICMP requests are blocked under Firewall settings");
			LOGGER.info("STEP " + stepNumber
					+ ": ACTION : Execute the command from WAN(Jump Server): ping -c 4 <WAN IPv4> ");
			...
			if (!(DeviceModeHandler.isFibreDevice(device) || DeviceModeHandler.isDSLDevice(device))) {
				...
				LOGGER.info("************************************************************************************");
				LOGGER.info("STEP " + stepNumber
						+ ": DESCRIPTION : Verify the Custom Secuirty is configured to 'Block ICMP' for IPv6 traffic");
				LOGGER.info("STEP " + stepNumber
						+ ": ACTION : Execute set command for the following webpa params to set value to 'true', Device.X_CISCO_COM_Security.Firewall.FilterAnonymousInternetRequestsV6 ");
				LOGGER.info("STEP " + stepNumber
						+ ": EXPECTED : Firewall Setting for IPv6 traffic should be set to 'Block ICMP' under Custom Security");
				LOGGER.info("************************************************************************************");
	...
	/**
	 * Verify security firewall paramaters are adding rules in iptables after
	 * enabled
	 * <ol>
	 * <li>Perform factory reset using Webpa</li>
	 * <li>Verify ipv4 fragmented security parameter is having default value using
	 * webpa</li>
	 * <li>Verify ipv4 Flood detect security parameter is having default value using
	 * webpa</li>
	 * <li>Verify ipv4 portscan security parameter is having default value using
	 * webpa</li>
	 * <li>Verify ipv6 fragmented security parameter is having default value using
	 * webpa</li>
	 * <li>Verify ipv6 Flood detect security parameter is having default value using
	 * webpa</li>
	 * <li>Verify ipv6 portscan security parameter is having default value using
	 * webpa</li>
	 ...
	 * <li>Verify iptables rules are removed for ipv4 fragmented security after
	 * disabled</li>
	 ...
	 * <li>Verify iptables rules are removed for ipv6 fragmented security after
	 * disabled</li>
	 ...
	 * <li>Verify the firewall setting is configured to 'Custom Security' for IPv6
	 * traffic.</li>
	 ...
	 * traffic.</li>
	 * <li>Verify whether the 'Block ICMP' for IPv6 traffic can be disabled.</li>
	 * <li>Verify the ICMPv6- Echo Reply or Response to the IPv6 Address of
	 * 'google.com' from WAN is successful with 'Block ICMP' disabled for IPv6
	 * traffic.</li>
	 * <li>Verify whether the firewall setting is configured to 'Typical Security'
	 * for IPv6 traffic.</li>
	 * <li>Verify the ICMPv6- Echo Reply or Response to the IPv6 Address of
	 * 'google.com' from WAN is successful with firewall 'Typical Security'.</li>
	 * <li>Verify the firewall setting is configured to 'Maximum Security' for IPv4
	 * traffic.</li>
	 * <li>Verify the ICMPv6- Echo Reply or Response to the IPv6 Address of
	 * 'google.com' from WAN is successful with firewall 'High'.</li>
	 * <li>Verify whether the firewall setting is configured to 'Minimum Security'
	 * for IPv4 traffic.</li>
	 * <li>Verify the ICMPv6- Echo Reply or Response to the IPv6 Address of
