...
public class BroadBandSecurityTest extends BroadBandWebUiBaseTest {
     ...
     * <li>Verify whether syscfg.db is available in /tmp and /opt/secure/data after FR</li>
     ...
     * <li>3. Check server.pem is present as soft link in /fss/gw/etc/Server.pem</li>
	...
	try {
	    ...
	    LOGGER.info("################### COMPLETED PRE-CONFIGURATIONS ###################");
	    /**
	     * Calling VerifyPresenceOfServerPemFile helper method to check the presence of server.pem
	     */
     ...
     * <li>Find the RFC log to verify the new value and old value of ForwardSSH.Enable. using webPA,
     * <li>Verify the current value of ForwardSSH.Enable is true</li>
     * <li>Verify whether Device is not accessible using forwardSSH. Wait for 10 mins to get the connection time out
     * response</li>
     * <li>Verify the /rdklogs/logs/FirewallDebug.txt log to find the ForwardSSH enabled logs</li>
     * </ol>
     * 
     * @author Dipankar Nalui
     * @refactor Athira
     ...
     * <li>using ReverseSSH, Find the RFC log to verify the new value and old value of ForwardSSH.Enable.</li>
     * <li>using webPA, Verify the current value of ForwardSSH.Enable is same as previous value</li>
     * </ol>
     * 
     * @author Dipankar Nalui
     * @refactor Athira
     ...
     * <li>S2) Verify CSRF Protection Module is not present in lighttpd.conf file.</li>
     ...
     * <li>using ReverseSSH, Find the RFC log to verify the new value and old value of ForwardSSH.Enable. Reboot the
     * device.</li>
     * <li>using webPA, verify the current value of ForwardSSH.Enable is false</li>
     * <li>Verify whether Device is accessible using forwardSSH. Wait for 10 mins to get the connection time out
     * response</li>
     * <li>using ReverseSSH, Verify the /rdklogs/logs/FirewallDebug.txt log to find the ForwardSSH disabled logs</li>
     * <li>using webPA, set ForwardSSH to True. Reboot the device and verify the device is accessible.</li>
     * 
     * @author Dipankar Nalui
     * @refactor Said Hisham
     * 
