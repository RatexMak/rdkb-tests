...
public class TelemetryLogUploadTest extends AutomaticsTestBase {
     ...
     * Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging.xOpsDMUploadLogsNow to False</li>
     * <li>S3) Verify retrieving the value of WebPA parameter
     * Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging.xOpsDMLogsUploadStatus to check final status</li>
     * </ol>
     *
	...
	try {
	     ...
	     * Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging. xOpsDMUploadLogsNow to False
	     */
	    stepNumber = "s2";
	    status = false;
	    LOGGER.info("##################################################################################");
	     ...
	     * Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging. xOpsDMLogsUploadStatus to check final status
	     */
	    stepNumber = "s3";
	    status = false;
	    LOGGER.info("##################################################################################");
     ...
     * <li>S2) Verify setting the value of WebPA parameter
     * Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging.xOpsDMUploadLogsNow to True</li>
     * <li>S3) Verify retrieving the value of WebPA parameter:
     * Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging.xOpsDMLogsUploadStatus to check the Triggered
     * state</li>
     * <li>S4) Verify retrieving the value of WebPA parameter:
     * Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging.xOpsDMLogsUploadStatus to check the In Progress
     * state</li>
     * <li>S5) Verify the log upload status in device rdklogs folder and grep the Log File name</li>
     * <li>S6) Verify retrieving the value of WebPA parameter
     * Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging.xOpsDMLogsUploadStatus and check the final state as
     * Complete</li>
	...
	try {
	    ...
	    /**
	     * S2: Verify setting the value of WebPA parameter
	     * Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging. xOpsDMUploadLogsNow to True
	     */
	    stepNumber = "s2";
	    status = false;
	    LOGGER.info("##################################################################################");
	     ...
	     * Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging. xOpsDMLogsUploadStatus to check the In
	     * Progress state
	     */
	    stepNumber = "s4";
	    status = false;
	     ...
	     * Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging. xOpsDMLogsUploadStatus and check the
	     * successful log uploaded date and time
	     */
	    ...
	    /**
	     * S6: Verify the log upload status in device rdklogs folder and grep the Log file name
	     */
	    stepNumber = "s6";
	    status = false;
	    LOGGER.info("##################################################################################");
     ...
     * 
     * 
     * Verify whether log upload fails after adding dns names in hosts entry and on removing the
     * dns names log upload should be successful
     *
     *
     * <p>
     * <ol>
     ...
     * state</li>
     * <li>S4) Verify retrieving the value of WebPA parameter:
     * Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging.xOpsDMLogsUploadStatus to check the Failed State</li>
     ...
     * Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging.xOpsDMLogsUploadStatus to check the Complete state</li>
     * </ol>
     *
     * @author Praveen Chandru
     * 
	...
	try {
	    ...
	    /**
	     * S5: Verify retrieving the value of WebPA parameter:
	     * Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging. xOpsDMLogsUploadStatus to check the Final
	     * state
	     */
     ...
     * 
     * 
     * Verify when setting UploadlogsNow snmp OID (1.3.6.1.4.1.17270.43.1.2.1.0) to False using
     * snmp, no upload happens
     *
     *
     * <p>
     * <ol>
     * <li>S1) Verify retrieving the value of
     * Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging.xOpsDMLogsUploadStatus using SNMP OID
     * (1.3.6.1.4.1.17270.43.1.2.2.0)</li>
     * <li>S2) Verify setting the value of Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging.xOpsDMUploadLogsNow
     * to False using SNMP OID *(1.3.6.1.4.1.17270.43.1.2.1.0)</li>
     * <li>S3) Verify retrieving the value of
     * Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging.xOpsDMLogsUploadStatus using SNMP OID
     * (1.3.6.1.4.1.17270.43.1.2.2.0) to check the final upload status</li>
     * </ol>
     *
	...
	try {
	    ...
	    /**
	     * S1: Verify retrieving the current value of Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging.
	    ...
	    /**
	     * S2: Verify setting the value of Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging.
	    ...
	    /**
	     * S3: Verify retrieving the value of Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging.
	     * xOpsDMLogsUploadStatus using SNMP OID (1.3.6.1.4.1.17270.43.1.2.2.0) to check the final upload status
	     */
	    stepNumber = "s3";
	    status = false;
	    LOGGER.info("##################################################################################");
    ...
    /**
     * 
     * Verify when setting UploadlogsNow snmp OID (1.3.6.1.4.1.17270.43.1.2.1.0) to True, logs
     * get uploaded
     *
     * <p>
     * <ol>
     ...
     * <li>S3) Verify retrieving the value of
     * Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging.xOpsDMLogsUploadStatus using SNMP OID
     * (1.3.6.1.4.1.17270.43.1.2.2.0) to check Triggered /In Progress State</li>
     * <li>S4) Verify the log upload status in device rdklogs folder and grep the Log File name</li>
     * <li>S5) Verify retrieving the value of
     * Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging.xOpsDMLogsUploadStatus using SNMP OID
     * (1.3.6.1.4.1.17270.43.1.2.2.0) to check the final upload status as Complete</li>
     ...
     * <li>Step 1 : Verify triggering CDL with Latest Firmware version(Latest GA Build) via TR-181/SNMP.</li>
     * <li>Step 2 : Verify checking the log file name with latest time and file upload successful (HTTP 200) from
     * Consolelog.txt.0/Armconsolelog.txt.0, within 30 mins of uptime.</li>
     * <li>Step 3 : Verify Rebooting the device and verify whether device comes up properly with all required process
     * </li>
     * <li>Step 4 : Verify checking the log file name with latest time and file upload successful (HTTP 200) from
     * Consolelog.txt.0/Armconsolelog.txt.0, within 30 mins of uptime.</li>
     * <li>Step 5 : Verify triggered CDL successfull with intial firmware version(Test Build)</li>
     * <li>Step 6 : Verify checking the log file name with latest time and file upload successful (HTTP 200) from
     * Consolelog.txt.0/Armconsolelog.txt.0, within 30 mins of uptime.</li>
     * <li>Step 7 : Verify Rebooting the device and verify whether device comes up properly with all required process
     * </li>
     * <li>Step 8 : Verify checking the log file name with latest time and file upload successful (HTTP 200) from
     * Consolelog.txt.0/Armconsolelog.txt.0, within 30 mins of uptime.</li>
     * <li>Post Condition 1 : Perform flashing the original build on the device.</li>
     * </ol>
     * 
     * @param device
     ...
     * <li>S3) Verify retrieving the value of
     * Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging.xOpsDMLogsUploadStatus using SNMP OID
     * (1.3.6.1.4.1.17270.43.1.2.2.0) to check Triggered State</li>
     * <li>S4) Verify retrieving the value of
     * Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging.xOpsDMLogsUploadStatus using SNMP OID
     * (1.3.6.1.4.1.17270.43.1.2.2.0) to check Failed State</li>
     * <li>S5) Verify removing the dns names in the host entry file</li>
     * <li>S6) Verify setting the value of Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging.xOpsDMUploadLogsNow
     * to True using SNMP OID (1.3.6.1.4.1.17270.43.1.2.1.0)</li>
     ...
     * Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging.xOpsDMLogsUploadStatus using SNMP OID
     * (1.3.6.1.4.1.17270.43.1.2.2.0) to check Complete State</li>
     * </ol>
     *
     * @author Praveen Chandru
     * @refactor yamini.s
	...
	try {
	    ...
	    /**
	     * S3: Verify retrieving the value of Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging.
	     * xOpsDMLogsUploadStatus using SNMP OID (1.3.6.1.4.1.17270.43.1.2.2.0) to check the status moved to
	     * Triggered State
	     */
	    stepNumber = "s3";
	    status = false;
	    ...
	    /**
	     * S4: Verify retrieving the value of Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging.
	     * xOpsDMLogsUploadStatus using SNMP OID (1.3.6.1.4.1.17270.43.1.2.2.0) to check the status moved to In
	     * Progress State
	     */
	    stepNumber = "s4";
	    status = false;
	    ...
	    /**
	     * S5: Verify retrieving the value of Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging.
	     * xOpsDMLogsUploadStatus using SNMP OID (1.3.6.1.4.1.17270.43.1.2.2.0) to check the status moved to Failed
	     * State
	     */
	    ...
	    /**
	     * S7: Verify setting the value of Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging.
	     * xOpsDMUploadLogsNow to True using SNMP OID *(1.3.6.1.4.1.17270.43.1.2.1.0)
	     */
	    stepNumber = "s7";
	    status = false;
	    ...
	    /**
	     * S8: Verify retrieving the value of Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging.
	     * xOpsDMLogsUploadStatus using SNMP OID (1.3.6.1.4.1.17270.43.1.2.2.0) to check the status moved to
	     * Triggered State
	     */
	    stepNumber = "s8";
	    ...
	    /**
	     * S9: Verify retrieving the value of Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging.
	     * xOpsDMLogsUploadStatus using SNMP OID (1.3.6.1.4.1.17270.43.1.2.2.0) to check the status moved to In
	     * Progress State
	     */
	    stepNumber = "s9";
	    ...
	    /**
	     * S10: Verify retrieving the value of Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging.
	     * xOpsDMLogsUploadStatus using SNMP OID (1.3.6.1.4.1.17270.43.1.2.2.0) to check the status moved to
	     * Complete State
	     */
	    stepNumber = "s10";
