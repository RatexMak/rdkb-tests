...
public class BroadBandWiFiConnectedClientTests extends AutomaticsTestBase {
    ...
    /**
     * This test case is to Verify the controlled user access (Deny) for 2.4GHZ against different MAC addresses by way
     * of MAC ACLs
     * 
     * <ol>
     * <li>STEP 1: Getting the Wifi Mac address of Connected client having 2.4GHZ wifi Capability.</li>
     * <li>STEP 2: Verify and add the device wifi Mac address in the MAC Filter list by using WEBPA command.</li>
     * <li>STEP 3: Verify the TR-181 parameter 'Device.WiFi.AccessPoint.10001.X_CISCO_COM_MACFilter.Enable' as true
     * using Webpa.</li>
     * <li>STEP 4: Verify whether the MAC Filtering mode is configured as 'Deny' by setting TR-181 parameter
     * 'Device.WiFi.AccessPoint.10001.X_CISCO_COM_MACFilter.FilterAsBlackList' as 'true' using WebPA for 2.4GHZ.</li>
     * <li>STEP 5:verify getting the Configured MAC Filter Mode by using this TR-181parameter
     * 'Device.WiFi.AccessPoint.10001.X_COMCAST-COM_MAC_FilteringMode'</li>
     * <li>STEP 6: Connect the connected client device whose wifi Mac address is added in the MAC Filter to 2.4 GHz SSID
     * and verify connection status</li>
     * <li>STEP 7: Verify whether interface did'nt get the correct IPv4 address.</li>
     * <li>STEP 8 : Verify whether interface did'nt get the correct IPv6 address.</li>
     * <li>STEP 9: Verify whether there is no connectivity using that particular interface using IPV4</li>
     * <li>STEP 10: Verify whether there is no connectivity using that particular interface using IPV6</li>
     * <li>STEP 11: Connect the connected client device whose wifi Mac address is not added in the MAC Filter to 2.4 GHz
     * SSID and verify connection status</li>
     * <li>STEP 12 :Verify whether interface got the correct IPv4 address</li>
     * <li>STEP 13 :Verify whether interface got the correct IPv6 address</li>
     * <li>STEP 14 :Verify whether you have connectivity using that particular interface using IPV4</li>
     * <li>STEP 15 :Verify whether you have connectivity using that particular interface using IPV6</li>
     * </ol>
     * 
     * @param device
     *            Dut to be used
	...
	try {
	    ...
	    /**
	     * STEP 3:Verify the TR-181 parameter "Device.WiFi.AccessPoint.10001.X_CISCO_COM_MACFilter.Enable" as true
	     * using Webpa.
	     */
	    status = false;
	    stepNumber++;
	    ...
	    /**
	     * STEP 4:Verify whether MAC Filtering mode is configured as "Deny" by setting TR-181 parameter
	     * "Device.WiFi.AccessPoint.10001.X_CISCO_COM_MACFilter.FilterAsBlackList" as "true" using WebPA for 2.4GHZ.
	     */
	    status = false;
	    stepNumber++;
	    stepNum = "S" + stepNumber;
	    ...
	    /**
	     * STEP 6:Connect the connected client device whose wifi Mac address is added in the MAC Filter to 2.4 GHz
	     * SSID and verify connection status
	     */
	    status = false;
	    stepNumber++;
	    ...
	    /**
	     * STEP 9:Verify whether there is no connectivity using that particular interface using IPV4.
	     */
	    status = false;
	    stepNumber++;
	    stepNum = "S" + stepNumber;
	    ...
	    /**
	     * STEP 12-15 : VERIFY THE CORRECT IPV4 AND IPV6 ADDRESS FOR CLIENT CONNECTED WITH PRIVATE WIFI 5 GHZ AND
	     * INTERNET CONNECTIVITY USING IPV4 AND IPV6 INTERFACE.
	     */
	    stepNumber++;
	    stepNum = "S" + stepNumber;
    ...
    /**
     * This test case is to Verify the controlled user access (Deny) for 5GHZ against different MAC addresses by way of
     * MAC ACLs
     * 
     * <ol>
     * <li>STEP 1: Getting the Wifi Mac address of Connected client having 5GHZ wifi Capability.</li>
     * <li>STEP 2: Verify and add the device wifi Mac address in the MAC Filter list by using WEBPA command.</li>
     * <li>STEP 3: Verify the TR-181 parameter 'Device.WiFi.AccessPoint.10101.X_CISCO_COM_MACFilter.Enable' as true
     * using Webpa.</li>
     * <li>STEP 4: Verify whether the MAC Filtering mode is configured as 'Deny' by setting TR-181 parameter
     * 'Device.WiFi.AccessPoint.10101.X_CISCO_COM_MACFilter.FilterAsBlackList' as 'true' using WebPA for 5GHZ.</li>
     * <li>STEP 5:verify getting the Configured MAC Filter Mode by using this TR-181parameter
     * 'Device.WiFi.AccessPoint.10101.X_COMCAST-COM_MAC_FilteringMode'</li>
     * <li>STEP 6: Connect the connected client device whose wifi Mac address is added in the MAC Filter to 5GHz SSID
     * and verify connection status</li>
     * <li>STEP 7: Verify whether interface did'nt get the correct IPv4 address.</li>
     * <li>STEP 8 : Verify whether interface did'nt get the correct IPv6 address.</li>
     * <li>STEP 9: Verify whether there is no connectivity using that particular interface using IPV4</li>
	...
	try {
	    ...
	    /**
	     * STEP 3:Verify the TR-181 parameter "Device.WiFi.AccessPoint.10101.X_CISCO_COM_MACFilter.Enable" as true
	     * using Webpa.
	     */
	    status = false;
	    stepNumber++;
	    ...
	    /**
	     * STEP 4:Verify whether MAC Filtering mode is configured as "Deny" by setting TR-181 parameter
	     * "Device.WiFi.AccessPoint.10101.X_CISCO_COM_MACFilter.FilterAsBlackList" as "true" using WebPA for 2.4GHZ.
	     */
	    status = false;
	    stepNumber++;
	    stepNum = "S" + stepNumber;
    ...
    /**
     * Test Case : Verify Connecting Multiple Clients to the Gateway device via Wi-Fi network and check the internet
     * connectivity and Validate the status of Wi-Fi Radio and current Wi-Fi channel for 2.4 and 5 Ghz.
     *
     * <p>
     * STEPS:
     * </p>
     ...
     * <li>S5 Connect the client 1 to 2.4 GHz Private Wi-Fi Network and verify connection status</li>
     * <li>S6 Verify number of clients associated with 2.4 GHz using webpa</li>
     * <li>S7 Verify the client mac address and connection type connected with 2.4 GHz in LM.txt.0 log file</li>
     * <li>S8 Verify the connected clients details are IP and MAC in Gateway</li>
     * <li>S9 Verify the correct IPv4 address for client connected with 2.4 GHz SSID</li>
     * <li>S10 Verify the correct IPv6 address for client connected with 2.4 GHz SSID</li>
     * <li>S11 Verify whether have connectivity using that particular interface using IPV4 for client connected with 2.4
     * GHz</li>
     * <li>S12 Verify whether have connectivity using that particular interface using IPV6 for client connected with 2.4
     * GHz</li>
     * <li>S13 Connect the client 2 to 5 GHz Private Wi-Fi Network and verify connection status</li>
     * <li>S14 Verify number of clients associated with 5 GHz using webpa</li>
     * <li>S15 Verify the client mac address and connection type connected with 5 GHz in LM.txt.0 log file</li>
     * <li>S16 Verify the connected clients details are IP and MAC in Gateway</li>
     * <li>S17 Verify the correct IPv4 address for client connected with 5 GHz SSID</li>
     * <li>S18 Verify the correct IPv6 address for client connected with 5 GHz SSID</li>
     * <li>S19 Verify whether have connectivity using that particular interface using IPV4 for client connected with 5
     * Ghz</li>
     * <li>S20 Verify whether have connectivity using that particular interface using IPV6 for client connected with 5
     * Ghz</li>
     * <li>S21 Verify client 3 to ethernet with ethernet</li>
     * <li>S22 Verify the client mac address and connection type connected with ethernet in LM.txt.0 log file</li>
     * <li>S23 Verify the IPv4 Address is retrieved from the client connected with Ethernet</li>
     * <li>S24 Verify the IPv6 Address is retrieved from the client connected with Ethernet</li>
     * <li>S25 Verify whether have connectivity using that particular interface using IPV4 for client connected with
     * ethernet</li>
     * <li>S26 Verify whether have connectivity using that particular interface using IPV6 for client connected with
     * ethernet</li>
     *
     * @author Muthukumar
     * @refactor Athira
	...
	try {
	    ...
	    /**
	     * SETP 7 : VERIFY THE CLIENT MAC ADDRESS AND CONNECTION TYPE CONNECTED IN /rdklogs/logs/LM.txt.0 LOG
	     */
	    stepNumber++;
	    testStepNumber = "S" + stepNumber;
	    status = false;
	    ...
	    /**
	     * SETP 15 VERIFY THE CLIENT MAC ADDRESS AND CONNECTION TYPE CONNECTED IN /rdklogs/logs/LM.txt.0 LOG
	     */
	    stepNumber++;
	    testStepNumber = "S" + stepNumber;
	    status = false;
	    ...
	    /**
	     * SETP 22 VERIFY THE CLIENT MAC ADDRESS AND CONNECTION TYPE CONNECTED IN /rdklogs/logs/LM.txt.0 LOG
	     */
	    stepNumber++;
	    testStepNumber = "S" + stepNumber;
	    status = false;
    ...
    /**
     * Method to VERIFY THE CLIENT MAC ADDRESS AND CONNECTION TYPE CONNECTED IN /rdklogs/logs/LM.txt.0 LOG
     * 
     * @param device
     *            {@link Dut}
     * @param testId
     ...
     * @param tapEnv
     *            instance of {@link AutomaticsTapApi}
     * @param connectionTypeLog
     *            Client Connection Type log message
     * @param hostMacAddress
     *            Client Mac Address
     * @param pollDuration
     *            Duration to verify the logs
	...
	try {
		...
		LOGGER.info("POST-CONDITION STEPS");
		/**
		 * POST CONDITION 1 : Remove wifi monitor debug file from /nvram and /tmp directory
		 */
		LOGGER.info("#######################################################################################");
		LOGGER.info(
    ...
    /**
     *
     * Test Case : Verify Private WiFi channel selection (ACS) should remain same post MESH enabled or disabled
     *
     * <p>
     * STEPS:
     * </p>
     * <ol>
     * 
     * <li>PRE CONDITION 1 : Perform Factory reset and reactivate device if any of the ACS initial status is
     * disabled</li>
     * <li>PRE CONDITION 2 : Verify 2.4 GHz SSID is enabled.</li>
     * <li>PRE CONDITION 3 : Verify 5 GHz SSID is enabled.</li>
     * <li>PRE CONDITION 4 : Verify the private wifi 2.4 ghz and 5 ghz ssid's are broadcasting in connected client.</li>
     * <li>Step 1 : Verify mesh is enabled using TR181 parameter,if not enable wifi mesh service using tr181
     * parameter</li>
     * <li>Step 2 : Verify the Automatic channel selection mode for wifi 2.5 ghz as true.</li>
     * <li>Step 3 : Verify the Automatic channel selection mode for wifi 5 ghz as true.</li>
     * <li>Step 4 : Verify ACS status using Wi-Fi driver level commands</li>
     * <li>Step 5 : Disable Mesh using TR181 parameter</li>
     * <li>Step 6 : Verify the Automatic channel selection mode for wifi 2.5 ghz as true even when mesh is disabled</li>
     * <li>Step 7 : Verify the Automatic channel selection mode for wifi 5 ghz as true even when mesh is disabled</li>
     * <li>Step 8 : Verify ACS status using Wi-Fi driver level commands</li>
     * <li>Step 9 : Verify mesh disable persist</li>
     * <li>Step 10 : Verify mesh is enabled using TR181 parameter,if not enable wifi mesh service using tr181
     * parameter</li>
     * <li>Step 11 :Verify the Automatic channel selection mode for wifi 2.5 ghz as true</li>
     * <li>Step 12 : Verify the Automatic channel selection mode for wifi 5 ghz as true</li>
     * <li>Step 13 : Verify ACS status using Wi-Fi driver level commands</li>
     * <li>Step 14 : Connect the client to 2.4 GHz Private Wi-Fi Network and verify connection status</li> LOGGER.info(
     * <li>Step 15 : Verify the correct IPv4 address for client connected with 2.4 GHz SSID</li>
     * <li>Step 16 : Verify the correct IPv6 address for client connected with 2.4 GHz SSID</li>
     * <li>Step 17 : Verify whether have connectivity using that particular interface using IPV4 for client connected
     * with 2.4 GHz</li>
     * <li>Step 18 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 2.4 Ghz</li>
     * <li>Step 19 : Connect the connected client in the setup to 5 GHz SSID and verify connection status.</li>
     ...
     * with 5 Ghz.</li>
     * <li>POST-CONDITION 1 : Verify disconnecting the client connected with in the setup.</li>
     * <li>POST-CONDITION 2 : Revert the default wifi mesh status and automatic channel mode.</li>
     * 
     * 
     * </ol>
     * 
	...
	try {
	    ...
	    /**
	     * PRE-CONDITION 2-3 : VERIFY THE PRIVATE WIFI 2.4 GHZ AND 5 GHZ SSID'S ARE ENABLED
	     */
	    preConStepNumber++;
	    ...
	    /**
	     * Step 1-4 : Check ACS status using webpa and wifi driver commands after enabling mesh.
	     */
	    checkACSBasedOnMeshStatus(device, tapEnv, BroadBandTestConstants.TRUE, testCaseId,
		    BroadBandTestConstants.CONSTANT_0);
	    /**
	     * Step 5-8 : Check ACS status using webpa and wifi driver commands after disabling mesh.
	     */
	    ...
	    /**
	     * Step 10-13 : Check ACS status using webpa and wifi driver commands after enabling mesh.
	     */
	    checkACSBasedOnMeshStatus(device, tapEnv, BroadBandTestConstants.TRUE, testCaseId,
		    BroadBandTestConstants.CONSTANT_9);

	    /**
	     * Step 14 : CONNECT THE CONNECTED CLIENT IN THE SETUP TO 2.4 GHZ SSID AND VERIFY CONNECTION STATUS AFTER
	     * FIRMWARE UPGRADE
	     */
	    ...
	    /**
	     * SETP 15- 18 : VERIFY THE CORRECT IPV4 AND IPV6 ADDRESS FOR CLIENT CONNECTED WITH 2.4GHZ AND INTERNET
	    ...
	    /**
	     * Step 19 : CONNECT THE CONNECTED CLIENT IN THE SETUP TO 5 GHZ SSID AND VERIFY CONNECTION STATUS AFTER
	     * FIRMWARE UPGRADE
	     */
	    stepNumber = 19;
	    BroadBandWiFiUtils.executeTestStepToConnectPrivateWiFi(device, testCaseId, ssidVisibleDeviceOne,
	    ...
	    /**
	     * SETP 20- 23 : VERIFY THE CORRECT IPV4 AND IPV6 ADDRESS FOR CLIENT CONNECTED WITH 5GHZ AND INTERNET
	     * CONNECTIVITY USING IPV4 AND IPV6 INTERFACE.
	     */
	    stepNumber++;
	    BroadBandWiFiUtils.verifyIpv4AndIpV6ConnectionInterface(device, testCaseId, ssidVisibleDeviceOne,
	    ...
	    /**
	     * POST CONDITION : REVERT THE DEFAULT WIFI MESH STATUS AND AUTOMATIC CHANNEL MODE.
	     */
	    postConStepNumber++;
	    status = false;
	    LOGGER.info("#######################################################################################");
	...
	/**
	 * STEP : SET AND VERIFY THE AUTOMATIC CHANNEL SELECTION MODE FOR WIFI 5 GHZ AS TRUE.
	 */
	stepNumber++;
	acsStep = "S" + stepNumber;
	status = false;
