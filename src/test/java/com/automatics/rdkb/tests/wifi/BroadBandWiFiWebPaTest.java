...
public class BroadBandWiFiWebPaTest extends AutomaticsTestBase {
	 ...
	 * 
	 * <ol>
	 * <li>STEP 1:Execute webPA Get command on
	 * Device.WiFi.AccessPoint.10101.Security.ModeEnabled to get the current
	 * mode</li>
	 * 
	 * <li>STEP 2:Execute WebPA command to Set on all the valid security mode
	 * parameter and validate whether they are set correctly</li>
	 * 
	 * <li>STEP 3:Verify whether device logs the telemetry marker for security mode
	 * change</li>
	 * 
	 * <li>STEP 4 :Execute WebPA command to Set the current security mode and
	 * validate whether they are set correctly</li>
	 * 
	 * <li>STEP 5:Verify whether device logs the telemetry marker for current
	 * security mode change</li>
	 * </ol>
	 *
	 * @Refactor Athira
	 ...
	 * <ol>
	 * <li>STEP 1:Execute webPA Get command on
	 * Device.WiFi.AccessPoint.10102.Security.ModeEnabled to get the current
	 * mode</li>
	 * 
	 * <li>STEP 2:Execute WebPA command to Set on all the valid security mode
	 * parameter and validate whether they are set correctly</li>
	 ...
	 * <ol>
	 * <li>STEP 1:Execute webPA Get command on
	 * Device.WiFi.AccessPoint.10001.Security.ModeEnabled to get the current
	 * mode</li>
	 * 
	 * <li>STEP 2:Execute WebPA command to Set on all the valid security mode
	 * parameter and validate whether they are set correctly</li>
	 ...
	 * <ol>
	 * <li>STEP 1:Execute webPA Get command on
	 * Device.WiFi.AccessPoint.10002.Security.ModeEnabled to get the current
	 * mode</li>
	 * 
	 * <li>STEP 2:Execute WebPA command to Set on all the valid security mode
	 * parameter and validate whether they are set correctly</li>
	 ...
	 * <ol>
	 * <li>STEP 1:Execute webPA Get command on
	 * Device.WiFi.AccessPoint.10003.Security.ModeEnabled to get the current
	 * mode</li>
	 * 
	 * <li>STEP 2:Execute WebPA command to Set on all the valid security mode
	 * parameter and validate whether they are set correctly</li>
	...
	/**
	 * This test case checks the SSID on 5Ghz Private network by comparing the
	 * output from WebPA with the output from the device
	 * <ol>
	 * <li>STEP 1:Execute the TR-181 parameter-Device.WiFi.SSID.10101.SSID to
	 * retrieve 5GHz Private SSID name by WebPA.</li>
	 * 
	 * <li>STEP 2:Verify whether the system command provides the 5GHz private SSID
	 * name and verify whether it is matching with the WebPA response</li>
	 * </ol>
	 * 
	 * @param device Device to be used
	 * @Refactor Alan_Bivera
	...
	public void testValidateSsidNameFor5GhzPrivateNetwork(Dut device) {
		...
		try {
			...
			/**
			 * STEP 1:Execute the TR-181 parameter-Device.WiFi.SSID.10101.SSID to retrieve
			 * 5GHz Private SSID name by WebPA.
			 */
			...
			/**
			 * STEP 2:Verify whether the system command provides the 5GHz private SSID name
			 * and verify whether it is matching with WebPA response
			 */
	...
	/**
	 * This test case checks the SSID on 5Ghz Public network by comparing the output
	 * from webpa with the output from the device
	 * <ol>
	 * <li>STEP 1:Execute the TR-181 parameter-Device.WiFi.SSID.10103.SSID to
	 * retrieve 5GHz Public SSID name by WebPA</li>
	 * 
	 * <li>STEP 2:Verify whether the system command provides the 5GHz Public SSID
	 * name and verify whether it is matching with WebPA response.</li>
	 * </ol>
	 * 
	 * @param device Device to be used
	 * @Refactor Alan_Bivera
	...
	public void testValidateSsidNameFor5GhzPublicNetwork(Dut device) {
		...
		try {
			...
			/**
			 * PRECONDITION 1 :Setting the Public wifi parameters and enabling the Public
			 * Wifi.
			 */
			LOGGER.info("#####################################################################################");
			...
			/**
			 * STEP 1:Execute the TR-181 parameter-Device.WiFi.SSID.10103.SSID to retrieve
			 * 5GHz Public SSID name by WebPA
			 */
			...
			status = CommonMethods.isNotNull(ssidNameFromWebPa) && ssidNameFromWebPa.equalsIgnoreCase(
			...
			/**
			 * STEP 2:Verify whether the system command provides the 5GHz Public SSID name
			 * and verify whether it is matching with WebPA response.
			 */
			testStepNumber = "s2";
			status = false;
	...
	/**
	 * This test case checks the SSID on 2.4Ghz Private network by comparing the
	 * output from webpa with the output from from device
	 * <ol>
	 * <li>STEP 1:Execute the TR-181 parameter-Device.WiFi.SSID.10001.SSID to
	 * retrieve 2.4GHz Private SSID name by WebPA</li>
	 * 
	 * <li>STEP 2:Verify whether the system command provides the 2.4GHz private SSID
	 * name and verify whether it is matching with WebPA response.</li>
	 * </ol>
	 * 
	 * @param device Device to be used
	...
	public void testValidateSsidNameFor2_4GhzPrivateNetwork(Dut device) {
		...
		try {
			...
			/**
			 * STEP 1:Execute the TR-181 parameter-Device.WiFi.SSID.10001.SSID to retrieve
			 * 2.4GHz Private SSID name by WebPA
			 */
			tapEnv.waitTill(BroadBandTestConstants.ONE_MINUTE_IN_MILLIS);
			status = false;
			LOGGER.info("#####################################################################################");
			...
			tapEnv.updateExecutionStatus(device, testId, testStepNumber, status, errorMessage, true);
			/**
			 * STEP 2:Verify whether the system command provides the 2.4GHz private SSID
			 * name and matching with WebPA response.
			 */
			testStepNumber = "s2";
			status = false;
			LOGGER.info("#####################################################################################");
	...
	/**
	 * This test case checks the SSID on 2.4Ghz Public network by comparing the
	 * output from webpa with the output from the device
	 * <ol>
	 * <li>STEP 1:Execute the TR-181 parameter-Device.WiFi.SSID.10003.SSID to
	 * retrieve 2.4GHz Public SSID name by WebPA</li>
	 * 
	 * <li>STEP 2:Verify whether the system command provides the 2.4GHz Public SSID
	 * name and matching with WebPA response.</li>
	 * </ol>
	 * 
	 * @param device Device to be used
	 * @Refactor Alan_Bivera
	...
	public void testValidateSsidNameFor2_4GhzPublicNetwork(Dut device) {
		...
		try {
			/**
			 * PRECONDITION 1 :Setting the configuration parameters and enabling Public Wifi
			 * 2.4 GHZ.
			 */
			LOGGER.info("#####################################################################################");
			...
			/**
			 * STEP 1:Execute the TR-181 parameter-Device.WiFi.SSID.10003.SSID to retrieve
			 * 2.4GHz Public SSID name by WebPA.
			 */
			tapEnv.waitTill(BroadBandTestConstants.THREE_MINUTE_IN_MILLIS);
			status = false;
			LOGGER.info("#####################################################################################");
			...
			tapEnv.updateExecutionStatus(device, testId, testStepNumber, status, errorMessage, true);
			/**
			 * STEP 2:Verify whether the system command provides the 2.4GHz Public SSID name
			 * and matching with WebPA response.
			 */
			testStepNumber = "s2";
			status = false;
			LOGGER.info("#####################################################################################");
	...
	/**
	 * This test case checks the MAC Address on 5Ghz Private network by comparing
	 * the output from webpa with the output from device
	 * 
	 * <ol>
	 * <li>STEP 1:Execute the TR-181 parameter-Device.WiFi.SSID.10101.MACAddress to
	 * retrieve 5GHz Private MACAddress by WebPA</li>
	 * 
	 * <li>STEP 2:Verify whether the system command provides the 5Ghz Private MAC
	 * Address and matching with WebPA response.</li>
	 * </ol>
	 * 
	 * @param device Device to be used
	 * @Refactor Alan_Bivera
	...
	public void testValidateMacAddresssFor5GhzPrivateNetwork(Dut device) {
		...
		try {
			...
			/**
			 * STEP 1:Execute the TR-181 parameter-Device.WiFi.SSID.10101.MACAddress to
			 * retrieve 5GHz Private MACAddress by WebPA
			 * 
			 */
			tapEnv.waitTill(BroadBandTestConstants.ONE_MINUTE_IN_MILLIS);
			status = false;
			...
			//
			/**
			 * STEP 2:Verify whether the system command provides the 5Ghz Private MAC
			 * Address and matching with WebPA response.
			 */
	...
	/**
	 * This test case checks the MAC Address on 5Ghz Public network by comparing the
	 * output from webpa with the output from the device
	 * <ol>
	 * <li>STEP 1:Execute the TR-181 parameter-Device.WiFi.SSID.10103.MACAddress to
	 * retrieve 5GHz Public MACAddress by WebPA</li>
	 * 
	 * <li>STEP 2:Verify whether the system command provides the 5Ghz Public wifi
	 * MAC Address and matching with WebPA response.</li>
	 * </ol>
	 * 
	 * @param device Device to be used
	 * @Refactor Alan_Bivera
	...
	public void testValidateMacAddresssFor5GhzPublicNetwork(Dut device) {
		...
		try {
			...
			/**
			 * STEP 1:Execute the TR-181 parameter-Device.WiFi.SSID.10103.MACAddress to
			 * retrieve 5GHz Public MACAddress by WebPA
			 */
			tapEnv.waitTill(BroadBandTestConstants.THREE_MINUTE_IN_MILLIS);
			status = false;
			LOGGER.info("#####################################################################################");
			...
			tapEnv.updateExecutionStatus(device, testId, testStepNumber, status, errorMessage, true);
			/**
			 * STEP 2:Verify whether the system command provides the 5Ghz Public wifi MAC
			 * Address and matching with WebPA response
			 */
			testStepNumber = "s2";
			status = false;
	...
	/**
	 * This test case checks the MAC Address on 2.4Ghz Private network by comparing
	 * the output from webpa with the output from the device *
	 * <ol>
	 * <li>STEP 1:Execute the TR-181 parameter-Device.WiFi.SSID.10001.MACAddress to
	 * retrieve 2.4GHz Private MACAddress by WebPA</li>
	 * 
	 * <li>STEP 2:Verify whether the system command provides the 2.4Ghz Private MAC
	 * Address and matching with WebPA response.</li>
	 * </ol>
	 * 
	 * @param device Device to be used
	...
	public void testValidateMacAddresssFor2_4GhzPrivateNetwork(Dut device) {
		...
		try {
			...
			/**
			 * STEP 1:Execute the TR-181 parameter-Device.WiFi.SSID.10001.MACAddress to
			 * retrieve 2.4GHz Private MACAddress by WebPA.
			 */
			tapEnv.waitTill(BroadBandTestConstants.ONE_MINUTE_IN_MILLIS);
			status = false;
			LOGGER.info("#####################################################################################");
			...
			tapEnv.updateExecutionStatus(device, testId, testStepNumber, status, errorMessage, true);
			/**
			 * STEP 2:Verify whether the system command provides the 2.4Ghz Private MAC
			 * Address and matching with WebPA response.
			 */
			testStepNumber = "s2";
			status = false;
	...
	/**
	 * This test case checks the MAC Address on 2.4Ghz Public network by comparing
	 * the output from webpa with the output from the device
	 * <ol>
	 * <li>STEP 1:Execute the TR-181 parameter-Device.WiFi.SSID.10003.MACAddress to
	 * retrieve 2.4GHz Public MACAddress by WebPA</li>
	 * 
	 * <li>STEP 2:Verify whether the system command provides the 2.4Ghz Public wifi
	 * MAC Address and matching with WebPA response.</li>
	 * </ol>
	 * 
	 * @param device Device to be used
	...
	public void testValidateMacAddresssFor2_4GhzPublicNetwork(Dut device) {
		...
		try {
			...
			/**
			 * STEP 1:Execute the TR-181 parameter-Device.WiFi.SSID.10003.MACAddress to
			 * retrieve 2.4GHz Public MACAddress by WebPA
			 */
			tapEnv.waitTill(BroadBandTestConstants.THREE_MINUTE_IN_MILLIS);
			status = false;
			LOGGER.info("#####################################################################################");
			...
			tapEnv.updateExecutionStatus(device, testId, testStepNumber, status, errorMessage, true);
			/**
			 * STEP 2:Verify whether the system command provides the 2.4Ghz Public wifi MAC
			 * Address and matching with WebPA response.
			 */
			testStepNumber = "s2";
			status = false;
	...
	/**
	 * This test case checks the validation of SSID Enable/Disble from device side
	 * for 5Ghz Private interface
	 * 
	 * <ol>
	 * <li>STEP 1:Disable the SSID of 5Ghz Private Interface and verify the same
	 * from device side</li>
	 * 
	 * <li>STEP 2:Enable the SSID of 5Ghz Private Interface and verify the same from
	 * device side</li>
	 * </ol>
	 * 
	 * @param device Device to be used
	...
	public void testValidateSsidEnabledOn5GhzPrivateInterface(Dut device) {
		...
		try {
			...
			/**
			 * STEP 2:Enable the SSID of 5Ghz Private Interface and verify the same from
			 * device side
			 */
	...
	/**
	 * This test case checks the validation of SSID Enable/Disble from device side
	 * for 5Ghz Public interface
	 * 
	 * <ol>
	 * <li>STEP 1:Enable the SSID of 5Ghz Public Interface and verify the same from
	 * device side</li>
	 * 
	 * <li>STEP 2:Disable the SSID of 5Ghz Public Interface and verify the same from
	 * device side</li>
	 * </ol>
	 * 
	 * @param device Device to be used
	...
	public void testValidateSsidEnabledOn5GhzPublicInterface(Dut device) {
		...
		try {
			...
			/**
			 * STEP 1:Enable the SSID of 5Ghz Public Interface and verify the same from
			 * device side
			 */
			status = false;
			LOGGER.info("#####################################################################################");
			...
			/**
			 * STEP 2:Disable the SSID of 5Ghz Public Interface and verify the same from
			 * device side
			 */
	...
	/**
	 * This test case checks the SSIDAdvertisementEnabled on 2.4Ghz Private network
	 * by WebPA and verifies by SNMP
	 * 
	 * <ol>
	 * <li>STEP 1:Disable the TR181 parameter
	 * Device.WiFi.AccessPoint.10001.SSIDAdvertisementEnabled by setting value as
	 * false and verify the assigned value using WebPA get command</li>
	 * 
	 * <li>STEP 2:Retrieve the value using SNMP
	 * command(1.3.6.1.4.1.17270.50.2.2.2.1.1.5.10001) and cross checked that we are
	 * getting actual value '1' for false.</li>
	 * 
	 * <li>STEP 3:Enable the TR181 parameter
	 * Device.WiFi.AccessPoint.10001.SSIDAdvertisementEnabled by setting value as
	 * true and verify the assigned value using WebPA get command</li>
	 * 
	 * <li>STEP 4:Retrieve the value using SNMP
	 * command(1.3.6.1.4.1.17270.50.2.2.2.1.1.5.10001) and cross checked that we are
	 * getting actual value '2' for true.
	 * </ol>
	 * 
	 * @param device Device to be used
	 * @Refactor Alan_Bivera
	...
	public void testValidateSSIDAdvertisementEnabledFor2_4GhzPrivateNetwork(Dut device) {
		...
		try {
			...
			/**
			 * STEP 1:Disable the TR181 parameter
			 * Device.WiFi.AccessPoint.10001.SSIDAdvertisementEnabled by setting value as
			 * false and verify the assigned value using WebPA get command
			 */
			status = false;
			LOGGER.info("#####################################################################################");
			LOGGER.info(
			...
			/**
			 * STEP 2:Retrieve the value using SNMP
			 * command(1.3.6.1.4.1.17270.50.2.2.2.1.1.5.10001) and cross verify that we are
			 * getting actual value '1' for false.
			 * 
			 */
			...
			/**
			 * STEP 3:Enable the TR181 parameter
			 * Device.WiFi.AccessPoint.10001.SSIDAdvertisementEnabled by setting value as
			 * true and verify the assigned value using WebPA get command
			 */
			tapEnv.waitTill(BroadBandTestConstants.ONE_MINUTE_IN_MILLIS);
			testStepNumber = "s3";
			status = false;
			...
			/**
			 * STEP 4:Retrieve the value using SNMP
			 * command(1.3.6.1.4.1.17270.50.2.2.2.1.1.5.10001) and cross verify that we are
			 * getting actual value '2' for true.
			 * 
			 */
	...
	/**
	 * This test case checks the SSIDAdvertisementEnabled on 5Ghz Private network by
	 * WebPA and verifies by SNMP
	 * 
	 * <ol>
	 * <li>STEP 1:Disable the TR181 parameter
	 * Device.WiFi.AccessPoint.10101.SSIDAdvertisementEnabled by setting value as
	 * false and verify the assigned value using WebPA get command</li>
	 * 
	 * <li>STEP 2:Retrieve the value using SNMP
	 * command(1.3.6.1.4.1.17270.50.2.2.2.1.1.5.10101) and cross verify that we are
	 * getting actual value '1' for false.</li>
	 * 
	 * <li>STEP 3:Enable the TR181 parameter
	 * Device.WiFi.AccessPoint.10101.SSIDAdvertisementEnabled by setting value as
	 ...
	 * 
	 * <li>STEP 4:Retrieve the value using SNMP
	 * command(1.3.6.1.4.1.17270.50.2.2.2.1.1.5.10101) and cross checked that we are
	 * getting actual value '2' for true.
	 * </ol>
	 * 
	...
	/**
	 * This test case checks the SSIDAdvertisementEnabled on 2.4Ghz Public wifi
	 * network by WebPA and verifies by SNMP
	 * 
	 * <ol>
	 * <li>STEP 1:Disable the TR181 parameter
	 * Device.WiFi.AccessPoint.10003.SSIDAdvertisementEnabled by setting value as
	 * false and verify the assigned value using WebPA get command</li>
	 * <li>STEP 2:Enable the TR181 parameter
	 * Device.WiFi.AccessPoint.10003.SSIDAdvertisementEnabled by setting value as
	 * true and verify the assigned value using WebPA get command</li>
	 * 
	 * @param device Dut to be used
	...
	public void testValidateSSIDAdvertisementEnabledFor2_4GhzPublicNetwork(Dut device) {
		...
		try {
			...
			/**
			 * STEP 2:Enable the TR181 parameter
			 * Device.WiFi.AccessPoint.10003.SSIDAdvertisementEnabled by setting value as
			 * true and verify the assigned value using WebPA get command
			 */
			tapEnv.waitTill(BroadBandTestConstants.ONE_MINUTE_IN_MILLIS);
	...
	/**
	 * This test case checks the SSIDAdvertisementEnabled on 5Ghz Public network by
	 * WebPA and verifies by SNMP
	 * 
	 * <ol>
	 * <li>STEP 1:Disable the TR181 parameter
	 * Device.WiFi.AccessPoint.10103.SSIDAdvertisementEnabled by setting value as
	 * false and verify the assigned value using WebPA get command</li>
	 * <li>STEP 2:Enable the TR181 parameter
	 * Device.WiFi.AccessPoint.10103.SSIDAdvertisementEnabled by setting value as
	 * true and verify the assigned value using WebPA get command</li>
	 ...
	 * 
	 * <ol>
	 * <li>STEP 1:Execute webPA command to Get on the Security Mode to get the
	 * current mode</li>
	 * 
	 ...
	 * change.</li>
	 * 
	 * <li>STEP 4 :Execute WebPA command to set the current security mode
	 * parameter</li>
	 * 
	 * <li>STEP 5:Verify whether device logs the telemetry marker for current
	 * security mode change</li>
	...
	public void checkForSecurityModeParameter(Dut device, String testCaseId, String securityModeEnabled) {
		...
		try {
			...
			/**
			 * STEP 1:Execute webPA command to Get on the Security Mode to get the current
			 * mode
			 */
			testStepNumber = "s1";
			status = false;
			...
			for (int count = 0; count < supportedSecurityModesList.size(); count++) {
				...
				/**
				 * STEP 3 : Verify whether device logs the telemetry marker for security mode
				 * change.
				 * 
				 */
				testStepNumber = "s" + stepNumber;
			...
			tapEnv.updateExecutionStatus(device, testId, testStepNumber, status, errorMessage, true);
			/**
			 * STEP 5: Verify whether device logs the telemetry marker for current security
			 * mode change
			 * 
			 */
			testStepNumber = "s" + stepNumber;
