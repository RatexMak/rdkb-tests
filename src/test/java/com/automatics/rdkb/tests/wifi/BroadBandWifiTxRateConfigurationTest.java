...
public class BroadBandWifiTxRateConfigurationTest extends AutomaticsTestBase {
	 ...
	 * Radio and 5GHZ.
	 *
	 * Test Case # 1: Verify the configuration of Transmission Control Rate for both
	 * 2.4GHz bands and 5Ghz bands using WebPA.
	 *
	 * <p>
	 * STEPS:
	 * </p>
	 ...
	 * <li>S2)Verify the supported data transmit rate of the 2.4 GHz with operating
	 * standard as g/n</li>
	 ...
	 * <li>S5)Verify the supported data transmit rate of the 2.4 GHz with operating
	 ...
	 * <li>S7)Verify setting unsupported values for operational transmission rate
	 * for 2.4GHz band.</li>
	 * <li>S8)Verify the value of operational transmission rate of the 2.4 GHz.</li>
	 * <li>S9)Verify setting values for operational transmission rate for 2.4GHz
	 * band excluding the basic transmission rate.</li>
	 * <li>S10)Verify the default value of operational transmission rate of the 2.4
	 * GHz.</li>
	 * <li>S11)Verify setting the operational transmission rate for 2.4GHz with
	 * operating standard as b/g/n with values 1,2,6,9.</li>
	 * <li>S12)Verify retrieving the operational transmission rate for 2.4GHz with
	 * operating standard as b/g/n.</li>
	 * <li>S13)Verify retrieving the value of basic transmission rate of the 2.4 GHz
	 * with operating standard as b/g/n</li>
	 * <li>S14)Verify retrieving the OperatingStandards for 5GHz default value as
	 * 802.11a/n/ac</li>
	 * <li>S15)Verify retrieving value of basic data transmission rate of 5GHz with
	 * operating standard as 802.11a/n/ac</li>
	 * <li>S16)Verify retrieving the SupportedDataTransmitRates for 5GHz with
	 * operating standard as 802.11a/n/ac</li>
	 * <li>S17)Verify retrieving the operational transmission rate for 5GHz with
	 * operating standard as 802.11a/n/ac</li>
	 * <li>S18)Change the operating mode for 5GHz Wi-Fi for device to 802.11 n/ac
	 * and verify the wifi rates</li>
	 * <li>S18)Verify retrieving the OperatingStandards for 5GHz</li>
	 * <li>S20)Verify retrieving value of basic data transmission rate of 5GHz with
	 * operating standard as n/ac</li>
	 * <li>S21)Verify retrieving the SupportedDataTransmitRates for 5GHz with
	 * operating standard as 802.11 n/ac</li>
	 * <li>S22)Verify the operational transmission rate for 5GHz with operating
	 * standard as 802.11 n/ac</li>
	 * <li>S23)Change the operating mode for 5GHz Wi-Fi for device to 802.11ac and
	 * verify the wifi rates</li>
	 * <li>S24)Verify the OperatingStandards for 5GHz by using webpa</li>
	 * <li>S25)Verify the value of basic data transmission rate of 5GHz with
	 * operating standard as ac</li>
	 * <li>S26)Verify the SupportedDataTransmitRates for 5GHz with operating
	 * standard as 802.11 ac</li>
	 * <li>S27)Verify retrieving the operational transmission rate for 5GHz with
	 * operating standard as 802.11ac</li>
	 * <li>S28)Verify retrieving the operational transmission rate for 2.4GHz with
	 * operating standard as b/g/n post reboot.</li>
	 * <li>S29)Verify the supported data transmit rate of the 2.4 GHz with operating
	 * standard as b/g/n post reboot.</li>
	 * <li>S30)Verify retrieving the value of basic transmission rate of the 2.4 GHz
	 * with operating standard as b/g/n post reboot.</li>
	 * <li>S31)Verify setting the operational transmission rate for 2.4GHz with
	 * operating standard as g/n with values 6,9,12,18</li>
	 * <li>S32)Verify retrieving the operational transmission rate for 2.4GHz with
	 * operating standard as g/n.</li>
	 * <li>S33)Verify retrieving the value of basic transmission rate of the 2.4 GHz
	 * with operating standard as g/n</li>
	 * <li>S34)Verify the beacon traffic use the lowest supported basic rate
	 * (2.4GHz)</li>
	 * <li>S35)Verify the OperatingStandard for 5GHz by webpa post reboot</li>
	 * <li>S36)Verify the value of basic data transmission rate of 5GHz with
	 * operating standard as '802.11ac' by webpa post reboot</li>
	 * <li>S37)Verify the SupportedDataTransmitRates for 5GHz with operating
	 * standard as 802.11ac by webpa post reboot</li>
	 * <li>S38)Verify the operational transmission rate for 5GHz with operating
	 * standard as 802.11ac by webpa post reboot</li>
	 * <li>S39)Change the operating mode for 5GHz Wi-Fi for device to 802.11n and
	 * verify the wifi rates</li>
	 * <li>S40)Verify retrieving the OperatingStandards for 5GHz by Webpa</li>
	 * <li>S41)Verify the value of basic data transmission rate of 5GHz with
	 * operating standard as 'n'</li>
	 * <li>S42)Verify the SupportedDataTransmitRates for 5GHz with operating
	 * standard as 802.11n</li>
	 * <li>S43)Verify the operational transmission rate for 5GHz with operating
	 * standard as 802.11n</li>
	 * <li>Pre-Condition:Perform image upgrade on the device.</li>
	 * <li>S44)Verify retrieving the operational transmission rate for 2.4GHz with
	 * operating standard as g/n post image upgrade.</li>
	 * <li>S45)Verify the supported data transmit rate of the 2.4 GHz with operating
	 * standard as g/n post image upgrade.</li>
	 * <li>S46)Verify retrieving the value of basic transmission rate of the 2.4 GHz
	 * with operating standard as g/n post image upgrade.</li>
	 * <li>S47)Verify the OperatingStandard for 5GHz with operating standard as
	 * 802.11n by webpa post upgrade</li>
	 * <li>S48)Verify the value of basic data transmission rate of 5GHz with
	 * operating standard as '802.11n' by webpa post upgrade</li>
	 * <li>S49)Verify the SupportedDataTransmitRates for 5GHz with operating
	 * standard as 802.11n by webpa post upgrade</li>
	 * <li>S50)Verify the operational transmission rate for 5GHz with operating
	 * standard as 802.11n by webpa post upgrade</li>
	 * <li>
	 * </ol>
	 * *
	...
	public void testTxRateConfigWebPa(Dut device) {
		...
		try {
			 ...
			 * with operating standard as g/n or b/g/n for DSL devices.
			 */
			 ...
			 * standard as g/n or b/g/n for DSL devices
			 */
			stepNumber++;
			step = "S" + stepNumber;
			result = false;
			 ...
			 * operating standard as g/n or b/g/n for DSL devices
			 */
			stepNumber++;
			step = "S" + stepNumber;
			result = false;
			...
			if (CommonMethods.isAtomSyncAvailable(device, tapEnv) || DeviceModeHandler.isDSLDevice(device)) {
				...
				/**
				 * S6) Verify the default value of basic transmission rate of the 2.4GHz with
				...
				/**
				 * S7) Verify setting unsupported values Operational Transmission Rate for
				 * 2.4GHz band.
				 */
				stepNumber++;
				step = "S" + stepNumber;
				...
				/**
				 * S8) Verify setting values Operational Transmission Rate for 2.4GHz band
				 * excluding the basic transmission rate.
				 */
				stepNumber++;
				step = "S" + stepNumber;
				result = false;
			...
			/**
			 * S9) Verify setting the operational transmission rate for 2.4GHz with
			 * operating standard as b/g/n with value 1,2,6,9.
			 */
			if (!DeviceModeHandler.isDSLDevice(device)) {
				...
				/**
				 * S10) Verify retrieving the operational transmission rate for 2.4GHz with
				 * operating standard as b/g/n.
				 */
				expectedValue = BroadBandTestConstants.TEMP_OPEATIONAL_TX_RATE_2GHZ;
				stepNumber++;
			...
			/**
			 * S11) Verify retrieving the basic transmission rate for 2.4GHz with operating
			 * standard as b/g/n.
			 */
			stepNumber++;
			step = "S" + stepNumber;
			...
			/**
			 * S12) Verify retrieving the OperatingStandards for 5GHz default value as
			 * 802.11a/n/ac.
			 */
			stepNumber++;
			step = "S" + stepNumber;
			...
			/**
			 * S13) Verify retrieving value of basic data transmission rate of 5GHz with
			 * operating standard as 802.11a/n/ac
			 */
			stepNumber++;
			step = "S" + stepNumber;
			result = false;
			...
			/**
			 * S14) Verify retrieving the SupportedDataTransmitRates for 5GHz with operating
			 * standard as 802.11a/n/ac
			 */
			stepNumber++;
			step = "S" + stepNumber;
			result = false;
			...
			/**
			 * S15) Verify retrieving the operational transmission rate for 5GHz with
			 * operating standard as 802.11a/n/ac.
			 */
			stepNumber++;
			step = "S" + stepNumber;
			...
			if (!(DeviceModeHandler.isDSLDevice(device))) {
				/**
				 * S16) Change the operating mode for 5GHz Wi-Fi for device to 802.11 n/ac and
				 * verify the wifi rates
				 * 
				 */
				stepNumber++;
				step = "S" + stepNumber;
				...
				/**
				 * S18) Verify retrieving value of basic data transmission rate of 5GHz with
				 * operating standard as n/ac
				 */
				stepNumber++;
				step = "S" + stepNumber;
				result = false;
				...
				/**
				 * S19) Verify retrieving the SupportedDataTransmitRates for 5GHz with operating
				 * standard as 802.11 n/ac
				 */
				stepNumber++;
				step = "S" + stepNumber;
				result = false;
				...
				/**
				 * S20) Verify the operational transmission rate for 5GHz with operating
				 * standard as 802.11 n/ac.
				 */
				stepNumber++;
				step = "S" + stepNumber;
				...
				/**
				 * S21) Change the operating mode for 5GHz Wi-Fi for device to 802.11ac and
				 * verify the wifi rates
				 * 
				 */
				stepNumber++;
				...
				/**
				 * S23) Verify the value of basic data transmission rate of 5GHz with operating
				 * standard as ac
				 */
				stepNumber++;
				step = "S" + stepNumber;
				...
				/**
				 * S24) Verify the SupportedDataTransmitRates for 5GHz with operating standard
				 * as 802.11 ac
				 */
				stepNumber++;
				step = "S" + stepNumber;
				...
				/**
				 * S25) Verify retrieving the operational transmission rate for 5GHz with
				 * operating standard as 802.11ac.
				 */
				stepNumber++;
				step = "S" + stepNumber;
				result = false;
			...
			/**
			 * S26) Verify retrieving the operational transmission rate for 2.4GHz with
			 * operating standard as b/g/n post re-boot.
			 */
			stepNumber = 26;
			step = "S" + stepNumber;
			result = false;
			...
			/**
			 * S27) Verify the supported data transmit rate of the 2.4GHz with operating
			 * standard as b/g/n post re-boot
			 */
			stepNumber++;
			step = "S" + stepNumber;
			result = false;
			...
			/**
			 * S28) Verify retrieving the basic transmission rate for 2.4GHz with operating
			 * standard as b/g/n post re-boot.
			 */
			stepNumber++;
			step = "S" + stepNumber;
			...
			if (!(DeviceModeHandler.isDSLDevice(device))) {
				/**
				 * S29) Verify setting the operational transmission rate for 2.4GHz with
				...
				/**
				 * S30) Verify retrieving the operational transmission rate for 2.4GHz with
				...
				/**
				 * S31) Verify retrieving the basic transmission rate for 2.4GHz with operating
				 * standard as g/n.
				 */
				stepNumber++;
				step = "S" + stepNumber;
			...
			if (!(DeviceModeHandler.isDSLDevice(device))) {
				/**
				 * S34) Verify the value of basic data transmission rate of 5GHz with operating
				 * standard as '802.11ac' by webpa post reboot
				 */
				stepNumber++;
				step = "S" + stepNumber;
				result = false;
				...
				/**
				 * S35) Verify the SupportedDataTransmitRates for 5GHz with operating standard
				 * as 802.11ac by webpa post reboot
				 */
				stepNumber++;
				step = "S" + stepNumber;
				result = false;
				...
				/**
				 * S36) Verify the operational transmission rate for 5GHz with operating
				 * standard as 802.11ac by webpa post reboot.
				 */
				stepNumber++;
				step = "S" + stepNumber;
				...
				/**
				 * S37) Change the operating mode for 5GHz Wi-Fi for device to 802.11n and
				 * verify the wifi rates
				 */
				stepNumber++;
				step = "S" + stepNumber;
			...
			if (!(DeviceModeHandler.isDSLDevice(device))) {
				/**
				 * S39) Verify the value of basic data transmission rate of 5GHz with operating
				 * standard as 'n'
				 */
				stepNumber++;
				step = "S" + stepNumber;
				...
				/**
				 * S40) Verify the SupportedDataTransmitRates for 5GHz with operating standard
				 * as 802.11n
				 */
				stepNumber++;
				step = "S" + stepNumber;
				...
				/**
				 * S41) Verify the operational transmission rate for 5GHz with operating
				 * standard as 802.11n.
				 */
				stepNumber++;
				step = "S" + stepNumber;
			...
			/**
			 * S42) Verify retrieving the operational transmission rate for 2.4GHz with
			 * operating standard as g/n (b,g,n for DSL) post image upgrade.
			 */
			stepNumber = 42;
			step = "S" + stepNumber;
			result = false;
			...
			/**
			 * S43) Verify the supported data transmit rate of the 2.4GHz with operating
			 * standard as g/n (b,g,n for DSL) post image upgrade.
			 */
			stepNumber++;
			step = "S" + stepNumber;
			result = false;
			...
			/**
			 * S44) Verify retrieving the basic transmission rate for 2.4GHz with operating
			 * standard as g/n (b,g,n for DSL) post image upgrade..
			 */
			stepNumber++;
			step = "S" + stepNumber;
			...
			/**
			 * S45) Verify the OperatingStandard for 5GHz with operating standard as 802.11n
			...
			/**
			 * S46) Verify the value of basic data transmission rate of 5GHz with operating
			 * standard as '802.11n' (a,n,ac for DSL) by webpa post upgrade
			 */
			stepNumber++;
			step = "S" + stepNumber;
			result = false;
			...
			/**
			 * S47) Verify the SupportedDataTransmitRates for 5GHz with operating standard
			 * as 802.11n by (a,n,ac for DSL) webpa post upgrade
			 */
			stepNumber++;
			step = "S" + stepNumber;
			result = false;
			...
			/**
			 * S48) Verify the operational transmission rate for 5GHz with operating
			 * standard as 802.11n (a,n,ac for DSL) by webpa post upgrade.
			 */
			stepNumber++;
			step = "S" + stepNumber;
	...
	/**
	 * The method to be executed once during the execution of the test case; factory
	 * reset is being performed here.
	 * 
	...
	/**
	 * The method to be executed after test method where the factory reset needs to
	 * be performed on the device and then the activation.
	 * 
	 * @param tapEnv {@link AutomaticsTapApi}
	 * @param device {@link Dut}
	 */
	 ...
	 * reboot
	 * <ol>
	 * <li>1. set and verify WifiBlaster RFC config parameter is enabled using
	 * RFC</li>
	 * <li>2. Set and Verify Wifi Blaster PacketSize Parameter to 64</li>
	 * <li>3. Set and verify Wifi Blaster PacketSize Parameter to 63 and and verify
	 * the value to be previous setvalue</li>
	 * <li>4. Set and Verify Wifi Blaster PacketSize Parameter to 1470</li>
	 * <li>5. Set and Verify Wifi Blaster PacketSize Parameter to 1471 and verify
	 * the value to be previous setvalue</li>
	 * <li>6. Set and Verify Wifi Blaster SampleDuration Parameter to 1</li>
	 * <li>7. Set Wifi Blaster SampleDuration Parameter to 0 and verify the value to
	 * be previous set value</li>
	 * <li>8. Set and Verify Wifi Blaster SampleDuration Parameter to 10000</li>
	 * <li>9. Set Wifi Blaster SampleDuration Parameter to 10001 and verify the
	 * value to be previous set value</li>
	 * <li>10. Set and Verify Wifi Blaster NumberOfSamples Parameter to 1</li>
	 * <li>11. Set Wifi Blaster NumberOfSamples Parameter to 0 and verify the value
	 * to be previous set value</li>
	 * <li>12. Set and Verify Wifi Blaster NumberOfSamples Parameter to 100</li>
	 * <li>13. Set Wifi Blaster NumberOfSamples Parameter to 101 and verify the
	 * value to be previous set value</li>
	 * </ol>
	 * 
