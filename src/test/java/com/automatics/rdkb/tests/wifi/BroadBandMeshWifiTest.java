...
public class BroadBandMeshWifiTest extends AutomaticsTestBase {
	 ...
	 * <ol>
	 * <li>Disable Mesh using webpa and wiat for 90 seconds for the changes to get
	 * affected</li>
	 * <li>Verify whether the current channel set for 5ghz is in the non overlapping
	 * range</li>
	 * <li>Enable Mesh using webpa and wiat for 90 seconds for the changes to get
	 * affected</li>
	 * <li>Verify whether the current channel set for 5ghz has not changed or is in
	 * the non overlapping range</li>
	 * <li>Disable Mesh using webpa and wiat for 90 seconds for the changes to get
	 * affected</li>
	 * <li>Verify whether the current channel set for 5ghz has not changed or is in
	 * the non overlapping range after disabling mesh</li>
	 * </ol>
	 * 
	 * @param {@link device}
	 * 
	 ...
	 * <li>Step 3: Check for Setting Mesh to disabled when bridge mode enabled log
	 * message</li>
	 ...
	 * @param bridge Boolean value containing true/false for enable/disable bridge
	 *               mode
	 * @param mesh   Boolean value containing value of mesh enable to be set
	 * 
	 */
	...
	/**
	 * Method to execute steps to validate mesh gets disabled when we enable bridge
	 * mode
	 * 
	 * @param device  {@link Dut}
	 * @param testId  String containing test case id to update step execution status
	 * @param stepNum Integer containing previous step executed after which these
	 *                steps are validated
	 * 
	 * @author Ashwin Sankara
	 * @Refactor Athira
