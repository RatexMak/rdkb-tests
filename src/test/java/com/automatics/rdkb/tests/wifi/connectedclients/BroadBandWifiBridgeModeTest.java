...
/**
 * Test class for the verification of Client Connectivity to 2.4GHz & 5GHz bands
 * with Bridge mode is 'ON' & 'OFF'.
 * 
 * 
 */
public class BroadBandWifiBridgeModeTest extends AutomaticsTestBase {
	...
	public enum LanModeTypes {
		...
		/**
		 * @param lanModeValue the lanModeValue to set
		 */
	 ...
	 * <li>2:VERIFY WHETHER THE WIFI CONNECTED CLIENT 1 GOT THE IPV4 ADDRESS FROM
	 * DHCP RANGE.</li>
	 * <li>3:VERIFY WHETHER WIFI CONNECTED CLIENT 1 OBTAINED THE IPV6 ADDRESS.</li>
	 * <li>4:VERIFY CONNECTIVITY OF CONNECTED CLIENT USING IPV4 WITH CURL
	 * REQUEST</li>
	 * <li>5:VERIFY CONNECTIVITY OF CONNECTED CLIENT USING IPV4 WITH CURL
	 * REQUEST</li>
	 * <li>6:VERIFY CONNECTING THE WI-FI CLIENT IN THE SETTOP TO 5GHz SSID</li>
	 * <li>7:VERIFY WHETHER WIFI CONNECTED CLIENT 2 GOT THE IPV4 ADDRESS FROM DHCP
	 * RANGE.</li>
	 * <li>8:VERIFY WHETHER WIFI CONNECTED CLIENT 2 OBTAINED THE IPV6 ADDRESS.</li>
	 * <li>9:VERIFY CONNECTIVITY OF CONNECTED CLIENT USING IPV4 WITH CURL
	 * REQUEST</li>
	 * <li>10:VERIFY CONNECTIVITY OF CONNECTED CLIENT USING IPV4 WITH CURL
	 * REQUEST</li>
	 * <li>11:RETRIEVE ETHERNET CONNECTED CLIENT FROM CONNECTED CLIENTS LIST</li>
	 * <li>12:VERIFY WHETHER ETHERNET CONNECTED CLIENT GOT THE IPV4 ADDRESS FROM
	 * DHCP RANGE.</li>
	 * <li>13:VERIFY WHETHER ETHERNET CONNECTED CLIENT OBTAINED THE IPV6
	 * ADDRESS.</li>
	 * <li>14:VERIFY CONNECTIVITY OF CONNECTED CLIENT USING IPV4 WITH CURL
	 * REQUEST</li>
	 * <li>15:VERIFY CONNECTIVITY OF CONNECTED CLIENT USING IPV4 WITH CURL
	 * REQUEST</li>
	 * <li>16:VERIFY ENABLING BRIDGE MODE ON THE DEVICE.</li>
	 * <li>17:VERIFY WEBPA PROCESS IS UP AND RUNNING</li>
	 * <li>18:VERIFY THAT THE PRIVATE WI-FI SSIDS 2.4GHZ AND 5GHZ ARE DISABLED USING
	 * WEBPA</li>
	 ...
	 * <li>22:VERIFY WHETHER THERE IS CONNECTIVITY USING THAT PARTICULAR INTERFACE
	 * USING IPV4</li>
	 * <li>23:VERIFY WHETHER YOU HAVE NO CONNECTIVITY USING THAT PARTICULAR
	 ...
	 * <li>27:VERIFY WHETHER THERE IS CONNECTIVITY USING THAT PARTICULAR INTERFACE
	 * USING IPV4</li>
	 * <li>28:VERIFY WHETHER YOU HAVE CONNECTIVITY USING THAT PARTICULAR INTERFACE
	 * USING IPV6</li>
	 ...
	 * <li>31:VERIFY WHETHER THERE IS CONNECTIVITY USING THAT PARTICULAR INTERFACE
	 * USING IPV4</li>
	 * <li>32:VERIFY WHETHER YOU HAVE CONNECTIVITY USING THAT PARTICULAR INTERFACE
	 * USING IPV6</li>
	 * <li>33:VERIFY DISABLING BRIDGE MODE ON THE DEVICE.</li>
	 * <li>34:VERIFY CONNECTING THE WI-FI CLIENT IN THE SETTOP TO 2.4GHz SSID WITH
	 * BRIDGE MODE DISABLED</li>
	 * <li>35:VERIFY WHETHER WIFI CONNECTED CLIENT 1 GOT THE IPV4 ADDRESS FROM DHCP
	 * RANGE.</li>
	 * <li>36:VERIFY WHETHER WIFI CONNECTED CLIENT 1 OBTAINED THE IPV6 ADDRESS.</li>
	 * <li>37:VERIFY CONNECTIVITY OF CONNECTED CLIENT USING IPV4 WITH CURL
	 * REQUEST</li>
	 * <li>38:VERIFY CONNECTIVITY OF CONNECTED CLIENT USING IPV6 WITH CURL
	 * REQUEST</li>
	 * <li>39:VERIFY CONNECTING THE WI-FI CLIENT IN THE SETTOP TO 5GHz SSID</li>
	 * <li>40:VERIFY WHETHER WIFI CONNECTED CLIENT 2 GOT THE IPV4 ADDRESS FROM DHCP
	 * RANGE.</li>
	 * <li>41:VERIFY WHETHER WIFI CONNECTED CLIENT 2 OBTAINED THE IPV6 ADDRESS.</li>
	 * <li>42:VERIFY CONNECTIVITY OF CONNECTED CLIENT USING IPV4 WITH CURL
	 * REQUEST</li>
	 * <li>43:VERIFY CONNECTIVITY OF CONNECTED CLIENT USING IPV6 WITH CURL
	 * REQUEST</li>
	 * <li>44:VERIFY WHETHER ETHERNET CONNECTED CLIENT GOT THE IPV4 ADDRESS FROM
	 * DHCP RANGE.</li>
	 * <li>45:VERIFY WHETHER ETHERNET CONNECTED CLIENT OBTAINED THE IPV6
	 * ADDRESS</li>
	 * <li>46:VERIFY CONNECTIVITY OF CONNECTED CLIENT USING IPV4 WITH CURL
	 * REQUEST</li>
	 * <li>47:VERIFY CONNECTIVITY OF CONNECTED CLIENT USING IPV6 WITH CURL
	 * REQUEST</li>
	 * </ol>
	 * 
	 * @param device
	...
	public void testWifiBand2GhzBridgeMode(Dut device) {
		...
		try {
			...
			// Validating IPv4 , IPV6 Address and connectivity check with IPv4 and IPv6
			// using Curl
			...
			/**
			 * STEP 6: Verify connecting the Another WiFi Client in the Setup to the 5GHz
			 * SSID
			 */
			testStepNumber = "S6";
			status = false;
			...
			/**
			 * STEP 18:Verify that the Private Wi-Fi SSIDs 2.4Ghz and 5Ghz are disabled
			 * using WebPA
			 */
			status = false;
			testStepNumber = "s18";
			...
			tapEnv.updateExecutionStatus(device, testCaseId, testStepNumber, status, errorMessage, true);
			/**
			 * STEP 19: Verify the 2.4GHz SSID is not broadcasted in Wifi Connected client
			 * 1.
			 */
			testStepNumber = "s19";
			status = false;
			...
			/**
			 * STEP 22:Verify No Internet connectivity of Wifi connected client 1 using IPV4
			 * with curl request.
			 * 
			 */
			testStepNumber = "s22";
			...
			/**
			 * STEP 23:Verify No Internet connectivity of Wifi connected client 1 using IPV6
			 * with curl request.
			 * 
			 */
			status = false;
			...
			/**
			 * STEP 29: Verify whether Ethernet connected client has IPv4 address in Wan IP
			 * Broadcast.
			 * 
			 */
			testStepNumber = "s29";
			...
			if (BroadbandPropertyFileHandler.isIpv6Enabled()) {
				...
				if (CommonMethods.isNotNull(osType)) {
					status = BroadBandConnectedClientUtils
							.verifyIpv6AddressForWiFiOrLanInterfaceConnectedWithRdkbDevice(osType, ethernetClient,
									tapEnv);
				}
				if (status) {
			...
			/**
			 * STEP 31:Verify connectivity of Ethernet connected client using IPV4 with curl
			 * request.
			 * 
			 */
			testStepNumber = "s31";
			...
			/**
			 * STEP 32:Verify connectivity of Ethernet connected client using IPV6 with curl
			 * request
			 * 
			 */
			status = false;
			...
			if (BroadbandPropertyFileHandler.isIpv6Enabled()) {
				...
				LOGGER.info("#####################################################################################");
				bandResultObject = BroadBandConnectedClientUtils.verifyInternetIsAccessibleInConnectedClientUsingCurl(
						tapEnv, ethernetClient, BroadBandTestConstants.URL_WIKIPEDIA,
						BroadBandTestConstants.IP_VERSION6);
				status = bandResultObject.isStatus();
				errorMessage = bandResultObject.getErrorMessage();
				if (status) {
	...
	public void verifyIpstatusAndConnectivityInConnectedClient(Dut device, Dut connectedClient, String testCaseId,
		...
		/**
		 * STEP 1: Verify whether the Connected client got the IPv4 address from DHCP
		 * range.
		 * 
		 */
		...
		if (BroadbandPropertyFileHandler.isIpv6Enabled()) {
			...
			if (status) {
				LOGGER.info(
						"STEP " + testNumbers[1] + " ACTUAL :Connected client has IPv6 address validated successfully");
			} else {
