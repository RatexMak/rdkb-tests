...
public class BroadBandPublicWifiTests extends BroadBandWebUiBaseTest {
	 ...
	 * </p>
	 * <ol>
	 * <li>PRE-CONDITION 1: Verify the private wifi 2.4 GHz and 5 GHz SSID's is
	 * broadcasting in connected client</li>
	 * <li>PRE-CONDITION 2: Set and verify the public wifi status is enabled</li>
	 * <li>PRE-CONDITION 3: Verify the public wifi 5 GHz SSID's is broadcasting in
	 * connected client</li>
	 * <li>Step 1 : Connect the client into 2.4 GHz private ssid and verify
	 * connection status</li>
	 * <li>Step 2 : Verify the correct IPv4 address for client connected with
	 * private wifi 2.4 GHz ssid</li>
	 * <li>Step 3 : Verify the correct IPv6 address for client connected with
	 * private wifi 2.4 GHz ssid</li>
	 * <li>Step 4 : Verify the internet connectivity in the client connected with
	 ...
	 * <li>Step 6 : Verify login into the LAN GUI Adimn page by using userid and
	 * password for client connected with 2.4 Ghz wifi ssid</li>
	 * <li>Step 7 : Verify the public wifi parameters on LAN GUI Adimn page for
	 * client connected with 2.4 Ghz wifi ssid</li>
	 * <li>Step 8 : Verify disconnecting the client from 2.4 GHz private wifi
	 * SSID</li>
	 * <li>POST-CONDITION 1: Logout Admin web gui page for device connected with 2.4
	 * GHz ssid</li>
	 * </ol>
	 * 
	 * @param device {@link Dut}
	...
	public void testToVerifypublicWiFiConfigurationOnLan2Ghz(Dut device) {
		...
		try {
			...
			/**
			 * SETP 2-5 : VERIFY THE CORRECT IPV4 AND IPV6 ADDRESS FOR CLIENT CONNECTED WITH
			 ...
			 * PASSWORD FOR CLIENNT CONNECTED WITH 2.4 GHZ WIFI SSID
			 */
			stepNumber = 6;
			stepNum = "S" + stepNumber;
			status = false;
			...
			/**
			 * STEP 7 : VERIFY THE public WIFI PARAMETERS ON LAN GUI ADIMN PAGE FOR CLIENT
			 * CONNECTED WITH 2.4 GHZ public WIFI SSID
			 */
			stepNumber++;
			stepNum = "S" + stepNumber;
			status = false;
	 ...
	 * broadcasting in connected client</li>
	 * <li>PRE-CONDITION 2: Set and verify the public wifi status is enabled</li>
	 * <li>PRE-CONDITION 3: Verify the public wifi 2.4 GHz and 5 GHz SSID's is
	 * broadcasting in connected client</li>
	 * <li>Step 1 : Connect the client into 5 GHz private ssid and verify connection
	 * status</li>
	 * <li>Step 2 : Verify the correct IPv4 address for client connected with
	 * private wifi 5 GHz ssid</li>
	 * <li>Step 3 : Verify the correct IPv6 address for client connected with
	 * private wifi 5 GHz ssid
	 * <li>Step 4 : Verify the internet connectivity in the client connected with
	 * private wifi 5 GHz ssid using ipv4 interface</li>
	 * <li>Step 5 : Verify the internet connectivity in the client connected with
	 * private wifi 5 GHz ssid using ipv6 interface</li>
	 * <li>Step 6 : Verify login into the LAN GUI Adimn page by using userid and
	 * password for client connected with 5 Ghz public wifi ssid</li>
	 * <li>Step 7 : Verify the public wifi parameters on LAN GUI Adimn page for
	 * client connected with 5 Ghz public wifi ssid</li>
	 * <li>Step 8 : Verify disconnecting the client from 5 GHz private wifi
	 * SSID</li>
	 * <li>POST-CONDITION 1: Logout Admin web gui page for device connected with 5
	 * GHz ssid</li>
	 * </ol>
	 * 
	 * @param device {@link Dut}
	...
	public void testToVerifypublicWiFiConfigurationOnLAN(Dut device) {
		...
		try {
			...
			/**
			 * STEP 1 : CONNECT THE CLIENT INTO 5 GHZ PRIVATE SSID AND VERIFY CONNECTION
			 * STATUS
			 */
			...
			/**
			 * STEP 6 : VERIFY LOGIN INTO THE LAN GUI ADIMN PAGE BY USING USERID AND
			 * PASSWORD FOR CLIENNT CONNECTED WITH 5 GHZ public WIFI SSID
			 */
			stepNumber = 6;
			stepNum = "S" + stepNumber;
			status = false;
			...
			/**
			 * STEP 7 : VERIFY THE public WIFI PARAMETERS ON LAN GUI ADIMN PAGE FOR CLIENT
			 * CONNECTED WITH 5 GHZ public WIFI SSID
			 */
			stepNumber++;
			stepNum = "S" + stepNumber;
			status = false;
			...
			/**
			 * POST-CONDITION 2 : CLOSE THE LAN SIDE BROWSER FOR DEVICE CONNECTED WITH 5 GHZ
			 * SSID
			 */
			postConStepNumber++;
			LOGGER.info("POST-CONDITION " + postConStepNumber + " : DESCRIPTION : VERIFY LAN SIDE BROWSER CLOSED");
