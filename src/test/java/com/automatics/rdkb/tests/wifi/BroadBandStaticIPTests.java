...
public class BroadBandStaticIPTests extends AutomaticsTestBase {
     ...
     * <ol>
     * <li>Set the default/initial value of static IPv4 address as null using SNMP.</li>
     * <li>Verify the default/initial value of static IPv4 address using webpa</li>
     * <li>copy the cliconfig.txt script from resources folder to /var in the gateway device</li>
     * <li>Get the static wan ip set for the device from the script</li>
     * <li>Apply the configuration for static IP setting</li>
     * <li>Wait for a 3 minutes for statics to start routing. and Verify the value of static IPv4 address using
     * SNMP</li>
     ...
     * <li>Factory reset the device using Webpa and wait till the device comes online</li>
	...
	try {
	    ...
	    LOGGER.info(
		    "STEP 1: ACTION : Execute snmpwalk using mib .1.3.6.1.4.1.17270.50.2.1.4.6.0");
	    LOGGER.info(
	    ...
	    // Execute the command dmcli eRT getv Device.X_CISCO_COM_TrueStaticIP.IPAddress by SSHing to the device and
	    ...
	    LOGGER.info(
		    "STEP 6: ACTION : Execute snmpwalk using mib .1.3.6.1.4.1.17270.50.2.1.4.6.0");
	    LOGGER.info(
		...
		// Validate whether the IP address from the dmcli command and from SNMP are the same
		status = CommonMethods.isIpv4Address(response)
			&& response.trim().equalsIgnoreCase(wan_ip_address.trim());
	    ...
	    LOGGER.info(
		    "STEP 12: ACTION : Execute a webpa sequence for reactivation");
	    ...
	    LOGGER.info(
		    "STEP 13: ACTION : Execute snmpwalk using mib .1.3.6.1.4.1.17270.50.2.1.4.6.0");
	    LOGGER.info(
