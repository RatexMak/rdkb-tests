...
public class BroadbandConnectedDeviceListTest extends AutomaticsTestBase {
	...
	public void testBridgeModeFunctionality(Dut device) {
	    ...
	    /**
	     *
	     * Test Case : Test script to validate basic wifi parameters on router mode transition
	     *
	     * <p>
	     * STEPS:
	     * </p>
	     * <ol>
	     * <li>Change the private ssid names in both 2.4Ghz and 5Ghz channels using Device.WiFi.SSID.{i}.SSID</li>
	     * <li>Change the Default wifi channel numbers in 2.4Ghz channel using webpa parameters</li>
	     * <li>Change the Default wifi channel numbers in 5 Ghz channel using webpa parameters</li>
	     * <li>Get the remoter access status and change the values on vice versa for both http and https using webpa
	     * parameters</li>
	     * <li>Set a parental control rule by enabling \"Device.X_Comcast_com_ParentalControl.ManagedSites.Enable \" and set
	     * rules</li>
	     * <li>Verify the port forwarding feature can be enabled using WebPA</li>
	     * <li>Connect the device to the private Wi-Fi SSID and verify connection status</li>
	     * <li>Check if the wireless connected client has an IP address from the gateway</li>
	     * <li>Verify the port forwarding rule for HTTP service is added for the client connected to the gateway</li>
	     * <li>Verify whether IP tables has the port forwarding rules configured when device in Router Mode</li>
	     * <li>Verify the WAN IP Address of the gateway is retrieved successfully</li>
	     * <li>Verify the HTTP connection is successful when portforwarding is configured</li>
	     ...
	     * "Device.WiFi.AccessPoint.1.Security.ModeEnabled \"</li>
	     * <li>Enable Bridge mode using webpa command \"Device.X_CISCO_COM_DeviceControl.LanManagementEntry.1.LanMode\"</li>
	     * <li>verify whether Bridge mode is enabled using SNMP MIB \"1.3.6.1.4.1.17270.50.2.3.2.1.1.32\"</li>
	     * <li>Verify whether IP tables doesn’t have the port forwarding rules configred in bridge mode</li>
	     * <li>Verify Whether IP tables restore doesn’t fail when device in bridge mode</li>
	     * <li>Disable Bridge mode using webpa command \"Device.X_CISCO_COM_DeviceControl.LanManagementEntry.1.LanMode\"
	     * </li>
	     * <li>Verify whether Bridge mode disabled using SNMP MIB 1.3.6.1.4.1.17270.50.2.3.2.1.1.32</li>
	     * <li>Verify the Private SSID names in both 2.4Ghz and 5Ghz bands using Device.WiFi.SSID.{i}.SSID</li>
	     * <li>Verify the channel number in 2.4Ghz band using \"Device.WiFi.Radio.{i}.Channel\"</li>
	     * <li>Verify the channel number in 5Ghz band using Device.WiFi.Radio.{i}.Channel</li>
	     ...
	     * <li>Verify whether IP tables has the port forwarding rules configured when device in Router Mode</li>
	     * <li>Verify the port forwarding rule for HTTP service can be deleted successfully</li>
	     * <li>Verify the port forwarding feature can be disabled using WebPA</li>
	     * <li>POST-CONDITION 1 : Change the Device back to router mode if it is in Bridge mode</li>
	     * <li>POST-CONDITION 2 : Change the HTTP remote access statuses since we have altered them in STEP 4</li>
	     * <li>POST-CONDITION 3 : Change the channel number in 2Ghz and 5Ghz bands to initial values</li>
	     * <li>POST-CONDITION 4 : Disable auto channel Enable status in both 2.4Ghz and 5Ghz bands</li>
	     * <li>POST-CONDITION 5 : Change the security mode in both 2.4Ghz and 5Ghz bands since we have updated them in STEP5
	     * and STEP6</li>
	     * <li>POST-CONDITION 6 : Delete the new parental control rule created</li>
	     * <li>POST-CONDITION 7 : Verify the port forwarding rule for HTTP service can be deleted successfully</li>
	     * </ol>
	     * 
	     * @param device
	     *            {@link Dut}
		...
		try {
		    ...
		    /**
		     * step 1: Change the private ssid names in both 2.4Ghz and 5Ghz channels. Expected : ssid names must be
		    ...
		    /**
		     * step 2:Change the Default wifi channel numbers in 2.4Ghz channel Expected : Channel number must be
		     * changed successfully
		     * 
		     */
		    testStepNumber = "s2";
		    ...
		    /**
		     * step 3:Change the Default wifi channel numbers in 5Ghz channel Expected : Channel number must be changed
		     * successfully
		     * 
		     */
		    testStepNumber = "s3";
		    ...
		    /**
		     * step 4 : Change the default values of remote access statuses. Expected : values must be changed
		     * successfully
		     */
		    testStepNumber = "s4";
		    ...
		    /**
		     * 
		     * step 5 : Set a parental Control rule. Expected : parental control rule must be set successfully
		     * 
		     */
		    testStepNumber = "s5";
		    ...
		    /**
		     * Step 7: Connect the device to the private Wi-Fi SSID and verify connection status
		     * 
		     */
		    testStepNumber = "S7";
		    ...
		    /**
		     * Step 8: Check if the wireless connected client has an IP address from the gateway
		     *
		     */
		    testStepNumber = "s8";
		    ...
		    /**
		     * Step 11: Check if the wireless connected client has an IP address from the gateway
		     *
		     */
		    testStepNumber = "s11";
		    ...
		    /**
		     * Step 12: Verify the HTTP connection is successful when portforwarding is configured
		     */
		    status = false;
		    testStepNumber = "s12";
		    ...
		    /**
		     * step 13 : Change the security mode of wifi in 2.4Ghz band. Expected : Security mode must be changed
		     * successfully
		     * 
		     */
		    testStepNumber = "s13";
		    ...
		    /**
		     * step 14 : Change the security mode of wifi in 5Ghz band. Expected : Security mode must be changed
		     * successfully
		     * 
		     */
		    testStepNumber = "s14";
		    ...
		    /**
		     * 
		     * step 15 : Enable Bridge mode using webpa Expected : Bridge mode must be enabled successfully
		     * 
		     */
		    testStepNumber = "s15";
		    ...
		    /**
		     * 
		     * step 16 : verify whether Bridge mode enabled using SNMP Expected : Value of the MIB
		     * 1.3.6.1.4.1.17270.50.2.3.2.1.1.32 must be "1" in bridge mode
		     * 
		     */
		    testStepNumber = "s16";
		    ...
		    /**
		     * Step 17: Verify whether IP tables doesn’t have the port forwarding rules configured in bridge mode
		     *
		     */
		    status = false;
		    testStepNumber = "s17";
		    ...
		    /**
		     * Step 18: Verify Whether IP tables restore doesn’t fail when device in bridge mode
		     *
		     */
		    testStepNumber = "s18";
		    ...
		    /**
		     * 
		     * step 19 : Disable Bridge mode using webpa Expected : Bridge mode must be disabled successfully
		     * 
		     */
		    testStepNumber = "s19";
		    ...
		    /**
		     * 
		     * step 20 : Verify whether Bridge mode disabled using SNMP. Expected : Value of snmp mib
		     * 1.3.6.1.4.1.17270.50.2.3.2.1.1.32 must be "2" when the device in router mode
		     * 
		     */
		    testStepNumber = "s20";
		    ...
		    /**
		     * step 21 : Verify the Private SSID names in both 2.4Ghz and 5Ghz bands.. Expected : values of
		     * Device.WiFi.SSID.1.SSID,Device.WiFi.SSID.2.SSID must be same as they are set .
		     * 
		     */
		    testStepNumber = "s21";
		    ...
		    /**
		     * step 22 : Verify the channel number in 2.4Ghz band Expected : channel number must be same as it is set in
		     * step 2.
		     * 
		     */
		    testStepNumber = "s22";
		    ...
		    /**
		     * step 23 : Verify the channel number in 2.4Ghz band Expected : channel number must be same as it is set in
		     * step 2.
		     * 
		     */
		    testStepNumber = "s23";
		    ...
		    /**
		     * step 24 : Verify the values of remote access statuses Expected : Values must be same as the values that
		     * are set in step4
		     * 
		     */
		    testStepNumber = "s24";
		    ...
		    /**
		     * step 25 : Verify the security mode of private wifi in 2.4Ghz band. Expected : Values must be same as the
		     * values that are set in step5
		     * 
		     */
		    testStepNumber = "s25";
		    ...
		    /**
		     * step 26 : Verify the security mode of private wifi in 5Ghz band. Expected : Values must be same as the
		     * values that are set in step6
		     * 
		     */
		    testStepNumber = "s26";
		    ...
		    /**
		     * step 27 : Verify the persistence of parental control rule Expected : Values must be same as the values
		     * that are set in step7
		     * 
		     */
		    testStepNumber = "s27";
		    ...
		    /**
		     * Step 29: Verify the port forwarding rule for HTTP service can be deleted successfully
		     */
		    testStepNumber = "s29";
