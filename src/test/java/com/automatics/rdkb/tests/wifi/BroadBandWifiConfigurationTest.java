...
public class BroadBandWifiConfigurationTest extends AutomaticsTestBase {
    ...
    /**
     * Test Case : Verify that the Preshared key of WIFI access point can be updated & read by admin for 2.4 Ghz
     * 
     * <p>
     * STEPS:
     * </p>
     ...
     * <li>Step 1 : Get and verify the default passphrase for 2.4 GHz SSID using webpa</li>
     * <li>Step 2 : Connect the connected client in the setup to 2.4 GHz SSID and verify connection status</li>
     * <li>Step 3 : Verify the correct IPv4 address for client connected with 2.4 GHz SSID</li>
     * <li>Step 4 : Verify the correct IPv6 address for client connected with 2.4 GHz SSID</li>
     * <li>Step 5 : Verify whether have connectivity using that particular interface using IPV4 for client connected
     * with 2.4 GHz</li>
     * <li>Step 6 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 2.4 GHz</li>
     ...
     * <li>Step 9 : Connect the client to 2.4 GHz Private Wi-Fi Network and verify connection status</li>
     * <li>Step 10 : Verify the correct IPv4 address for client connected with 2.4 GHz SSID</li>
     * <li>Step 11 : Verify the correct IPv6 address for client connected with 2.4 GHz SSID</li>
     * <li>Step 12 : Verify whether have connectivity using that particular interface using IPV4 for client connected
     * with 2.4 GHz</li>
     * <li>Step 13 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 2.4 GHz</li>
	...
	try {
	    ...
	    BroadBandWiFiUtils.verifyIpv4AndIpV6ConnectionInterface(device, testId, deviceConnectedWith2Ghz,
		    stepNumber);
	    /**
	     * Step 14: VERIFY DISCONNECTING THE WIFI CLIENT FROM THE GATEWAY DEVICE FOR 2.4 GHZ
	     */
	    stepNumber = 14;
	    testStepNumber = "S" + stepNumber;
	    status = false;
    ...
    /**
     *
     * Test Case : Verify that the Preshared key of WIFI access point can be updated & read by admin for 5 Ghz
     * 
     * <p>
     * STEPS:
     * </p>
     ...
     * <li>Step 1 : Get and verify the default passphrase for 5 GHz SSID using webpa</li>
     * <li>Step 2 : Connect the connected client in the setup to 5 GHz SSID and verify connection status</li>
     * <li>Step 3 : Verify the correct IPv4 address for client connected with 5 GHz SSID</li>
     * <li>Step 4 : Verify the correct IPv6 address for client connected with 5 GHz SSID</li>
     * <li>Step 5 : Verify whether have connectivity using that particular interface using IPV4 for client connected
     * with 5 GHz</li>
     * <li>Step 6 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 5 GHz</li>
     ...
     * <li>Step 9 : Connect the client to 5 GHz Private Wi-Fi Network and verify connection status</li>
     * <li>Step 10 : Verify the correct IPv4 address for client connected with 5 GHz SSID</li>
     * <li>Step 11 : Verify the correct IPv6 address for client connected with 5 GHz SSID</li>
     * <li>Step 12 : Verify whether have connectivity using that particular interface using IPV4 for client connected
     * with 5 GHz</li>
     * <li>Step 13 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 5 GHz</li>
	...
	try {
	    ...
	    BroadBandWiFiUtils.verifyIpv4AndIpV6ConnectionInterface(device, testId, deviceConnectedWith5Ghz,
		    stepNumber);
	    /**
	     * Step 14: VERIFY DISCONNECTING THE WIFI CLIENT FROM THE GATEWAY DEVICE FOR 5 GHZ
	     */
	    stepNumber = 14;
	    testStepNumber = "S" + stepNumber;
	    status = false;
    ...
    /**
     *
     * Test Case : Verify the WIFI Connectivity on Dual Band Radio 2.4 - 802.11n, 5-802.11ac with security mode WPA2-PSK
     * ( AES )
     *
     * <p>
     * STEPS:
     ...
     * <li>Step 1:Set and verify the value of operational transmission rate of the 2.4 GHz with operating standard as
     * n</li>
     * <li>Step 2:Set and verify the invalid operating standard and verify the process crash</li>
     * <li>Step 3:Set and verify the channel value to 11.</li>
     * <li>Step 4:Set and verify the security mode 'WPA2-Personal' for 2.4 GHz SSID</li>
     * <li>Step 5:Set and verify the security encryption method as 'AES' for 2.4 GHz SSID</li>
     * <li>Step 6:Set and verify the value of operational transmission rate of the 5 GHz with operating standard as
     * ac</li>
     * <li>Step 7:Set and verify the invalid operating standard and verify the process crash</li>
     * <li>Step 8:Set and verify the channel value to 161.</li>
     * <li>Step 9:Set and verify the security mode 'WPA2-Personal' for 5 GHz SSID</li>
     * <li>Step 10:Set and verify the security encryption method as 'AES' for 5 GHz SSID</li>
     * <li>Step 11:Connect the connected client in the setup to 2.4 GHz SSID and verify connection status</li>
     * <li>Step 12 :Verify number of connected clients associated with 2.4 GHz</li>
     * <li>Step 13 :Verify the client mac address and connection type connected with 2.4 GHz</li>
     * <li>Step 14:Connect the connected client in the setup to 5 GHz SSID and verify connection status</li>
     * <li>Step 15 :Verify number of connected clients associated with 5 GHz</li>
     * <li>Step 16 :Verify the client mac address and connection type connected with 5 GHz</li>
     * <li>Step 17 :Verify the correct IPv4 address for client connected with 2.4 GHz SSID</li>
     * <li>Step 18 :Verify the correct IPv6 address for client connected with 2.4 GHz SSID</li>
     * <li>Step 19 :Verify whether have connectivity using that particular interface using IPV4 for client connected
     * with 2.4 GHz</li>
     * <li>Step 20 :Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 2.4 GHz</li>
     * <li>Step 21 :Verify the correct IPv4 address for client connected with 5 GHz SSID</li>
     * <li>Step 22 :Verify the correct IPv6 address for client connected with 5 GHz SSID</li>
	...
	try {
	    ...
	    /**
	     * Step 2 : validate the process crash when trying to set the invalid operating standard for DSL Device -2.4
	     * GHz
	     */
	    ...
	    /**
	     * Step 5 : SET AND VERIFY THE SECURITY ENCRYPTION METHOD AS "AES" FOR 2.4 GHZ SSID
	     */
	    stepNumber++;
	    step = "S" + stepNumber;
	    status = false;
	    ...
	    /**
	     * Step 6 : SET AND VERIFY THE VALUE OF OPERATIONAL TRANSMISSION RATE OF THE 5GHZ WITH OPERATING STANDARD AS
	     * ac
	     */
	    stepNumber++;
	    step = "S" + stepNumber;
	    ...
	    /**
	     * Step 7 : validate the process crash when trying to set the invalid operating standard for DSL Device-5
	     * GHz
	     */
	    ...
	    /**
	     * Step 10 : SET AND VERIFY THE SECURITY ENCRYPTION METHOD AS "AES" FOR 5 GHZ SSID
	     */
	    stepNumber++;
	    step = "S" + stepNumber;
	    status = false;
	    ...
	    verifyIpv4AndIpV6ConnectionInterface(device, testId, deviceConnectedWith5Ghz,
		    BroadBandTestConstants.BAND_5GHZ);
	    /**
	     * Step 25: VERIFY DISCONNECTING THE WIFI CLIENT FROM THE GATEWAY DEVICE FOR 2.4 GHZ
	     */
	    stepNumber++;
	    step = "S" + stepNumber;
	    status = false;
	    ...
	    /**
	     * Step 26: VERIFY DISCONNECTING THE WIFI CLIENT FROM THE GATEWAY DEVICE FOR 5 GHZ.
	     */
	    stepNumber++;
	    step = "S" + stepNumber;
	    status = false;
    ...
    /**
     *
     * Test Case : Verify enable one radio & disable another radio and check the internet connectivity
     *
     * <p>
     * STEPS:
     * </p>
     ...
     * <li>Step 1 : Verify the 2.4Ghz radio Automatic Channel selection is enabled by default</li>
     * <li>Step 2 : Verify the 5Ghz radio Automatic Channel selection is enabled by default</li>
     * <li>Step 3 : Verify for 2.4Ghz radio is enabled by default</li>
     * <li>Step 4 : Verify for 5Ghz radio is enabled by default</li>
     * <li>Step 5 : Set and verify the value of operational transmission rate of the 2.4 GHz with operating standard as
     * g/n</li>
     * <li>Step 6 : Set and verify the value of operational transmission rate of the 5GHz with operating standard as
     * a,n,ac</li>
     ...
     * <li>Step 9 : Verify number of clients associated with 2.4 GHz using webpa</li>
     * <li>Step 10 : Verify the client mac address and connection type connected with 2.4 GHz in LM.txt.0 log file</li>
     * <li>Step 11 : Verify the connected clients details are IP and MAC in Gateway</li>
     * <li>Step 12 : Verify the correct IPv4 address for client connected with 2.4 GHz SSID</li>
     * <li>Step 13 : Verify the correct IPv6 address for client connected with 2.4 GHz SSID</li>
     * <li>Step 14 : Verify whether have connectivity using that particular interface using IPV4 for client connected
     * with 2.4 GHz</li>
     * <li>Step 15 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 2.4 GHz</li>
     * <li>Step 16 : Set and verify new SSID name is broadcasted for 2.4 GHz</li>
     * <li>Step 17 : Connect the connected client in the setup to 2.4 GHz SSID and verify connection status</li>
     * <li>Step 18 : Verify number of clients associated with 2.4 GHz using webpa</li>
     * <li>Step 19 : Verify the client mac address and connection type connected with 2.4 GHz in LM.txt.0 log file</li>
     * <li>Step 20 : Verify the connected clients details are IP and MAC in Gateway</li>
     * <li>Step 21 : Verify the correct IPv4 address for client connected with 2.4 GHz SSID</li>
     * <li>Step 22 : Verify the correct IPv6 address for client connected with 2.4 GHz SSID</li>
     * <li>Step 23 : Verify whether have connectivity using that particular interface using IPV4 for client connected
     * with 2.4 GHz</li>
     ...
     * <li>Step 27 : Connect the connected client in the setup to 5 GHz SSID and verify connection status</li>
     * <li>Step 28 : Verify number of clients associated with 5 GHz using webpa</li>
     * <li>Step 29 : Verify the client mac address and connection type connected with 5 GHz in LM.txt.0 log file</li>
     * <li>Step 30 : Verify the connected clients details are IP and MAC in Gateway</li>
     * <li>Step 31 : Verify the correct IPv4 address for client connected with 5 GHz SSID</li>
     * <li>Step 32 : Verify the correct IPv6 address for client connected with 5 GHz SSID</li>
     * <li>Step 33 : Verify whether have connectivity using that particular interface using IPV4 for client connected
     * with 5 GHz</li>
     * <li>Step 34 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 5 GHz</li>
     * <li>Step 35 : Set and verify new SSID name is broadcasted for 5 GHz</li>
     * <li>Step 36 : Connect the connected client in the setup to 5 GHz SSID and verify connection status</li>
     * <li>Step 37 : Verify number of clients associated with 5 GHz using webpa</li>
     * <li>Step 38 : Verify the client mac address and connection type connected with 5 GHz in LM.txt.0 log file</li>
     * <li>Step 39 : Verify the connected clients details are IP and MAC in Gateway</li>
     * <li>Step 40 : Verify the correct IPv4 address for client connected with 5 GHz SSID</li>
     * <li>Step 41 : Verify the correct IPv6 address for client connected with 5 GHz SSID</li>
     * <li>Step 42 : Verify whether have connectivity using that particular interface using IPV4 for client connected
     * with 5 GHz</li>
     * <li>Step 43 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 5 GHz</li>
	...
	try {
	    ...
	    /**
	     * Step 1 : VERIFY THE 2.4GHZ RADIO AUTOMATIC CHANNEL SELECTION IS ENABLED BY DEFAULT
	     * 
	     */
	    ...
	    /**
	     * Step 2 : VERIFY THE 5GHZ RADIO AUTOMATIC CHANNEL SELECTION IS ENABLED BY DEFAULT
	     * 
	     */
	    stepNumber++;
	    step = "S" + stepNumber;
	    ...
	    /**
	     * Step 5 : SET AND VERIFY THE VALUE OF OPERATIONAL TRANSMISSION RATE OF THE 2.4 GHZ WITH OPERATING STANDARD
	     * AS g/n
	     */
	    stepNumber++;
	    step = "S" + stepNumber;
	    ...
	    /**
	     * Step 6 : SET AND VERIFY THE VALUE OF OPERATIONAL TRANSMISSION RATE OF THE 5 GHZ WITH OPERATING STANDARD
	     * AS a,n,ac
	     */
	    stepNumber++;
	    step = "S" + stepNumber;
	    ...
	    /**
	     * SETP 9-10 : VERIFY THE CLIENT MAC ADDRESS AND CONNECTION TYPE CONNECTED IN /rdklogs/logs/LM.txt.0 LOG
	     */
	    verifyConnectedclientDetails(device, testId, deviceConnectedWith2Ghz, BroadBandTestConstants.BAND_2_4GHZ,
		    BroadBandWebPaConstants.WEBPA_PARAM_2_4_GHZ_ASSOCIATED_DEVICES, deviceDateTime);
	    /**
	    ...
	    /**
	     * SETP 16 : SET AND VERIFY NEW SSID NAME IS BROADCASTED FOR 2.4 GHZ IN CONNECTED CLIENT
	     */
	    stepNumber++;
	    step = "S" + stepNumber;
	    status = false;
	    ...
	    /**
	     * SETP 18-19 : VERIFY THE CLIENT MAC ADDRESS AND CONNECTION TYPE CONNECTED IN /rdklogs/logs/LM.txt.0 LOG
	     */
	    verifyConnectedclientDetails(device, testId, deviceConnectedWith2Ghz, BroadBandTestConstants.BAND_2_4GHZ,
		    BroadBandWebPaConstants.WEBPA_PARAM_2_4_GHZ_ASSOCIATED_DEVICES, deviceDateTime);
	    /**
	    ...
	    /**
	     * SETP 29-30 : VERIFY THE CLIENT MAC ADDRESS AND CONNECTION TYPE CONNECTED IN /rdklogs/logs/LM.txt.0 LOG
	     */
	    verifyConnectedclientDetails(device, testId, deviceConnectedWith5Ghz, BroadBandTestConstants.BAND_5GHZ,
		    BroadBandWebPaConstants.WEBPA_PARAM_5_GHZ_ASSOCIATED_DEVICES, deviceDateTime);
	    ...
	    /**
	     * SETP 36: SET AND VERIFY NEW SSID NAME IS BROADCASTED FOR 5 GHZ IN CONNECTED CLIENT
	     */
	    stepNumber++;
	    step = "S" + stepNumber;
	    status = false;
	    ...
	    /**
	     * SETP 38-39 : VERIFY THE CLIENT MAC ADDRESS AND CONNECTION TYPE CONNECTED IN /rdklogs/logs/LM.txt.0 LOG
	     */
	    verifyConnectedclientDetails(device, testId, deviceConnectedWith5Ghz, BroadBandTestConstants.BAND_5GHZ,
		    BroadBandWebPaConstants.WEBPA_PARAM_5_GHZ_ASSOCIATED_DEVICES, deviceDateTime);
	    ...
	    /**
	     * Step 46: VERIFY DISCONNECTING THE WIFI CLIENT FROM THE GATEWAY DEVICE FOR 5 GHZ
	     */
	    stepNumber++;
	    step = "S" + stepNumber;
	    status = false;
    ...
    /**
     * Test step method used to validate the process crash when trying to set the invalid operating standard for DSL
     * Devices Model
     * 
     * @param device
     *            {@link Dut}
     ...
     *            WiFi frequency band
     * @param webParameter
     *            Web parameter to set
     * @param operatingStd
     *            Operating standard to set
     */
	...
	/**
	 * Step : Verify the process crash while setting invalid operating standard for DSL devices
	 */
	String command = null;
	stepNumber++;
	...
	if (DeviceModeHandler.isDSLDevice(device)
	/*
	 * && !DeviceModeHandler.isGivenModel(device, BroadBandTestConstants.MODEL_NAME_ADA)
	 */) {
    ...
    /**
     *
     * Test Case : Verify the WIFI Connectivity on Dual Band Radio for Client for 2.4 and 5 GHz with security mode Open
     *
     * <p>
     * STEPS:
     * </p>
     * <ol>
     * 
     * <li>PRE CONDITION 1 : Verify the private wifi 2.4 & 5 GHz SSID's is broadcasting in connected client.</li>
     * <li>PRE CONDITION 2 : Get the default value for operating standard 2.4 GHz.</li>
     * <li>PRE CONDITION 3 : Get the default value for operating standard 5 GHz.</li>
     ...
     * <li>PRE CONDITION 6 : Set the channel selection mode to manual and set the respective channel value for 2.4 GHz
     * and 5 GHz via webpa.</li>
     * <li>PRE CONDITION 7 : Verify the security mode as 'None' for 2.4 GHz SSID</li>
     ...
     * <li>Step 1 : Set and verify the value of operation standard as a for 5 GHz.</li>
     * <li>Step 2 : Set and verify the value of operation standard as g for 2.4 GHz.</li>
     * <li>Step 3 : Connect the connected client in the setup to 2.4 GHz SSID and verify connection status.</li>
     * <li>Step 4 : Connect the another client in the setup to 5 GHz SSID and verify connection status.</li>
     * <li>Step 5 : Verify the correct IPv4 address for client connected with 2.4 GHz SSID.</li>
     * <li>Step 6 : Verify the correct IPv6 address for client connected with 2.4 GHz SSID.</li>
     * <li>Step 7 : Verify whether have connectivity using that particular interface using IPV4 for client connected
     * with 2.4 GHz.</li>
     * <li>Step 8 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 2.4 GHz.</li>
     * <li>Step 9 : Verify the correct IPv4 address for client connected with 5 GHz SSID.</li>
     * <li>Step 10 : Verify the correct IPv6 address for client connected with 5 GHz SSID.</li>
     * <li>Step 11 : Verify whether have connectivity using that particular interface using IPV4 for client connected
     * with 5 GHz.</li>
     * <li>Step 12 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 5 GHz.</li>
     * <li>Step 13 : Set and verify the value of operation standard as b for 2.4 GHz</li>
     * <li>Step 14 : Connect the connected client in the setup to 2.4 GHz SSID and verify connection status.</li>
     * <li>Step 15 : Connect the another client in the setup to 5 GHz SSID and verify connection status.</li>
     * <li>Step 16 : Verify the correct IPv4 address for client connected with 2.4 GHz SSID.</li>
     * <li>Step 17 : Verify the correct IPv6 address for client connected with 2.4 GHz SSID.</li>
     * <li>Step 18 : Verify whether have connectivity using that particular interface using IPV4 for client connected
     * with 2.4 GHz.</li>
     * <li>Step 19 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 2.4 GHz.</li>
     * <li>Step 20 : Verify the correct IPv4 address for client connected with 5 GHz SSID.</li>
     * <li>Step 21 : Verify the correct IPv6 address for client connected with 5 GHz SSID.</li>
     * <li>Step 22 : Verify whether have connectivity using that particular interface using IPV4 for client connected
     * with 5 GHz.</li>
     * <li>Step 23 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 5 GHz.</li>
     * <li>Step 24 : Set and verify the value of operation standard as ac for 5GHz</li>
     * <li>Step 25 : Connect the connected client in the setup to 2.4 GHz SSID and verify connection status.</li>
     * <li>Step 26 : Connect the another client in the setup to 5 GHz SSID and verify connection status.</li>
     * <li>Step 27 : Verify the correct IPv4 address for client connected with 2.4 GHz SSID.</li>
     * <li>Step 28 : Verify the correct IPv6 address for client connected with 2.4 GHz SSID.</li>
     * <li>Step 29 : Verify whether have connectivity using that particular interface using IPV4 for client connected
     * with 2.4 GHz.</li>
     * <li>Step 30 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 2.4 GHz.</li>
     * <li>Step 31 : Verify the correct IPv4 address for client connected with 5 GHz SSID.</li>
     * <li>Step 32 : Verify the correct IPv6 address for client connected with 5 GHz SSID.</li>
     * <li>Step 33 : Verify whether have connectivity using that particular interface using IPV4 for client connected
     ...
     * <li>Step 34 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 5 GHz.</li>
     * <li>Step 35 : Set and verify the value of operation standard as n for 2.4 GHz</li>
     * <li>Step 36 : Connect the connected client in the setup to 2.4 GHz SSID and verify connection status.</li>
     * <li>Step 37 : Connect the another client in the setup to 5 GHz SSID and verify connection status.</li>
     * <li>Step 38 : Verify the correct IPv4 address for client connected with 2.4 GHz SSID.</li>
     * <li>Step 39 : Verify the correct IPv6 address for client connected with 2.4 GHz SSID.</li>
     * <li>Step 40 : Verify whether have connectivity using that particular interface using IPV4 for client connected
     * with 2.4 GHz.</li>
     * <li>Step 41 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 2.4 GHz.</li>
     * <li>Step 42 : Verify the correct IPv4 address for client connected with 5 GHz SSID.</li>
     * <li>Step 43 : Verify the correct IPv6 address for client connected with 5 GHz SSID.</li>
     * <li>Step 44 : Verify whether have connectivity using that particular interface using IPV4 for client connected
     * with 5 GHz.</li>
     * <li>Step 45 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 5 GHz.</li>
     * <li>Step 46 : Set and verify the value of operation standard as g for 2.4GHz</li>
     * <li>Step 47 : Connect the connected client in the setup to 2.4 GHz SSID and verify connection status.</li>
     * <li>Step 48 : Connect the another client in the setup to 5 GHz SSID and verify connection status.</li>
     * <li>Step 49 : Verify the correct IPv4 address for client connected with 2.4 GHz SSID.</li>
     * <li>Step 50 : Verify the correct IPv6 address for client connected with 2.4 GHz SSID.</li>
     * <li>Step 51 : Verify whether have connectivity using that particular interface using IPV4 for client connected
     * with 2.4 GHz.</li>
     * <li>Step 52 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 2.4 GHz.</li>
     * <li>Step 53 : Verify the correct IPv4 address for client connected with 5 GHz SSID.</li>
     * <li>Step 54 : Verify the correct IPv6 address for client connected with 5 GHz SSID.</li>
     * <li>Step 55 : Verify whether have connectivity using that particular interface using IPV4 for client connected
     * with 5 GHz.</li>
     * <li>Step 56 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 5 GHz.</li>
     * <li>Step 57 : Verify disconnecting the client connected with 2.4 GHz SSID in the setup.</li>
     * <li>Step 58 : Verify disconnecting the client connected with 5 GHz SSID in the setup.</li>
     * <li>POST CONDITION 1 : Revert the default channel selection mode,operating standard,default channel
     * value,security mode for 2.4 GHz and 5 GHz via webpa</li>
     * <li>POST CONDITION 2 : Set and verify the security mode as 'WPA2-Personal' for 2.4 GHz private wiFi</li>
     * <li>POST CONDITION 3 : Set and verify the security mode as 'WPA2-Personal' for 5 GHz private wiFi</li>
     * </ol>
     * 
     * @param device
     *            {@link Dut}
	...
	try {
	    ...
	    /**
	     * PRE CONDITION 6 : SET THE CHANNEL SELECTION MODE TO MANUAL AND RESPECTIVE CHANNEL VALUE FOR 2.4 & 5 GHz
	     * AND GHz VIA WEBPA.
	     */
	    ...
	    /**
	     * SETP 5 - 8 : VERIFY THE CORRECT IPV4 AND IPV6 ADDRESS FOR CLIENT CONNECTED WITH 2.4 GHz AND INTERNET
	    ...
	    /**
	     * SETP 9 - 12 : VERIFY THE CORRECT IPV4 AND IPV6 ADDRESS FOR CLIENT CONNECTED WITH 5 GHz AND INTERNET
	     * CONNECTIVITY USING IPV4 AND IPV6 INTERFACE.
	     */
	    stepNumber = 9;
	    ...
	    /**
	     * Step 15 : CONNECT THE CONNECTED CLIENT IN THE SETUP TO 5 GHz SSID AND VERIFY CONNECTION STATUS
	     */
	    stepNumber++;
	    BroadBandWiFiUtils.executeTestStepToConnectPrivateWiFiOpenSecurityMode(device, testCaseId,
		    ssidVisibleDeviceTwo, BroadBandTestConstants.BAND_5GHZ, stepNumber);
	    ...
	    /**
	     * SETP 16 - 19 : VERIFY THE CORRECT IPV4 AND IPV6 ADDRESS FOR CLIENT CONNECTED WITH 2.4 GHz AND INTERNET
	     * CONNECTIVITY USING IPV4 AND IPV6 INTERFACE.
	     */
	    stepNumber++;
	    BroadBandWiFiUtils.verifyIpv4AndIpV6ConnectionInterface(device, testCaseId, ssidVisibleDeviceTwo,
	    ...
	    /**
	     * SETP 20 - 23 : VERIFY THE CORRECT IPV4 AND IPV6 ADDRESS FOR CLIENT CONNECTED WITH 5 GHz AND INTERNET
	     * CONNECTIVITY USING IPV4 AND IPV6 INTERFACE.
	     */
	    stepNumber = 23;
	    BroadBandWiFiUtils.verifyIpv4AndIpV6ConnectionInterface(device, testCaseId, ssidVisibleDeviceTwo,
	    ...
	    /**
	     * Step 26 : CONNECT THE CONNECTED CLIENT IN THE SETUP TO 5 GHz SSID AND VERIFY CONNECTION STATUS
	     */
	    stepNumber++;
	    BroadBandWiFiUtils.executeTestStepToConnectPrivateWiFiOpenSecurityMode(device, testCaseId,
		    ssidVisibleDeviceTwo, BroadBandTestConstants.BAND_5GHZ, stepNumber);
	    ...
	    /**
	     * SETP 27 - 30 : VERIFY THE CORRECT IPV4 AND IPV6 ADDRESS FOR CLIENT CONNECTED WITH 2.4 GHz AND INTERNET
	     * CONNECTIVITY USING IPV4 AND IPV6 INTERFACE.
	     */
	    stepNumber++;
	    BroadBandWiFiUtils.verifyIpv4AndIpV6ConnectionInterface(device, testCaseId, ssidVisibleDeviceOne,
	    ...
	    /**
	     * SETP 31 - 34 : VERIFY THE CORRECT IPV4 AND IPV6 ADDRESS FOR CLIENT CONNECTED WITH 5 GHz AND INTERNET
	     * CONNECTIVITY USING IPV4 AND IPV6 INTERFACE.
	     */
	    stepNumber = 31;
	    BroadBandWiFiUtils.verifyIpv4AndIpV6ConnectionInterface(device, testCaseId, ssidVisibleDeviceTwo,
	    ...
	    /**
	     * Step 37 : CONNECT THE CONNECTED CLIENT IN THE SETUP TO 5 GHz SSID AND VERIFY CONNECTION STATUS
	     */
	    stepNumber++;
	    BroadBandWiFiUtils.executeTestStepToConnectPrivateWiFiOpenSecurityMode(device, testCaseId,
		    ssidVisibleDeviceTwo, BroadBandTestConstants.BAND_5GHZ, stepNumber);
	    ...
	    /**
	     * SETP 38 - 41 : VERIFY THE CORRECT IPV4 AND IPV6 ADDRESS FOR CLIENT CONNECTED WITH 2.4 GHz AND INTERNET
	     * CONNECTIVITY USING IPV4 AND IPV6 INTERFACE.
	     */
	    stepNumber++;
	    BroadBandWiFiUtils.verifyIpv4AndIpV6ConnectionInterface(device, testCaseId, ssidVisibleDeviceOne,
	    ...
	    /**
	     * SETP 42 - 45 : VERIFY THE CORRECT IPV4 AND IPV6 ADDRESS FOR CLIENT CONNECTED WITH 5 GHz AND INTERNET
	     * CONNECTIVITY USING IPV4 AND IPV6 INTERFACE.
	     */
	    stepNumber = 42;
	    BroadBandWiFiUtils.verifyIpv4AndIpV6ConnectionInterface(device, testCaseId, ssidVisibleDeviceTwo,
	    ...
	    /**
	     * Step 48 : CONNECT THE CONNECTED CLIENT IN THE SETUP TO 5 GHz SSID AND VERIFY CONNECTION STATUS
	     */
	    stepNumber++;
	    BroadBandWiFiUtils.executeTestStepToConnectPrivateWiFiOpenSecurityMode(device, testCaseId,
		    ssidVisibleDeviceTwo, BroadBandTestConstants.BAND_5GHZ, stepNumber);
	    ...
	    /**
	     * SETP 49 - 52 : VERIFY THE CORRECT IPV4 AND IPV6 ADDRESS FOR CLIENT CONNECTED WITH 2.4 GHz AND INTERNET
	     * CONNECTIVITY USING IPV4 AND IPV6 INTERFACE.
	     */
	    stepNumber++;
	    BroadBandWiFiUtils.verifyIpv4AndIpV6ConnectionInterface(device, testCaseId, ssidVisibleDeviceOne,
	    ...
	    /**
	     * SETP 53-56 : VERIFY THE CORRECT IPV4 AND IPV6 ADDRESS FOR CLIENT CONNECTED WITH 5 GHz AND INTERNET
	     * CONNECTIVITY USING IPV4 AND IPV6 INTERFACE.
	     */
	    stepNumber = 53;
	    BroadBandWiFiUtils.verifyIpv4AndIpV6ConnectionInterface(device, testCaseId, ssidVisibleDeviceTwo,
	    ...
	    /**
	     * Step 57: VERIFY DISCONNECTING THE WIFI CLIENT FROM THE GATEWAY DEVICE FOR 2.4 GHz
	     */
	    stepNumber = 57;
	    ...
	    /**
	     * Step 58: VERIFY DISCONNECTING THE WIFI CLIENT FROM THE GATEWAY DEVICE FOR 2.4 GHz
	     */
	    stepNumber++;
	    ...
	    /**
	     * POST CONDITION 1 : REVERT THE DEFAULT CHANNEL SELECTION MODE, OPERATING STANDARD, DEFAULT CHANNEL VALUE,
	     * SECURITY MODE FOR 2 GHz AND 5 GHz
	     */
	    executePostConditionToSetChannelAndOprStd(device);

	    /**
	     * POST CONDITION 2 : SET AND VERIFY THE SECURITY MODE FOR 2.4 AND 5 GHz PRIVATE WIFI
	     */
    ...
    /**
     * PRE-CONDITION METHOD TO SET THE CHANNEL SELECTION MODE TO MANUAL AND RESPECTIVE CHANNEL VALUE FOR 2.4 GHz AND 5
     * GHz.
     * 
     * @param device
     *            {@link Dut}
     ...
     * @param stepNumber
     *            Test step number
     * @param wifiOperatingStandard
     *            Operating standard for 2.4/5 GHz
     * 
     */
    ...
    /**
     * PRE-CONDITION METHOD TO REVERT THE DEFAULT CHANNEL SELECTION MODE,OPERATING STANDARD,DEFAULT CHANNEL VALUE FOR
     * 2.4 GHz AND 5 GHz VIA WEBPA.
     * 
     * @param device
     *            {@link Dut}
     */
    ...
    /**
     *
     * Test Case : Verify the default channel bandwidth and enable & disable the radio for 2.4GHz & 5GHz with connected
     * clients
     * 
     *
     * <p>
     ...
     * <li>Step 7 : Verify the client mac address and connection type connected with 2.4 GHz in LM.txt.0 log file</li>
     * <li>Step 8 : Verify the connected clients details are IP and MAC in Gateway</li>
     ...
     * <li>Step 14: Verify the private wifi 2.4 GHz SSID is broadcasting in connected client</li>
     * <li>Step 15: Verify 2.4 GHz radio is reenabled</li>
     * <li>Step 16: Verify the private wifi 2.4 GHz SSID is broadcasting in connected client</li>
     * <li>Step 17: Connect the connected client in the setup to 2.4 GHz SSID and verify connection status after 2.4 GHz
     * radio is reenabled</li>
     ...
     * <li>Step 26: Connect the connected client in the setup to 5 GHz SSID and verify connection status</li>
     * <li>Step 27: Verify client associated with 5 GHz using webpa</li>
     * <li>Step 28: Verify the client mac address and connection type connected with 5 GHz in LM.txt.0 log file</li>
     * <li>Step 29: Verify the connected clients details are IP and MAC in Gateway</li>
     * <li>Step 30: Verify the correct IPv4 address for client connected with 5 GHz SSID</li>
     * <li>Step 31: Verify the correct IPv6 address for client connected with 5 GHz SSID</li>
     * <li>Step 32: Verify whether have connectivity using that particular interface using IPV4 for client connected
     * with 5 GHz</li>
     * <li>Step 33: Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 5 GHz</li>
     * <li>Step 34: Verify 5 GHz radio is disabled</li>
     * <li>Step 35: Verify the private wifi 5 GHz SSID is broadcasting in connected client</li>
     * <li>Step 36: Verify 5 GHz radio is reenabled</li>
     * <li>Step 37: Verify the private wifi 5 GHz SSID is broadcasting in connected client</li>
     * <li>Step 38: Connect the connected client in the setup to 5 GHz SSID and verify connection status after 5 GHz
     * radio is reenabled</li>
     * <li>Step 39: Verify client associated with 5 GHz using webpa</li>
     * <li>Step 40: Verify the client mac address and connection type connected with 5 GHz in LM.txt.0 log file</li>
     * <li>Step 41: Verify the connected clients details are IP and MAC in Gateway</li>
     * <li>Step 42: Verify the correct IPv4 address for client connected with 5 GHz SSID</li>
     * <li>Step 43: Verify the correct IPv6 address for client connected with 5 GHz SSID</li>
     * <li>Step 44: Verify whether have connectivity using that particular interface using IPV4 for client connected
     * with 5 GHz</li>
	...
	try {
	    ...
	    tapEnv.updateExecutionStatus(device, testId, step, status, errorMessage, true);
	    /**
	     * Step 14 : VERIFY THE PRIVATE WIFI 2.4 GHZ SSID IS BROADCASTING IN CONNECTED CLIENT
	     */
	    stepNumber++;
	    step = "S" + stepNumber;
	    status = false;
	    ...
	    tapEnv.updateExecutionStatus(device, testId, step, status, errorMessage, true);
	    /**
	     * Step 16 : VERIFY THE PRIVATE WIFI 2.4 GHZ SSID IS BROADCASTING IN CONNECTED CLIENT,WHEN 2.4 GHZ RADIO IS
	     * REENABLED
	     */
	    stepNumber++;
	    step = "S" + stepNumber;
	    ...
	    tapEnv.updateExecutionStatus(device, testId, step, status, errorMessage, true);
	    /**
	     * Step 17 : CONNECT THE CONNECTED CLIENT IN THE SETUP TO 2.4 GHZ SSID AND VERIFY CONNECTION STATUS AFTER
	     * 2.4 GHZ RADIO IS REENABLED
	     */
	    stepNumber++;
	    step = "S" + stepNumber;
	    status = false;
	    ...
	    /**
	     * SETP 27-28 : VERIFY THE CLIENT MAC ADDRESS AND CONNECTION TYPE CONNECTED IN /rdklogs/logs/LM.txt.0 LOG
	     */
	    ...
	    tapEnv.updateExecutionStatus(device, testId, step, status, errorMessage, true);
	    /**
	     * Step 35 : VERIFY THE PRIVATE WIFI 5 GHZ SSID IS BROADCASTING IN CONNECTED CLIENT
	     */
	    stepNumber++;
	    step = "S" + stepNumber;
	    status = false;
	    ...
	    tapEnv.updateExecutionStatus(device, testId, step, status, errorMessage, true);
	    /**
	     * Step 37 : VERIFY THE PRIVATE WIFI 5 GHZ SSID IS BROADCASTING IN CONNECTED CLIENT,WHEN 5 GHZ RADIO IS
	     * REENABLED
	     */
	    stepNumber++;
	    step = "S" + stepNumber;
	    ...
	    tapEnv.updateExecutionStatus(device, testId, step, status, errorMessage, true);
	    /**
	     * Step 38 : CONNECT THE CONNECTED CLIENT IN THE SETUP TO 5 GHZ SSID AND VERIFY CONNECTION STATUS AFTER 5
	     * GHZ RADIO IS REENABLED
	     */
	    stepNumber++;
	    step = "S" + stepNumber;
	    status = false;
	    ...
	    /**
	     * SETP 39-40 : VERIFY THE CLIENT MAC ADDRESS AND CONNECTION TYPE CONNECTED IN /rdklogs/logs/LM.txt.0 LOG
	     */
	    verifyConnectedclientDetailsWithGivenClient(device, testId, deviceConnectedWith5Ghz,
		    BroadBandTestConstants.BAND_5GHZ,
		    BroadBandWebPaConstants.WEBPA_PARAM_FOR_CONNECTED_DEVICES_DETAILS.replace(
    ...
    /**
     *
     * Test Case : Verify the WIFI Connectivity on Dual Band Radio for Client for 2.4 and 5 GHz with security mode
     * WPA2-PSK
     *
     * <p>
     * STEPS:
     * </p>
     * <ol>
     * <li>PRE CONDITION 1 : Verify the private wifi 2.4 GHz & 5 GHz SSID's is broadcasting in connected client.</li>
     * <li>PRE CONDITION 2 : Get the default value for operating standard 2.4 GHz.</li>
     * <li>PRE CONDITION 3 : Get the default value for operating standard 5 GHz.</li>
     * <li>PRE CONDITION 4 : Get the default channel value for 2.4 GHz</li>
     * <li>PRE CONDITION 5 : Get the default channel value for 5 GHz.</li>
     * <li>PRE CONDITION 6 : Set the channel selection mode to manual and respective channel value for 2.4 GHz and 5 GHz
     * via webpa.</li>
     * <li>PRE CONDITION 7 : Verify the security mode as 'WPA2-Personal' for 2.4 GHz SSID</li>
     * <li>PRE CONDITION 8 : Verify the security mode as 'WPA2-Personal' for 5 GHz SSID</li>
     * <li>Step 1 : Set and verify the value of operation standard as a for 5 GHz.</li>
     * <li>Step 2 : Set and verify the value of operation standard as b for 2.4 GHz.</li>
     * <li>Step 3 : Connect the connected client in the setup to 2.4 GHz SSID and verify connection status.</li>
     * <li>Step 4 : Connect the another client in the setup to 5 GHz SSID and verify connection status.</li>
     * <li>Step 5 : Verify the correct IPv4 address for client connected with 2.4 GHz SSID.</li>
     * <li>Step 6 : Verify the correct IPv6 address for client connected with 2.4 GHz SSID.</li>
     ...
     * <li>Step 12 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 5 GHz.</li>
     * <li>Step 13 : Set and verify the value of operation standard as n for 2.4 GHz</li>
     * <li>Step 14 : Connect the connected client in the setup to 2.4 GHz SSID and verify connection status.</li>
     * <li>Step 15 : Connect the another client in the setup to 5 GHz SSID and verify connection status.</li>
     * <li>Step 16 : Verify the correct IPv4 address for client connected with 2.4 GHz SSID.</li>
     * <li>Step 17 : Verify the correct IPv6 address for client connected with 2.4 GHz SSID.</li>
     ...
     * <li>Step 23 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 5 GHz.</li>
     * <li>Step 24 : Set and verify the value of operation standard as ac for 5 GHz</li>
     * <li>Step 25 : Connect the connected client in the setup to 2.4 GHz SSID and verify connection status.</li>
     * <li>Step 26 : Connect the another client in the setup to 5 GHz SSID and verify connection status.</li>
     * <li>Step 27 : Verify the correct IPv4 address for client connected with 2.4 GHz SSID.</li>
     * <li>Step 28 : Verify the correct IPv6 address for client connected with 2.4 GHz SSID.</li>
     ...
     * <li>Step 34 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 5 GHz.</li>
     * <li>Step 35 : Set and verify the value of operation standard as b for 2.4 GHz</li>
     * <li>Step 36 : Connect the connected client in the setup to 2.4 GHz SSID and verify connection status.</li>
     * <li>Step 37 : Connect the another client in the setup to 5 GHz SSID and verify connection status.</li>
     * <li>Step 38 : Verify the correct IPv4 address for client connected with 2.4 GHz SSID.</li>
     * <li>Step 39 : Verify the correct IPv6 address for client connected with 2.4 GHz SSID.</li>
     ...
     * <li>Step 45 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 5 GHz.</li>
     * <li>Step 46 : Set and verify the value of operation standard as g for 2.4 GHz</li>
     * <li>Step 47 : Set and verify the value of operation standard as n for 5 GHz</li>
     * <li>Step 48 : Connect the connected client in the setup to 2.4 GHz SSID and verify connection status.</li>
     * <li>Step 49 : Connect the another client in the setup to 5 GHz SSID and verify connection status.</li>
     * <li>Step 50 : Verify the correct IPv4 address for client connected with 2.4 GHz SSID.</li>
     * <li>Step 51 : Verify the correct IPv6 address for client connected with 2.4 GHz SSID.</li>
     * <li>Step 52 : Verify whether have connectivity using that particular interface using IPV4 for client connected
     * with 2.4 GHz.</li>
     * <li>Step 53 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 2.4 GHz.</li>
     * <li>Step 54 : Verify the correct IPv4 address for client connected with 5 GHz SSID.</li>
     * <li>Step 55 : Verify the correct IPv6 address for client connected with 5 GHz SSID.</li>
     * <li>Step 56 : Verify whether have connectivity using that particular interface using IPV4 for client connected
     * with 5 Ghz.</li>
     * <li>Step 57 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 5 Ghz.</li>
     * <li>Step 58 : Set and verify the value of operation standard as n for 2.4 GHz</li>
     * <li>Step 59 : Connect the connected client in the setup to 2.4 GHz SSID and verify connection status.</li>
     * <li>Step 60 : Connect the another client in the setup to 5 GHz SSID and verify connection status.</li>
     * <li>Step 61 : Verify the correct IPv4 address for client connected with 2.4 GHz SSID.</li>
     * <li>Step 62 : Verify the correct IPv6 address for client connected with 2.4 GHz SSID.</li>
     * <li>Step 63 : Verify whether have connectivity using that particular interface using IPV4 for client connected
     * with 2.4 GHz.</li>
     * <li>Step 64 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 2.4 GHz.</li>
     * <li>Step 65 : Verify the correct IPv4 address for client connected with 5 GHz SSID.</li>
     * <li>Step 66 : Verify the correct IPv6 address for client connected with 5 GHz SSID.</li>
     * <li>Step 67 : Verify whether have connectivity using that particular interface using IPV4 for client connected
     * with 5 GHz.</li>
     * <li>Step 68 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 5 GHz.</li>
     * <li>Step 69 : Verify disconnecting the client connected with 2.4 GHz SSID in the setup.</li>
     * <li>Step 70 : Verify disconnecting the client connected with 5 GHz SSID in the setup.</li>
     * <li>POST CONDITION 1 : Revert the default channel selection mode,operating standard,default channel value for 2.4
     * GHz and 5 GHz</li>
     * </ol>
     * 
     * @param device
	...
	try {
	    ...
	    /**
	     * PRE CONDITION 6 : SET THE CHANNEL SELECTION MODE TO MANUAL AND RESPECTIVE CHANNEL VALUE FOR 2.4 GHz AND 5
	     * GHz VIA WEBPA.
	     */
	    executePreConditionToSetChannel(device);

	    /**
	     * PRE-CONDITION 7-8 : VERIFY THE SECURITY MODE "WPA2-Personal" FOR 2.4 and 5 GHz SSID
	     */
	    preConStepNumber++;
	    BroadBandPreConditionUtils.executePreConditionToSetSecurityMode(device, tapEnv, preConStepNumber,
		    BroadBandTestConstants.SECURITY_MODE_WPA2_PERSONAL);
	    ...
	    /**
	     * Step 4 : CONNECT THE CONNECTED CLIENT IN THE SETUP TO 5 GHz SSID AND VERIFY CONNECTION STATUS
	     */
	    stepNumber++;
	    ...
	    /**
	     * Step 49 : CONNECT THE CONNECTED CLIENT IN THE SETUP TO 5 GHz SSID AND VERIFY CONNECTION STATUS
	     */
	    stepNumber++;
	    BroadBandWiFiUtils.executeTestStepToConnectPrivateWiFi(device, testCaseId, ssidVisibleDeviceTwo,
		    BroadBandTestConstants.BAND_5GHZ, stepNumber);
	    ...
	    /**
	     * SETP 50 - 53 : VERIFY THE CORRECT IPV4 AND IPV6 ADDRESS FOR CLIENT CONNECTED WITH 2.4 GHz AND INTERNET
	     * CONNECTIVITY USING IPV4 AND IPV6 INTERFACE.
	     */
	    stepNumber++;
	    BroadBandWiFiUtils.verifyIpv4AndIpV6ConnectionInterface(device, testCaseId, ssidVisibleDeviceOne,
	    ...
	    /**
	     * SETP 54 - 57 : VERIFY THE CORRECT IPV4 AND IPV6 ADDRESS FOR CLIENT CONNECTED WITH 5 GHz AND INTERNET
	     * CONNECTIVITY USING IPV4 AND IPV6 INTERFACE.
	     */
	    stepNumber = 54;
	    BroadBandWiFiUtils.verifyIpv4AndIpV6ConnectionInterface(device, testCaseId, ssidVisibleDeviceTwo,
	    ...
	    /**
	     * Step 60 : CONNECT THE CONNECTED CLIENT IN THE SETUP TO 5 GHz SSID AND VERIFY CONNECTION STATUS
	     */
	    stepNumber++;
	    BroadBandWiFiUtils.executeTestStepToConnectPrivateWiFi(device, testCaseId, ssidVisibleDeviceTwo,
		    BroadBandTestConstants.BAND_5GHZ, stepNumber);
	    ...
	    /**
	     * SETP 61 - 64 : VERIFY THE CORRECT IPV4 AND IPV6 ADDRESS FOR CLIENT CONNECTED WITH 2.4 GHz AND INTERNET
	     * CONNECTIVITY USING IPV4 AND IPV6 INTERFACE.
	     */
	    stepNumber++;
	    BroadBandWiFiUtils.verifyIpv4AndIpV6ConnectionInterface(device, testCaseId, ssidVisibleDeviceOne,
	    ...
	    /**
	     * SETP 65 - 68 : VERIFY THE CORRECT IPV4 AND IPV6 ADDRESS FOR CLIENT CONNECTED WITH 5 GHz AND INTERNET
	     * CONNECTIVITY USING IPV4 AND IPV6 INTERFACE.
	     */
	    stepNumber = 65;
	    BroadBandWiFiUtils.verifyIpv4AndIpV6ConnectionInterface(device, testCaseId, ssidVisibleDeviceTwo,
	    ...
	    /**
	     * Step 69 : VERIFY DISCONNECTING THE WIFI CLIENT FROM THE GATEWAY DEVICE FOR 2.4 GHz
	     */
	    stepNumber = 69;
	    BroadBandWiFiUtils.executeTestStepToDisconnectPrivateWiFi(device, testCaseId, ssidVisibleDeviceOne,
		    BroadBandTestConstants.BAND_2_4GHZ, stepNumber);
	    ...
	    /**
	     * Step 70 : VERIFY DISCONNECTING THE WIFI CLIENT FROM THE GATEWAY DEVICE FOR 2.4 GHz
	     */
	    stepNumber++;
	    BroadBandWiFiUtils.executeTestStepToDisconnectPrivateWiFi(device, testCaseId, ssidVisibleDeviceTwo,
		    BroadBandTestConstants.BAND_5GHZ, stepNumber);
	    ...
	    LOGGER.info("POST-CONDITION STEPS:");
	    /**
	     * POST CONDITION 1 : REVERT THE DEFAULT CHANNEL SELECTION MODE,OPERATING STANDARD,DEFAULT CHANNEL VALUE FOR
	     * 2.4 GHz AND 5 GHz VIA WEBPA.
	     */
	    executePostConditionToSetChannelAndOprStd(device);
	    LOGGER.info("################### COMPLETED POST-CONFIGURATIONS ###################");
     ...
     * <li>PRE CONDITION 6 : Set the channel selection mode to manual and respective channel value for 2.4 GHz and 5 GHz
     * via webpa.</li>
     * <li>PRE CONDITION 7 : Verify the security mode as 'WPA-WPA2-Personal' for 2.4 GHz SSID</li>
     * <li>PRE CONDITION 8 : Verify the security mode as 'WPA-WPA2-Personal' for 5 GHz SSID</li>
     * <li>PRE CONDITION 9 : Perform apply settings for 2.4 and 5 GHz radio's</li>
     * <li>Step 1 : Set and verify the value of operation standard as n for 5 GHz.</li>
     * <li>Step 2 : Set and verify the value of operation standard as n for 2 GHz.</li>
     * <li>Step 3 : Connect the connected client in the setup to 2.4 GHz SSID and verify connection status.</li>
     * <li>Step 4 : Connect the another client in the setup to 5 GHz SSID and verify connection status.</li>
     * <li>Step 5 : Verify the correct IPv4 address for client connected with 2.4 GHz SSID.</li>
     * <li>Step 6 : Verify the correct IPv6 address for client connected with 2.4 GHz SSID.</li>
     ...
     * <li>Step 12 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 5 GHz.</li>
     * <li>Step 13 : Set and verify the value of operation standard as g for 2.4 GHz</li>
     * <li>Step 14 : Connect the connected client in the setup to 2.4 GHz SSID and verify connection status.</li>
     * <li>Step 15 : Connect the another client in the setup to 5 GHz SSID and verify connection status.</li>
     * <li>Step 16 : Verify the correct IPv4 address for client connected with 2.4 GHz SSID.</li>
     * <li>Step 17 : Verify the correct IPv6 address for client connected with 2.4 GHz SSID.</li>
     ...
     * <li>Step 23 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 5 GHz.</li>
     * <li>Step 24 : Set and verify the value of operation standard as b for 2.4 GHz</li>
     * <li>Step 25 : Connect the connected client in the setup to 2.4 GHz SSID and verify connection status.</li>
     * <li>Step 26 : Connect the another client in the setup to 5 GHz SSID and verify connection status.</li>
     * <li>Step 27 : Verify the correct IPv4 address for client connected with 2.4 GHz SSID.</li>
     * <li>Step 28 : Verify the correct IPv6 address for client connected with 2.4 GHz SSID.</li>
     ...
     * <li>Step 34 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 5 GHz.</li>
     * <li>Step 35 : Set and verify the value of operation standard as ac for 5 GHz</li>
     * <li>Step 36 : Connect the connected client in the setup to 2.4 GHz SSID and verify connection status.</li>
     * <li>Step 37 : Connect the another client in the setup to 5 GHz SSID and verify connection status.</li>
     * <li>Step 38 : Verify the correct IPv4 address for client connected with 2.4 GHz SSID.</li>
     * <li>Step 39 : Verify the correct IPv6 address for client connected with 2.4 GHz SSID.</li>
     ...
     * <li>Step 42 : Verify the correct IPv4 address for client connected with 5 GHz SSID.</li>
     * <li>Step 43 : Verify the correct IPv6 address for client connected with 5 GHz SSID.</li>
     * <li>Step 43 : Verify whether have connectivity using that particular interface using IPV4 for client connected
     * with 5 GHz.</li>
     * <li>Step 45 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 5 GHz.</li>
     * <li>Step 46 : Set and verify the value of operation standard as a for 5 GHz</li>
     * <li>Step 47 : Connect the connected client in the setup to 2.4 GHz SSID and verify connection status.</li>
     * <li>Step 48 : Connect the another client in the setup to 5 GHz SSID and verify connection status.</li>
     * <li>Step 49 : Verify the correct IPv4 address for client connected with 2.4 GHz SSID.</li>
     * <li>Step 50 : Verify the correct IPv6 address for client connected with 2.4 GHz SSID.</li>
     ...
     * <li>Step 56 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 5 Ghz.</li>
     * <li>Step 57 : Set and verify the value of operation standard as g for 2.4 GHz</li>
     * <li>Step 58 : Connect the connected client in the setup to 2.4 GHz SSID and verify connection status.</li>
     * <li>Step 59 : Connect the another client in the setup to 5 GHz SSID and verify connection status.</li>
     * <li>Step 60 : Verify the correct IPv4 address for client connected with 2.4 GHz SSID.</li>
     * <li>Step 61 : Verify the correct IPv6 address for client connected with 2.4 GHz SSID.</li>
     * <li>Step 62 : Verify whether have connectivity using that particular interface using IPV4 for client connected
     * with 2.4 GHz.</li>
     * <li>Step 63 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 2.4 GHz.</li>
     * <li>Step 64 : Verify the correct IPv4 address for client connected with 5 GHz SSID.</li>
     * <li>Step 65 : Verify the correct IPv6 address for client connected with 5 GHz SSID.</li>
     * <li>Step 66 : Verify whether have connectivity using that particular interface using IPV4 for client connected
     * with 5 GHz.</li>
     * <li>Step 67 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with 5 GHz.</li>
     * <li>Step 68 : Verify disconnecting the client connected with 2.4 GHz SSID in the setup.</li>
     * <li>Step 69 : Verify disconnecting the client connected with 5 GHz SSID in the setup.</li>
     * <li>POST CONDITION 1 : Revert the default channel selection mode,operating standard,default channel
     * value,security mode for 2.4 GHz and 5 GHz</li>
     * <li>POST CONDITION 2 : Set and verify the security mode as 'WPA2-Personal' for 2.4 GHz private WiFi</li>
     * <li>POST CONDITION 3 : Set and verify the security mode as 'WPA2-Personal' for 5 GHz private WiFi</li>
     * 
     * </ol>
	...
	try {
	    ...
	    /**
	     * PRE CONDITION 6 : SET THE CHANNEL SELECTION MODE TO MANUAL AND RESPECTIVE CHANNEL VALUE FOR 2 GHz AND 5
	     * GHz VIA WEBPA.
	     */
	    executePreConditionToSetChannel(device);

	    /**
	     * PRE-CONDITION 7-8 : VERIFY THE SECURITY MODE "WPA-WPA2-Personal" FOR 2.4 and 5 GHz SSID
	     */
	    preConStepNumber++;
	    BroadBandPreConditionUtils.executePreConditionToSetSecurityMode(device, tapEnv, preConStepNumber,
	    ...
	    /**
	     * Step 59 : CONNECT THE CONNECTED CLIENT IN THE SETUP TO 5 GHz SSID AND VERIFY CONNECTION STATUS
	     */
	    stepNumber++;
	    BroadBandWiFiUtils.executeTestStepToConnectPrivateWiFi(device, testCaseId, ssidVisibleDeviceTwo,
		    BroadBandTestConstants.BAND_5GHZ, stepNumber);
	    ...
	    /**
	     * SETP 60 - 63 : VERIFY THE CORRECT IPV4 AND IPV6 ADDRESS FOR CLIENT CONNECTED WITH 2.4 GHz AND INTERNET
	     * CONNECTIVITY USING IPV4 AND IPV6 INTERFACE.
	     */
	    stepNumber++;
	    BroadBandWiFiUtils.verifyIpv4AndIpV6ConnectionInterface(device, testCaseId, ssidVisibleDeviceOne,
	    ...
	    /**
	     * SETP 64 - 67 : VERIFY THE CORRECT IPV4 AND IPV6 ADDRESS FOR CLIENT CONNECTED WITH 5 GHz AND INTERNET
	     * CONNECTIVITY USING IPV4 AND IPV6 INTERFACE.
	     */
	    stepNumber = 64;
	    BroadBandWiFiUtils.verifyIpv4AndIpV6ConnectionInterface(device, testCaseId, ssidVisibleDeviceTwo,
	    ...
	    /**
	     * Step 68: VERIFY DISCONNECTING THE WIFI CLIENT FROM THE GATEWAY DEVICE FOR 2.4 GHz
	     */
	    stepNumber = 68;
	    BroadBandWiFiUtils.executeTestStepToDisconnectPrivateWiFi(device, testCaseId, ssidVisibleDeviceOne,
		    BroadBandTestConstants.BAND_2_4GHZ, stepNumber);
	    ...
	    /**
	     * POST CONDITION 1 : REVERT THE DEFAULT CHANNEL SELECTION MODE, OPERATING STANDARD, DEFAULT CHANNEL VALUE,
	     * SECURITY MODE FOR 2.4 GHz AND 5 GHz
	     */
	    executePostConditionToSetChannelAndOprStd(device);
