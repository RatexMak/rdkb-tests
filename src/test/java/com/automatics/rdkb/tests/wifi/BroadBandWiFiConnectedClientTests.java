...
public class BroadBandWiFiConnectedClientTests extends AutomaticsTestBase {
	...
	/**
	 * Device device MUST have the ability to change from a/n/ac to ac only, a/n/ac
	 * to n only, a-n-ac to n-ac only radio
	 * 
	 * <p>
	 * STEPS:
	 * </p>
	 ...
	 * <li>Step 3: Change the mode of operation in 5GHz client from 802.11a/n/ac to
	 * 802.11ac and verify the status</li>
	...
	public void testVerifyChangeOperatingModeFor5GHz(Dut device) {
		...
		try {
			...
			/**
			 * Step4 : Change the mode of operation in 5GHz client to 802.11 ac; Change the
			 * mode of operation in 5GHz client to 802.11a/n/ac for devices
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			if (CommonMethods.isAtomSyncAvailable(device, tapEnv) || (DeviceModeHandler.isDSLDevice(device))) {
				...
				/**
				 * Step7 : Change the mode of operation in 5GHz client to 802.11 n; For devices
				 * change mode from a/n/ac to a/n/ac/ax
				 */
				LOGGER.info("**********************************************************************************");
				LOGGER.info(
	 ...
	 * <li>12. Verify wifiClient enable status set to default state after factory
	 * reset</li>
	 * <li>13. Verify wificlient schema using
	 * Device.WiFi.X_RDKCENTRAL-COM_Report.WifiClient.Schema after factory
	 * reset</li>
	 * <li>14. Verify wifiClient mac address reset to default value after factory
	 * reset</li>
	 * 
