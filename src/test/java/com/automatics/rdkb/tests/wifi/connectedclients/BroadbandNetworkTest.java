...
/***
 * Class to hold the test cases related to the network connectivity tests in
...
public class BroadbandNetworkTest extends AutomaticsTestBase {
	 ...
	 * <li>Execute the nslookup command for google.com in ethernet client
	 * connected</li>
	 * </ol>
	 * 
	 * @author Ramees KV
	...
	/**
	 * Test Steps to validate primary , seconday DNS IP from UI, webpa & Connected
	 * client
	 * 
	 * @param device           {@link Dut}
	 * @param tapEnv           instance of {@link AutomaticsTapApi}
	 * @param testCaseId       Test Case ID
	 * @param stepNumber       Pre condition number
	 * @param connectedClient  Connected Client Object (Ethernet/Wifi)
	 * @param webpaResponseMap To hold the WEBPA response in Map
	 */
