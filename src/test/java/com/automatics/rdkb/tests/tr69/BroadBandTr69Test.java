...
import com.automatics.rdkb.utils.tr69.TR69WriteAccessParameters;
...
public class BroadBandTr69Test extends AutomaticsTestBase {
	...
	/**
	 * 
	 * This method verifies whether WiFi SSID objects can be enabled disabled via
	 * TR69
	 * 
	 * <ol>
	 * <li>stepNumber 1: Execute set Parameter on Device.WiFi.SSID.10001.Enable (2.4
	 * GHZ private SSID) to False</li>
	 * <li>stepNumber 2: Verify using SNMP the private 2.4GHZ SSID is disabled using
	 * .1.3.6.1.4.1.17270.50.2.2.2.1.1.2.10001</li>
	 * <li>stepNumber 3: Verify from WebPa using the parameter
	 * Device.WiFi.SSID.10001.Enable that the 2.4 GHZ SSID is disabled</li>
	 * <li>stepNumber 4: Execute get Parameter on the Device.WiFi.SSID.10001.Enable
	 * and verify that it is false</li>
	 * <li>stepNumber 5: Execute get Parameter on Device.WiFi.SSID.10001.Status and
	 * verify that it is down</li>
	 * <li>stepNumber 6: Execute get Parameter on Device.WiFi.SSID.10001.LastChange
	 * and verify that it shows appropriate time in seconds</li>
	 * <li>stepNumber 7: Execute set Parameter on Device.WiFi.SSID.10001.Enable (2.4
	 * GHZ private SSID) to True</li>
	 * <li>stepNumber 8: Verify using SNMP the private 2.4GHZ SSID is disabled using
	 * .1.3.6.1.4.1.17270.50.2.2.2.1.1.2.10001</li>
	 * <li>stepNumber 9: Verify from WebPa using the parameter
	 * Device.WiFi.SSID.10001.Enable that the 2.4 GHZ SSID is disabled</li>
	 * <li>stepNumber 10: Execute get Parameter on the Device.WiFi.SSID.10001.Enable
	 * and verify that it is true</li>
	 * <li>stepNumber 11: Execute get Parameter on Device.WiFi.SSID.10001.Status and
	 * verify that it is Up</li>
	 * <li>stepNumber 12: Execute get Parameter on Device.WiFi.SSID.10001.LastChange
	 * and verify that it shows appropriate time in seconds</li>
	 * <li>stepNumber 13: Execute set Parameter on Device.WiFi.SSID.10101.Enable (5
	 * GHZ private SSID) to false</li>
	 * <li>stepNumber 14: Verify using SNMP the private 5GHZ SSID is disabled using
	 * .1.3.6.1.4.1.17270.50.2.2.2.1.1.2.10101</li>
	 * <li>stepNumber 15: Verify from WebPa using the parameter
	 * Device.WiFi.SSID.10101.Enable that the 5 GHZ SSID is disabled</li>
	 * <li>stepNumber 16: Execute get Parameter on the Device.WiFi.SSID.10101.Enable
	 * and verify that it is false</li>
	 * <li>stepNumber 17: Execute get Parameter on Device.WiFi.SSID.10101.Status and
	 * verify that it is down</li>
	 * <li>stepNumber 18: Execute get Parameter on Device.WiFi.SSID.10101.LastChange
	 * and verify that it shows appropriate time in seconds</li>
	 * <li>stepNumber 19: Execute set Parameter on Device.WiFi.SSID.10101.Enable (5
	 * GHZ private SSID) to True</li>
	 * <li>stepNumber 20: Verify using SNMP the private 5GHZ SSID is enabled using
	 * .1.3.6.1.4.1.17270.50.2.2.2.1.1.2.10101</li>
	 * <li>stepNumber 21: Verify from WebPa using the parameter
	 * Device.WiFi.SSID.10101.Enable that the 5 GHZ SSID is enabled</li>
	 * <li>stepNumber 22: Execute get Parameter on the Device.WiFi.SSID.10101.Enable
	 * and verify that it is true</li>
	 * <li>stepNumber 23: Execute get Parameter on Device.WiFi.SSID.10101.Status and
	 * verify that it is Up</li>
	 * <li>stepNumber 24: Execute get Parameter on Device.WiFi.SSID.10101.LastChange
	 * and verify that it shows appropriate time in seconds</li>
	 * </ol>
	 * 
	 * @author Sathurya Ravi
	...
	public void testVerifyTR69PrivateWifiSSIDEnableDisable(Dut device) {
		...
		try {
			...
			/*
			 * stepNumber 1: Execute set Parameter on Device.WiFi.SSID.10001.Enable (2.4 GHZ
			 * private SSID) to False
			 */
			LOGGER.info("#####STARTING-TESTCASE:TC-RDKB-TR69-1008###########");
			LOGGER.info(
					"******************************************************************************************************************************");
			...
			/*
			 * stepNumber 3: Verify from WebPa using the parameter
			 * Device.WiFi.SSID.10001.Enable that the 2.4 GHZ SSID is disabled
			 */
			LOGGER.info(
					"******************************************************************************************************************************");
			...
			/*
			 * stepNumber 4: Execute get Parameter on the Device.WiFi.SSID.10001.Enable and
			 * verify that it is false
			 */
			LOGGER.info(
					"***************************************************************************************************************");
			...
			/*
			 * stepNumber 5: Execute get Parameter on Device.WiFi.Radio.10100.Status and
			 * verify that it is down
			 */
			LOGGER.info(
					"***************************************************************************************************************");
			...
			/*
			 * stepNumber 6: Execute get Parameter on Device.WiFi.SSID.10001.LastChange and
			 * verify that it shows appropriate time in seconds
			 */
			LOGGER.info(
					"***************************************************************************************************************");
			...
			/*
			 * stepNumber 7: Execute set Parameter on Device.WiFi.SSID.10001.Enable (2.4 GHZ
			 * private SSID) to True
			 */
			LOGGER.info(
					"******************************************************************************************************************************");
			...
			/*
			 * stepNumber 9: Verify from WebPa using the parameter
			 * Device.WiFi.SSID.10001.Enable that the 2.4 GHZ SSID is enabled
			 */
			LOGGER.info(
					"******************************************************************************************************************************");
			...
			/*
			 * stepNumber 10: Execute get Parameter on the Device.WiFi.SSID.10001.Enable and
			...
			/*
			 * stepNumber 11: Execute get Parameter on Device.WiFi.SSID.10001.Status and
			 * verify that it is up
			 */
			...
			/*
			 * stepNumber 12: Execute get Parameter on Device.WiFi.SSID.10001.LastChange and
			 * verify that it shows appropriate time in seconds
			 */
			...
			/*
			 * stepNumber 13: Execute set Parameter on Device.WiFi.SSID.10101.Enable (5 GHZ
			 * private SSID) to False
			 */
			...
			/*
			 * stepNumber 15: Verify from WebPa using the parameter
			 * Device.WiFi.SSID.10101.Enable that the 5 GHZ SSID is disabled
			 */
			...
			/*
			 * stepNumber 16: Execute get Parameter on the Device.WiFi.SSID.10101.Enable and
			 * verify that it is false
			 */
			...
			/*
			 * stepNumber 17: Execute get Parameter on Device.WiFi.SSID.10101.Status and
			 * verify that it is down
			 */
			LOGGER.info(
					"***************************************************************************************************************");
			...
			/*
			 * stepNumber 18: Execute get Parameter on Device.WiFi.SSID.10101.LastChange and
			 * verify that it shows appropriate time in seconds
			 */
			...
			/*
			 * stepNumber 19: Execute set Parameter on Device.WiFi.SSID.10101.Enable (5 GHZ
			 * private SSID) to True
			 */
			...
			/*
			 * stepNumber 21: Verify from WebPa using the parameter
			 * Device.WiFi.SSID.10101.Enable that the 5 GHZ SSID is enabled
			 */
			...
			/*
			 * stepNumber 22: Execute get Parameter on the Device.WiFi.SSID.10101.Enable and
			 * verify that it is true
			 */
			...
			/*
			 * stepNumber 23: Execute get Parameter on Device.WiFi.SSID.10101.Status and
			 * verify that it is down
			 */
			LOGGER.info(
					"***************************************************************************************************************");
			...
			/*
			 * stepNumber 24: Execute get Parameter on Device.WiFi.SSID.10101.LastChange and
			 * verify that it shows appropriate time in seconds
			 */
			LOGGER.info(
					"***************************************************************************************************************");
		...
		LOGGER.info("#####ENDING-TESTCASE:TC-RDKB-TR69-1008###########");
	}

	/**
	 *
	 * This method verifies the expected TR69 functionality with default values,
	 * changed values and after reboot values of Device ManagementServer Passwords.
	 * 
	 * <ol>
	 * <li>Pre condition: Perform factory reset on the device</li>
	 * <li>Step 1: Verify encrypted Device ManagementServer STUN Password is not
	 * stored after factory reset</li>
	 * <li>Step 2: Verify TR-69 process is running on the device.</li>
	 * <li>Step 3: Verify TR-69 is enabled, if not, enable it.</li>
	 * <li>Step 4: Verify value of Device ManagementServer Password has been
	 * set.</li>
	 * <li>Step 5: Verify value of Device ManagementServer ConnectionRequestPassword
	 * has been set.</li>
	 * <li>Step 6: Verify default value of Device ManagementServer
	 * ConnectionRequestPassword</li>
	 ...
	 * <li>Step 13: Verify value of Device ManagementServer STUNPassword persists
	 * persists after reboot</li>
	 * <li>Step 14: Verify value of Device ManagementServer Password persists after
	 * reboot</li>
	 * <li>Step 15: Verify value of Device ManagementServer
	 * ConnectionRequestPassword persists after reboot</li>
	...
	public void testVerifyTR69PasswordsFunctionality(Dut device) {
		...
		try {
			...
			/*
			 * Step 1: Verify Device ManagementServer STUN Password is not stored after
			 * factory reset
			 */
			step = "s1";
			result = false;
			...
			/*
			 * Step 5: Verify value of Device ManagementServer ConnectionRequestPassword has
			 * been set.
			 */
			step = "s5";
			result = false;
			...
			/*
			 * Step 7: Verify default value of Device ManagementServer
			...
			/*
			 * Step 13: Verify null value of Device ManagementServer STUNPassword persists
			...
			/*
			 * Step 14: Verify value of Device ManagementServer Password persists after
			 * reboot
			 */
			step = "s14";
			result = false;
			...
			/*
			 * Step 15: Verify null value of Device ManagementServer
			 * ConnectionRequestPassword persists after reboot
			 */
			step = "s15";
			result = false;
			LOGGER.info("**********************************************************************************");
	 ...
	 * 
	 * Step1: Verification of the object Device.IP.IPv4Capable via TR69 Step2:
	 * Validation of the Object Device.IP.IPv4Capable via WebPa Step3: Verification
	 * of the object Device.IP.IPv4Enable via TR69 Step4: Validation of the Object
	 * Device.IP.IPv4Enable via WebPa Step5: Verification of the object
	 * Device.IP.IPv4Status via TR69 Step6: Validation of the Object
	 * Device.IP.IPv4Status via WebPa Step7: Verification of the object
	 * Device.IP.IPv6Capable via TR69 Step8: Validation of the Object
	 * Device.IP.IPv6Capable via WebPa Step9: Verification of the object
	 * Device.IP.IPv6Enable via TR69 Step10: Validation of the Object
	 * Device.IP.IPv6Enable via WebPa Step11: Verification of the object
	 * Device.IP.IPv6Status via TR69 Step12: Validation of the Object
	 ...
	 * Step2: Validation of the Object Device.IP.Interface.1.Enable via WebPa Step3:
	 * Verification of the object Device.IP.Interface.1.IPv4Enable via TR69 Step4:
	 * Validate the TR69 response of the object Device.IP.Interface.1.IPv4Enable
	 * against WebPa response Step5: Verification of the object
	 * Device.IP.Interface.1.IPv6Enable via TR69 Step6: Validation of the Object
	 * Device.IP.Interface.1.IPv6Enable via WebPa Step7: Verification of the object
	 * Device.IP.Interface.1.LastChange via TR69 Step8: Validation of the Object
	 * Device.IP.Interface.1.LastChange via WebPa Step9: Verification of the object
	 * Device.IP.Interface.1.MaxMTUSize via TR69 Step10: Validation of the Object
	 * Device.IP.Interface.1.MaxMTUSize via WebPa Step11: Verification of the object
	 * Device.IP.Interface.1.Status via TR69 Step12: Validation of the Object
	 * Device.IP.Interface.1.Status via WebPa Step13: Verification of the object
	 * Device.IP.Interface.2.Enable via TR69 Step14: Validation of the Object
	 * Device.IP.Interface.2.Enable via WebPa Step15: Verification of the object
	 * Device.IP.Interface.2.IPv4Enable via TR69 Step16: Validate the TR69 response
	 * of the object Device.IP.Interface.2.IPv4Enable against WebPa response Step17:
	 * Verification of the object Device.IP.Interface.2.IPv6Enable via TR69 Step18:
	 * Validation of the Object Device.IP.Interface.2.IPv6Enable via WebPa Step19:
	 * Verification of the object Device.IP.Interface.2.LastChange via TR69 Step20:
	 * Validation of the Object Device.IP.Interface.2.LastChange via WebPa Step21:
	 * Verification of the object Device.IP.Interface.2.MaxMTUSize via TR69 Step22:
	 * Validation of the Object Device.IP.Interface.2.MaxMTUSize via WebPa Step23:
	 * Verification of the object Device.IP.Interface.2.Status via TR69 Step24:
	 * Validation of the Object Device.IP.Interface.2.Status via WebPa Step25:
	 * Verification of the object Device.IP.Interface.3.Enable via TR69 Step26:
	 * Validation of the Object Device.IP.Interface.3.Enable via WebPa Step27:
	 * Verification of the object Device.IP.Interface.3.IPv4Enable via TR69 Step28:
	 * Validate the TR69 response of the object Device.IP.Interface.3.IPv4Enable
	 * against WebPa response Step29: Verification of the object
	 * Device.IP.Interface.3.IPv6Enable via TR69 Step30: Validation of the Object
	 * Device.IP.Interface.3.IPv6Enable via WebPa Step31: Verification of the object
	 * Device.IP.Interface.3.LastChange via TR69 Step32: Validation of the Object
	 * Device.IP.Interface.3.LastChange via WebPa Step33: Verification of the object
	 * Device.IP.Interface.3.MaxMTUSize via TR69 Step34: Validation of the Object
	 * Device.IP.Interface.3.MaxMTUSize via WebPa Step35: Verification of the object
	 * Device.IP.Interface.3.Status via TR69 Step36: Validation of the Object
	 * Device.IP.Interface.3.Status via WebPa Step37: Verification of the object
	 * Device.IP.Interface.4.Enable via TR69 Step38: Validation of the Object
	 * Device.IP.Interface.4.Enable via WebPa Step39: Verification of the object
	 * Device.IP.Interface.4.IPv4Enable via TR69 Step40: Validate the TR69 response
	 * of the object Device.IP.Interface.4.IPv4Enable against WebPa response Step41:
	 * Verification of the object Device.IP.Interface.4.IPv6Enable via TR69 Step42:
	 * Validation of the Object Device.IP.Interface.4.IPv6Enable via WebPa Step43:
	 * Verification of the object Device.IP.Interface.4.LastChange via TR69 Step44:
	 * Validation of the Object Device.IP.Interface.4.LastChange via WebPa Step45:
	 * Verification of the object Device.IP.Interface.4.MaxMTUSize via TR69 Step46:
	 * Validation of the Object Device.IP.Interface.4.MaxMTUSize via WebPa Step47:
	 * Verification of the object Device.IP.Interface.4.Status via TR69 Step48:
	 * Validation of the Object Device.IP.Interface.4.Status via WebPa Step49:
	 * Verification of the object Device.IP.Interface.5.Enable via TR69 Step50:
	 * Validation of the Object Device.IP.Interface.5.Enable via WebPa Step51:
	 * Verification of the object Device.IP.Interface.5.IPv4Enable via TR69 Step52:
	 * Validate the TR69 response of the object Device.IP.Interface.5.IPv4Enable
	 * against WebPa response Step53: Verification of the object
	 * Device.IP.Interface.5.IPv6Enable via TR69 Step54: Validation of the Object
	 * Device.IP.Interface.5.IPv6Enable via WebPa Step55: Verification of the object
	 * Device.IP.Interface.5.LastChange via TR69 Step56: Validation of the Object
	 * Device.IP.Interface.5.LastChange via WebPa Step57: Verification of the object
	 * Device.IP.Interface.5.MaxMTUSize via TR69 Step58: Validation of the Object
	 * Device.IP.Interface.5.MaxMTUSize via WebPa Step59: Verification of the object
	 * Device.IP.Interface.5.Status via TR69 Step60: Validation of the Object
	 * Device.IP.Interface.5.Status via WebPa Step61: Verification of the object
	 * Device.IP.Interface.6.Enable via TR69 Step62: Validation of the Object
	 * Device.IP.Interface.6.Enable via WebPa Step63: Verification of the object
	 * Device.IP.Interface.6.IPv4Enable via TR69 Step64: Validate the TR69 response
	 * of the object Device.IP.Interface.6.IPv4Enable against WebPa response Step65:
	 * Verification of the object Device.IP.Interface.6.IPv6Enable via TR69 Step66:
	 * Validation of the Object Device.IP.Interface.6.IPv6Enable via WebPa Step67:
	 * Verification of the object Device.IP.Interface.6.LastChange via TR69 Step68:
	 * Validation of the Object Device.IP.Interface.6.LastChange via WebPa Step69:
	 * Verification of the object Device.IP.Interface.6.MaxMTUSize via TR69 Step70:
	 * Validation of the Object Device.IP.Interface.6.MaxMTUSize via WebPa Step71:
	 * Verification of the object Device.IP.Interface.6.Status via TR69 Step72:
	 * Validation of the Object Device.IP.Interface.6.Status via WebPa
	 *
	 * @author Sathurya Ravi
	 * 
	 * @refactor Rakesh C N
	...
	public void testValidateTR69InterfaceObjects(Dut device) {
		...
		try {
			...
			/*
			 * stepNumber 1: Verification of the object Device.IP.Interface.1.Enable via
			 * TR69
			 */
			LOGGER.info("**********************************************************************************");
			...
			/*
			 * stepNumber 3: Verification of the object Device.IP.Interface.1.IPv4Enable via
			 * TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 4: Validation of the Object Device.IP.Interface.1.IPv4Enable via
			 * WebPa
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 5: Verification of the object Device.IP.Interface.1.IPv6Enable via
			 * TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 6: Validation of the Object Device.IP.Interface.1.IPv6Enable via
			 * WebPa
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 7: Verification of the object Device.IP.Interface.1.LastChange via
			 * TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 8: Verification of the object Device.IP.Interface.1.MaxMTUSize via
			 * TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 9: Validation of the Object Device.IP.Interface.1.MaxMTUSize via
			 * WebPa
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 10: Verification of the object Device.IP.Interface.1.Status via
			 * TR69
			 */
			LOGGER.info("**********************************************************************************");
			...
			/*
			 * stepNumber 11: Validation of the Object Device.IP.Interface.1.Status via
			 * WebPa
			 */
			LOGGER.info("**********************************************************************************");
			...
			/*
			 * stepNumber 12: Verification of the object Device.IP.Interface.2.Enable via
			 * TR69
			 */
			LOGGER.info("**********************************************************************************");
			...
			/*
			 * stepNumber 13: Validation of the Object Device.IP.Interface.2.Enable via
			 * WebPa
			 */
			LOGGER.info("**********************************************************************************");
			...
			/*
			 * stepNumber 14: Verification of the object Device.IP.Interface.2.IPv4Enable
			 * via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 15: Validation of the Object Device.IP.Interface.2.IPv4Enable via
			 * WebPa
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 16: Verification of the object Device.IP.Interface.2.IPv6Enable
			 * via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 17: Validation of the Object Device.IP.Interface.2.IPv6Enable via
			 * WebPa
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 18: Verification of the object Device.IP.Interface.2.LastChange
			 * via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 19: Verification of the object Device.IP.Interface.2.MaxMTUSize
			 * via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 20: Validation of the Object Device.IP.Interface.2.MaxMTUSize via
			 * WebPa
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 21: Verification of the object Device.IP.Interface.2.Status via
			 * TR69
			 */
			LOGGER.info("**********************************************************************************");
			...
			/*
			 * stepNumber 22: Validation of the Object Device.IP.Interface.2.Status via
			 * WebPa
			 */
			LOGGER.info("**********************************************************************************");
			...
			/*
			 * stepNumber 23: Verification of the object Device.IP.Interface.3.Enable via
			 * TR69
			 */
			LOGGER.info("**********************************************************************************");
			...
			/*
			 * stepNumber 24: Validation of the Object Device.IP.Interface.3.Enable via
			 * WebPa
			 */
			LOGGER.info("**********************************************************************************");
			...
			/*
			 * stepNumber 25: Verification of the object Device.IP.Interface.3.IPv4Enable
			 * via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 26: Validation of the Object Device.IP.Interface.3.IPv4Enable via
			 * WebPa
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 27: Verification of the object Device.IP.Interface.3.IPv6Enable
			 * via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 28: Validation of the Object Device.IP.Interface.3.IPv6Enable via
			 * WebPa
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 29: Verification of the object Device.IP.Interface.3.LastChange
			 * via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 30: Verification of the object Device.IP.Interface.3.MaxMTUSize
			 * via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 31: Validation of the Object Device.IP.Interface.3.MaxMTUSize via
			 * WebPa
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 32: Verification of the object Device.IP.Interface.3.Status via
			 * TR69
			 */
			LOGGER.info("**********************************************************************************");
			...
			/*
			 * stepNumber 33: Validation of the Object Device.IP.Interface.3.Status via
			 * WebPa
			 */
			LOGGER.info("**********************************************************************************");
			...
			/*
			 * stepNumber 34: Verification of the object Device.IP.Interface.4.Enable via
			 * TR69
			 */
			LOGGER.info("**********************************************************************************");
			...
			/*
			 * stepNumber 35: Validation of the Object Device.IP.Interface.4.Enable via
			 * WebPa
			 */
			LOGGER.info("**********************************************************************************");
			...
			/*
			 * stepNumber 36: Verification of the object Device.IP.Interface.4.IPv4Enable
			 * via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 37: Validation of the Object Device.IP.Interface.4.IPv4Enable via
			 * WebPa
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 38: Verification of the object Device.IP.Interface.4.IPv6Enable
			 * via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 39: Validation of the Object Device.IP.Interface.4.IPv6Enable via
			 * WebPa
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 40: Verification of the object Device.IP.Interface.4.LastChange
			 * via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 41: Verification of the object Device.IP.Interface.4.MaxMTUSize
			 * via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 42: Validation of the Object Device.IP.Interface.4.MaxMTUSize via
			 * WebPa
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 43: Verification of the object Device.IP.Interface.4.Status via
			 * TR69
			 */
			LOGGER.info("**********************************************************************************");
			...
			/*
			 * stepNumber 44: Validation of the Object Device.IP.Interface.4.Status via
			 * WebPa
			 */
			LOGGER.info("**********************************************************************************");
			...
			/*
			 * stepNumber 45: Verification of the object Device.IP.Interface.5.Enable via
			 * TR69
			 */
			LOGGER.info("**********************************************************************************");
			...
			/*
			 * stepNumber 46: Validation of the Object Device.IP.Interface.5.Enable via
			 * WebPa
			 */
			LOGGER.info("**********************************************************************************");
			...
			/*
			 * stepNumber 47: Verification of the object Device.IP.Interface.5.IPv4Enable
			 * via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 48: Validation of the Object Device.IP.Interface.5.IPv4Enable via
			 * WebPa
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 49: Verification of the object Device.IP.Interface.5.IPv6Enable
			 * via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 50: Validation of the Object Device.IP.Interface.5.IPv6Enable via
			 * WebPa
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 51: Verification of the object Device.IP.Interface.5.LastChange
			 * via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 52: Verification of the object Device.IP.Interface.5.MaxMTUSize
			 * via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 53: Validation of the Object Device.IP.Interface.5.MaxMTUSize via
			 * WebPa
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 54: Verification of the object Device.IP.Interface.5.Status via
			 * TR69
			 */
			LOGGER.info("**********************************************************************************");
			...
			/*
			 * stepNumber 55: Validation of the Object Device.IP.Interface.5.Status via
			 * WebPa
			 */
			LOGGER.info("**********************************************************************************");
			...
			/*
			 * stepNumber 56: Verification of the object Device.IP.Interface.6.Enable via
			 * TR69
			 */
			LOGGER.info("**********************************************************************************");
			...
			/*
			 * stepNumber 57: Validation of the Object Device.IP.Interface.6.Enable via
			 * WebPa
			 */
			LOGGER.info("**********************************************************************************");
			...
			/*
			 * stepNumber 58: Verification of the object Device.IP.Interface.6.IPv4Enable
			 * via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 59: Validation of the Object Device.IP.Interface.6.IPv4Enable via
			 * WebPa
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 60: Verification of the object Device.IP.Interface.6.IPv6Enable
			 * via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 61: Validation of the Object Device.IP.Interface.6.IPv6Enable via
			 * WebPa
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 62: Verification of the object Device.IP.Interface.6.LastChange
			 * via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 63: Verification of the object Device.IP.Interface.6.MaxMTUSize
			 * via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 64: Validation of the Object Device.IP.Interface.6.MaxMTUSize via
			 * WebPa
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 65: Verification of the object Device.IP.Interface.6.Status via
			 * TR69
			 */
			LOGGER.info("**********************************************************************************");
			...
			/*
			 * stepNumber 66: Validation of the Object Device.IP.Interface.6.Status via
			 * WebPa
			 */
			LOGGER.info("**********************************************************************************");
	...
	/*
	 * Step1: Verification of the object Device.WiFi.AccessPoint.10001.Enable via
	 * TR69 Step2: Validate the TR69 response of the object
	 * Device.WiFi.AccessPoint.10001.Enable against WebPa response Step3:
	 * Verification of the object Device.WiFi.AccessPoint.10001.Status via TR69
	 * Step4: Validate the TR69 response of the object
	 * Device.WiFi.AccessPoint.10001.Status against WebPa response Step5:
	 * Verification of the object Device.WiFi.AccessPoint.10001.SSIDReference via
	 * TR69 Step6: Validation of the Object
	 * Device.WiFi.AccessPoint.10001.SSIDReference via WebPa Step7: Verification of
	 * the object Device.WiFi.AccessPoint.10001.SSIDAdvertisementEnabled via TR69
	 * Step8: Validation of the Object
	 * Device.WiFi.AccessPoint.10001.SSIDAdvertisementEnabled via WebPa Step9:
	 * Verification of the object
	 * Device.WiFi.AccessPoint.10001.AssociatedDeviceNumberOfEntries via TR69
	 * Step10: Validation of the Object
	 * Device.WiFi.AccessPoint.10001.AssociatedDeviceNumberOfEntries via WebPa
	 * Step11: Verification of the object
	 * Device.WiFi.AccessPoint.10001.MaxAssociatedDevices via TR69 Step12:
	 * Validation of the Object Device.WiFi.AccessPoint.10001.MaxAssociatedDevices
	 * via WebPa Step13: Verification of the object
	 * Device.WiFi.AccessPoint.10001.Security.ModesSupported via TR69 Step14:
	 * Validation of the Object
	 * Device.WiFi.AccessPoint.10001.Security.ModesSupported via WebPa Step15:
	 * Verification of the object Device.WiFi.AccessPoint.10001.Security.ModeEnabled
	 * via TR69 Step16: Validation of the Object
	 * Device.WiFi.AccessPoint.10001.Security.ModeEnabled via WebPa Step17:
	 * Verification of the object Device.WiFi.AccessPoint.10101.Enable via TR69
	 * Step18: Validate the TR69 response of the object
	 * Device.WiFi.AccessPoint.10101.Enable against WebPa response Step19:
	 * Verification of the object Device.WiFi.AccessPoint.10101.Status via TR69
	 * Step20: Validate the TR69 response of the object
	 * Device.WiFi.AccessPoint.10101.Status against WebPa response Step21:
	 * Verification of the object Device.WiFi.AccessPoint.10101.SSIDReference via
	 * TR69 Step22: Validation of the Object
	 * Device.WiFi.AccessPoint.10101.SSIDReference via WebPa Step23: Verification of
	 * the object Device.WiFi.AccessPoint.10101.SSIDAdvertisementEnabled via TR69
	 * Step24: Validation of the Object
	 * Device.WiFi.AccessPoint.10101.SSIDAdvertisementEnabled via WebPa Step25:
	 * Verification of the object
	 * Device.WiFi.AccessPoint.10101.AssociatedDeviceNumberOfEntries via TR69
	 * Step26: Validation of the Object
	 * Device.WiFi.AccessPoint.10101.AssociatedDeviceNumberOfEntries via WebPa
	 * Step27: Verification of the object
	 * Device.WiFi.AccessPoint.10101.MaxAssociatedDevices via TR69 Step28:
	 * Validation of the Object Device.WiFi.AccessPoint.10101.MaxAssociatedDevices
	 * via WebPa Step29: Verification of the object
	 * Device.WiFi.AccessPoint.10101.Security.ModesSupported via TR69 Step30:
	 * Validation of the Object
	 * Device.WiFi.AccessPoint.10101.Security.ModesSupported via WebPa Step31:
	 * Verification of the object Device.WiFi.AccessPoint.10101.Security.ModeEnabled
	 * via TR69 Step32: Validation of the Object
	 * Device.WiFi.AccessPoint.10101.Security.ModeEnabled via WebPa
	 *
	 * @author Sathurya Ravi
	 * 
	 * @refactor Govardhan
	...
	public void testValidateTR69WiFiAccessPointObjects(Dut device) {
		...
		try {
			...
			/*
			 * stepNumber 1: Verification of the object Device.WiFi.AccessPoint.10001.Enable
			 * via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 2: Validate the TR69 response of the object
			 * Device.WiFi.AccessPoint.10001.Enable against WebPa response
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 3: Verification of the object Device.WiFi.AccessPoint.10001.Status
			 * via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 4: Validate the TR69 response of the object
			 * Device.WiFi.AccessPoint.10001.Status against WebPa response
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 5: Verification of the object
			 * Device.WiFi.AccessPoint.10001.SSIDReference via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 6: Validate the TR69 response of the object
			 * Device.WiFi.AccessPoint.10001.SSIDReference against WebPa response
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 7: Verification of the object
			 * Device.WiFi.AccessPoint.10001.SSIDAdvertisementEnabled via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 9: Verification of the object
			 * Device.WiFi.AccessPoint.10001.AssociatedDeviceNumberOfEntries via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			 ...
			 * Device.WiFi.AccessPoint.10001.AssociatedDeviceNumberOfEntries against WebPa
			 * response
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 11: Verification of the object
			 * Device.WiFi.AccessPoint.10001.MaxAssociatedDevices via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 13: Verification of the object
			 * Device.WiFi.AccessPoint.10001.Security.ModesSupported via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 15: Verification of the object
			 * Device.WiFi.AccessPoint.10001.Security.ModeEnabled via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 17: Verification of the object
			 * Device.WiFi.AccessPoint.10101.Enable via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 18: Validate the TR69 response of the object
			 * Device.WiFi.AccessPoint.10101.Enable against WebPa response
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 19: Verification of the object
			 * Device.WiFi.AccessPoint.10101.Status via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 20: Validate the TR69 response of the object
			 * Device.WiFi.AccessPoint.10101.Status against WebPa response
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 21: Verification of the object
			 * Device.WiFi.AccessPoint.10101.SSIDReference via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 22: Validate the TR69 response of the object
			 * Device.WiFi.AccessPoint.10101.SSIDReference against WebPa response
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 23: Verification of the object
			 * Device.WiFi.AccessPoint.10101.SSIDAdvertisementEnabled via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 25: Verification of the object
			 * Device.WiFi.AccessPoint.10101.AssociatedDeviceNumberOfEntries via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			 ...
			 * Device.WiFi.AccessPoint.10101.AssociatedDeviceNumberOfEntries against WebPa
			 * response
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 27: Verification of the object
			 * Device.WiFi.AccessPoint.10101.MaxAssociatedDevices via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 29: Verification of the object
			 * Device.WiFi.AccessPoint.10101.Security.ModesSupported via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 31: Verification of the object
			 * Device.WiFi.AccessPoint.10101.Security.ModeEnabled via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
	 ...
	 * 
	 * Step1 Verification of the object Device.WiFi.Radio.10000.Stats.BytesSent via
	 * TR69 Step2 Verification of the object
	 * Device.WiFi.Radio.10000.Stats.BytesReceived via TR69 Step3 Verification of
	 * the object Device.WiFi.Radio.10000.Stats.PacketsSent via TR69 Step4
	 * Verification of the object Device.WiFi.Radio.10000.Stats.PacketsReceived via
	 * TR69 Step5 Verification of the object
	 * Device.WiFi.Radio.10000.Stats.ErrorsSent via TR69 Step6 Verification of the
	 * object Device.WiFi.Radio.10000.Stats.ErrorsSent via TR69 Step7 Verification
	 * of the object Device.WiFi.Radio.10000.Stats.DiscardPacketsSent via TR69 Step8
	 * Verification of the object
	 * Device.WiFi.Radio.10000.Stats.DiscardPacketsReceived via TR69 Step9
	 * Verification of the object Device.WiFi.Radio.10100.Stats.BytesSent via TR69
	 * Step10 Verification of the object Device.WiFi.Radio.10100.Stats.BytesReceived
	 * via TR69 Step11 Verification of the object
	 * Device.WiFi.Radio.10100.Stats.PacketsSent via TR69 Step12 Verification of the
	 * object Device.WiFi.Radio.10100.Stats.PacketsReceived via TR69 Step13
	 * Verification of the object Device.WiFi.Radio.10100.Stats.ErrorsSent via TR69
	 * Step14 Verification of the object
	 * Device.WiFi.Radio.10100.Stats.DiscardPacketsSent via TR69 Step15 Verification
	 * of the object Device.WiFi.Radio.10100.Stats.DiscardPacketsReceived via TR69
	 * Step16 Verification of the object Device.WiFi.Radio.10100.Stats.PacketsSent
	 * via TR69
	 * 
	 * @author Sathurya Ravi
	...
	private void verifyRadioStatsObjects(String index, String testId, Dut device, int stepNumber) {
		...
		/*
		 * Verification of the object
		 * Device.WiFi.Radio.10000.Stats.DiscardPacketsReceived
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		LOGGER.info("stepNumber " + stepNumber
	 ...
	 * Step2: Validation of the Object Device.WiFi.SSID.10001.Enable via SNMP Step3:
	 * Verification of the object Device.WiFi.SSID.10001.Status via TR69 Step4:
	 * Validate the TR69 response of the object Device.WiFi.SSID.10001.Status
	 * against WebPa response Step5: Verification of the object
	 * Device.WiFi.SSID.10001.Alias via TR69 Step6: Validation of the Object
	 * Device.WiFi.SSID.10001.Alias via WebPa Step7: Verification of the object
	 * Device.WiFi.SSID.10001.Name via TR69 Step8: Validation of the Object
	 * Device.WiFi.SSID.10001.Name via WebPa Step9: Verification of the object
	 * Device.WiFi.SSID.10001.LastChange via TR69 Step10: Validation of the Object
	 * Device.WiFi.SSID.10001.LastChange via WebPa Step11: Verification of the
	 * object Device.WiFi.SSID.10001.LowerLayers via TR69 Step12: Validation of the
	 * Object Device.WiFi.SSID.10001.LowerLayers via WebPa Step13: Verification of
	 * the object Device.WiFi.SSID.10001.BSSID via TR69 Step14: Validation of the
	 * Object Device.WiFi.SSID.10001.BSSID via SNMP Step15: Verification of the
	 * object Device.WiFi.SSID.10001.MACAddress via TR69 Step16: Validation of the
	 * Object Device.WiFi.SSID.10001.MACAddress via SNMP Step17: Verification of the
	 * object Device.WiFi.SSID.10001.SSID via TR69 Step18: Validation of the Object
	 * Device.WiFi.SSID.10001.SSID via SNMP Step19: Verification of the object
	 * Device.WiFi.SSID.10101.Enable via TR69 Step20: Validation of the Object
	 * Device.WiFi.SSID.10101.Enable via SNMP Step21: Verification of the object
	 * Device.WiFi.SSID.10101.Status via TR69 Step22: Validate the TR69 response of
	 * the object Device.WiFi.SSID.10101.Status against WebPa response Step23:
	 * Verification of the object Device.WiFi.SSID.10101.Alias via TR69 Step24:
	 * Validation of the Object Device.WiFi.SSID.10101.Alias via WebPa Step25:
	 * Verification of the object Device.WiFi.SSID.10101.Name via TR69 Step26:
	 * Validation of the Object Device.WiFi.SSID.10101.Name via WebPa Step27:
	 * Verification of the object Device.WiFi.SSID.10101.LastChange via TR69 Step28:
	 * Validation of the Object Device.WiFi.SSID.10101.LastChange via WebPa Step29:
	 * Verification of the object Device.WiFi.SSID.10101.LowerLayers via TR69
	...
	public void testValidateTR69WiFiSSIDObjects(Dut device) {
		...
		try {
			...
			/*
			 * stepNumber 1: Verification of the object Device.WiFi.SSID.10001.Enable via
			 * TR69
			 */
			LOGGER.info("**********************************************************************************");
			...
			/*
			 * stepNumber 3: Verification of the object Device.WiFi.SSID.10001.Status via
			 * TR69
			 */
			LOGGER.info("**********************************************************************************");
			...
			/*
			 * stepNumber 4: Validate the TR69 response of the object
			 * Device.WiFi.SSID.10001.Status against WebPa response
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 5: Verification of the object Device.WiFi.SSID.10001.Alias via
			 * TR69
			 */
			LOGGER.info("**********************************************************************************");
			...
			/*
			 * stepNumber 6: Validate the TR69 response of the object
			 * Device.WiFi.SSID.10001.Alias against WebPa response
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 8: Validate the TR69 response of the object
			 * Device.WiFi.SSID.10001.Name against WebPa response
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 9: Verification of the object Device.WiFi.SSID.10001.LastChange
			 * via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 10: Verification of the object Device.WiFi.SSID.10001.LowerLayers
			 * via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 11: Validate the TR69 response of the object
			 * Device.WiFi.SSID.10001.LowerLayers against WebPa response
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 12: Verification of the object Device.WiFi.SSID.10001.BSSID via
			 * TR69
			 */
			LOGGER.info("**********************************************************************************");
			...
			/*
			 * stepNumber 14: Verification of the object Device.WiFi.SSID.10001.MACAddress
			 * via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 15: Validation of the Object Device.WiFi.SSID.10001.MACAddress via
			 * SNMP
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 16: Verification of the object Device.WiFi.SSID.10001.SSID via
			 * TR69
			 */
			LOGGER.info("**********************************************************************************");
			...
			/*
			 * stepNumber 18: Verification of the object Device.WiFi.SSID.10101.Enable via
			 * TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 19: Validation of the Object Device.WiFi.SSID.10101.Enable via
			 * SNMP
			 */
			LOGGER.info("**********************************************************************************");
			...
			/*
			 * stepNumber 20: Verification of the object Device.WiFi.SSID.10101.Status via
			 * TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 21: Validate the TR69 response of the object
			 * Device.WiFi.SSID.10101.Status against WebPa response
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 22: Verification of the object Device.WiFi.SSID.10101.Alias via
			 * TR69
			 */
			LOGGER.info("**********************************************************************************");
			...
			/*
			 * stepNumber 23: Validate the TR69 response of the object
			 * Device.WiFi.SSID.10101.Alias against WebPa response
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 24: Verification of the object Device.WiFi.SSID.10101.Name via
			 * TR69
			 */
			LOGGER.info("**********************************************************************************");
			...
			/*
			 * stepNumber 25: Validate the TR69 response of the object
			 * Device.WiFi.SSID.10101.Name against WebPa response
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 26: Verification of the object Device.WiFi.SSID.10101.LastChange
			 * via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 27: Verification of the object Device.WiFi.SSID.10101.LowerLayers
			 * via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 28: Validate the TR69 response of the object
			 * Device.WiFi.SSID.10101.LowerLayers against WebPa response
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 29: Verification of the object Device.WiFi.SSID.10101.BSSID via
			 * TR69
			 */
			LOGGER.info("**********************************************************************************");
			...
			/*
			 * stepNumber 31: Verification of the object Device.WiFi.SSID.10101.MACAddress
			 * via TR69
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 32: Validation of the Object Device.WiFi.SSID.10101.MACAddress via
			 * SNMP
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/*
			 * stepNumber 33: Verification of the object Device.WiFi.SSID.10101.SSID via
			 * TR69
			 */
			LOGGER.info("**********************************************************************************");
	 ...
	 * Step4: Validate the TR69 response of the object
	 * Device.WiFi.Radio.10000.Status against WebPa response Step5: Verification of
	 * the object Device.WiFi.Radio.10000.Alias via TR69 Step6: Validation of the
	 * Object Device.WiFi.Radio.10000.Alias via WebPa Step7: Verification of the
	 * object Device.WiFi.Radio.10000.Name via TR69 Step8: Validation of the Object
	 * Device.WiFi.Radio.10000.Name via WebPa Step9: Verification of the object
	 * Device.WiFi.Radio.10000.LastChange via TR69 Step10: Validation of the Object
	 * Device.WiFi.Radio.10000.LastChange via WebPa Step11: Verification of the
	 * object Device.WiFi.Radio.10000.LowerLayers via TR69 Step12: Validation of the
	 * Object Device.WiFi.Radio.10000.LowerLayers via WebPa Step13: Verification of
	 * the object Device.WiFi.Radio.10000.Upstream via TR69 Step14: Validation of
	 * the Object Device.WiFi.Radio.10000.Upstream via WebPa Step15: Verification of
	 * the object Device.WiFi.Radio.10000.MaxBitRate via TR69 Step16: Validation of
	 * the Object Device.WiFi.Radio.10000.MaxBitRate via WebPa Step17: Verification
	 * of the object Device.WiFi.Radio.10000.SupportedFrequencyBands via TR69
	 * Step18: Validation of the Object
	 * Device.WiFi.Radio.10000.SupportedFrequencyBands via WebPa Step19:
	 * Verification of the object Device.WiFi.Radio.10000.OperatingChannelBandwidth
	 * via TR69 Step20: Validation of the Object
	 * Device.WiFi.Radio.10000.OperatingChannelBandwidth via WebPa Step21:
	 * Verification of the object Device.WiFi.Radio.10000.SupportedStandards via
	 * TR69 Step22: Validation of the Object
	 * Device.WiFi.Radio.10000.SupportedStandards via WebPa Step23: Verification of
	 * the object Device.WiFi.Radio.10000.OperatingStandards via TR69 Step24:
	 * Validation of the Object Device.WiFi.Radio.10000.OperatingStandards via WebPa
	 ...
	 * Step33: Verification of the object Device.WiFi.Radio.10100.LastChange via
	 * TR69 Step34: Validation of the Object Device.WiFi.Radio.10100.LastChange via
	 * WebPa Step35: Verification of the object Device.WiFi.Radio.10100.LowerLayers
	 * via TR69 Step36: Validation of the Object Device.WiFi.Radio.10100.LowerLayers
	 * via WebPa Step37: Verification of the object Device.WiFi.Radio.10100.Upstream
	 * via TR69 Step38: Validation of the Object Device.WiFi.Radio.10100.Upstream
	 * via WebPa Step39: Verification of the object
	 * Device.WiFi.Radio.10100.MaxBitRate via TR69 Step40: Validation of the Object
	 * Device.WiFi.Radio.10100.MaxBitRate via WebPa Step41: Verification of the
	 * object Device.WiFi.Radio.10100.SupportedFrequencyBands via TR69 Step42:
	 * Validation of the Object Device.WiFi.Radio.10100.SupportedFrequencyBands via
	 * WebPa Step43: Verification of the object
	 * Device.WiFi.Radio.10100.OperatingChannelBandwidth via TR69 Step44: Validation
	 * of the Object Device.WiFi.Radio.10100.OperatingChannelBandwidth via WebPa
	 * Step45: Verification of the object Device.WiFi.Radio.10100.SupportedStandards
	 * via TR69 Step46: Validation of the Object
	 * Device.WiFi.Radio.10100.SupportedStandards via WebPa
	 *
	 * @author Sathurya Ravi
	 * @refactor Said Hisham
	 * 
	...
	private void verifyRadioObjectsForTR69(String index, int stepNumber, Dut device, String testId) {
		...
		LOGGER.info("					   b) Compare the WebPa response with the TR69 response from the above step.");
		...
		/*
		 * Validate the TR69 response of the object Device.WiFi.Radio.{i}.Status against
		 * WebPa response
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		...
		/*
		 * Validate the TR69 response of Device.WiFi.Radio.{i}.Alias against WebPa
		 * response
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		...
		/*
		 * Validate the TR69 response of Device.WiFi.Radio.{i}.Name against WebPa
		 * response
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		...
		LOGGER.info(" 					   b) Validate the whether parameter is of type and value of the parameter ");
		LOGGER.info("stepNumber " + stepNumber
		...
		/*
		 * Validate the TR69 response of Device.WiFi.Radio.{i}.LowerLayers against WebPa
		 * response
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		...
		/*
		 * Validate the TR69 response of Device.WiFi.Radio.{i}.Upstream against WebPa
		 * response
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		...
		/*
		 * Validate the TR69 response of Device.WiFi.Radio.{i}.MaxBitRate against WebPa
		 * response
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		...
		/*
		 * Execute Get Parameter on the object
		...
		/*
		 * Validate the TR69 response of Device.WiFi.Radio.{i}.SupportedFrequencyBands
		...
		/*
		 * Validate the TR69 response of Device.WiFi.Radio.{i}.OperatingFrequencyBand
		 * against WebPa response
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		...
		/*
		 * Validate the TR69 response of Device.WiFi.Radio.{i}.SupportedStandards
		 * against WebPa response
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
	 ...
	 * <li>Retrieve Ethernet Interface entries using TR69 TELESCOPIC SERVICE REST
	 * URL</li>
	 * <li>Retrieve Ethernet Interface entries using webpa and validate with tr69
	 * response</li>
	 * <li>Retrieve and validate values for ethernet interface \"Enable\" using TR69
	 * TELESCOPIC SERVICE REST URL for all entries</li>
	 * <li>Retrieve and validate values for ethernet interface \"Status\" using TR69
	 * TELESCOPIC SERVICE REST URL for all entries</li>
	 * <li>Retrieve and validate values for ethernet interface \"Alias\" using TR69
	 * TELESCOPIC SERVICE REST URL for all entries</li>
	 * <li>Retrieve and validate values for ethernet interface \"Name\" using TR69
	 * TELESCOPIC SERVICE REST URL for all entries</li>
	 * <li>Retrieve and validate values for ethernet interface \"MACAddress\" using
	 * TR69 TELESCOPIC SERVICE REST URL for all entries</li>
	 * <li>Retrieve and validate values for ethernet interface \"MaxBitRate\" using
	 * TR69 TELESCOPIC SERVICE REST URL for all entries</li>
	 * <li>Retrieve and validate values for ethernet interface \"BytesSent\" using
	 * TR69 TELESCOPIC SERVICE REST URL for all entries</li>
	 * <li>Retrieve and validate values for ethernet interface \"BytesReceived\"
	 * using TR69 TELESCOPIC SERVICE REST URL for all entries</li>
	 * <li>Retrieve and validate values for ethernet interface \"PacketsReceived\"
	 * using TR69 TELESCOPIC SERVICE REST URL for all entries</li>
	 * <li>Retrieve and validate values for ethernet interface \"ErrorsReceived\"
	 * using TR69 TELESCOPIC SERVICE REST URL for all entries</li>
	 * <li>Retrieve and validate values for ethernet interface
	 * \"DiscardPacketsSent\" using TR69 TELESCOPIC SERVICE REST URL for all
	 * entries</li>
	 * <li>Retrieve and validate values for ethernet interface
	 * \"BroadcastPacketsSent\" using TR69 TELESCOPIC SERVICE REST URL for all
	 * entries</li>
	 * <li>Retrieve and validate values for ethernet interface
	 * \"BroadcastPacketsReceived\" using TR69 TELESCOPIC SERVICE REST URL for all
	 * entries</li>
	...
	public void testToValidateTr69EthernetInterface(Dut device) {
		...
		try {
			...
			/**
			 * STEP 1 : Retrieve Ethernet Interface entries using TR69 TELESCOPIC SERVICE
			 * REST URL
			 */
			...
			/**
			 * STEP 2 : Retrieve Ethernet Interface entries using webpa and validate with
			 * tr69 response
			 */
			stepNumber++;
			stepNum = "S" + stepNumber;
	...
	/**
	 * Step1 Verification of the object object
	 * Device.WiFi.Radio.10000.PossibleChannels via TR69 Step2 Validation of the
	 * Object object Device.WiFi.Radio.10000.PossibleChannels via WebPa Step3
	 * Verification of the object object Device.WiFi.Radio.10000.ChannelsInUse via
	 * TR69 Step4 Validation of the Object object
	 * Device.WiFi.Radio.10000.ChannelsInUse via WebPa Step5 Verification of the
	 * object object Device.WiFi.Radio.10000.Channel via TR69 Step6 Validation of
	 * the Object object Device.WiFi.Radio.10000.Channel via WebPa Step7
	 * Verification of the object object
	 * Device.WiFi.Radio.10000.AutoChannelSupported via TR69 Step8 Validation of the
	 * Object object Device.WiFi.Radio.10000.AutoChannelSupported via WebPa Step9
	 * Verification of the object object Device.WiFi.Radio.10000.AutoChannelEnable
	 * via TR69 Step10 Validation of the Object object
	 * Device.WiFi.Radio.10000.AutoChannelEnable via WebPa Step11 Verification of
	 * the object object Device.WiFi.Radio.10000.AutoChannelRefreshPeriod via TR69
	 * Step12 Validation of the Object object
	 * Device.WiFi.Radio.10000.AutoChannelRefreshPeriod via WebPa Step13
	 * Verification of the object object
	 * Device.WiFi.Radio.10000.OperatingChannelBandwidth via TR69 Step14 Validation
	 * of the Object object Device.WiFi.Radio.10000.OperatingChannelBandwidth via
	 * WebPa Step15 Verification of the object object
	 * Device.WiFi.Radio.10000.ExtensionChannel via TR69 Step16 Validation of the
	 * Object object Device.WiFi.Radio.10000.ExtensionChannel via WebPa Step17
	 * Verification of the object object Device.WiFi.Radio.10000.GuardInterval via
	 * TR69 Step18 Validation of the Object object
	 * Device.WiFi.Radio.10000.GuardInterval via WebPa Step19 Verification of the
	 * object object Device.WiFi.Radio.10000.MCS via TR69 Step20 Validation of the
	 * Object object Device.WiFi.Radio.10000.MCS via WebPa Step21 Verification of
	 * the object object Device.WiFi.Radio.10000.TransmitPowerSupported via TR69
	 * Step22 Validation of the Object object
	 * Device.WiFi.Radio.10000.TransmitPowerSupported via WebPa Step23 Verification
	 * of the object object Device.WiFi.Radio.10000.TransmitPower via TR69 Step24
	 * Validation of the Object object Device.WiFi.Radio.10000.TransmitPower via
	 * WebPa Step25 Verification of the object object
	 * Device.WiFi.Radio.10000.IEEE80211hSupported via TR69 Step26 Validation of the
	 * Object object Device.WiFi.Radio.10000.IEEE80211hSupported via WebPa Step27
	 * Verification of the object object Device.WiFi.Radio.10000.IEEE80211hEnabled
	 * via TR69 Step28 Validation of the Object object
	 * Device.WiFi.Radio.10000.IEEE80211hEnabled via WebPa Step29 Verification of
	 * the object object Device.WiFi.Radio.10000.RegulatoryDomain via TR69 Step30
	 * Validation of the Object object Device.WiFi.Radio.10000.RegulatoryDomain via
	 * WebPa Step31 Verification of the object object
	 * Device.WiFi.Radio.10100.PossibleChannels via TR69 Step32 Validation of the
	 * Object object Device.WiFi.Radio.10100.PossibleChannels via WebPa Step33
	 * Verification of the object object Device.WiFi.Radio.10100.ChannelsInUse via
	 * TR69 Step34 Validation of the Object object
	 * Device.WiFi.Radio.10100.ChannelsInUse via WebPa Step35 Verification of the
	 * object object Device.WiFi.Radio.10100.Channel via TR69 Step36 Validation of
	 * the Object object Device.WiFi.Radio.10100.Channel via WebPa Step37
	 * Verification of the object object
	 * Device.WiFi.Radio.10100.AutoChannelSupported via TR69 Step38 Validation of
	 * the Object object Device.WiFi.Radio.10100.AutoChannelSupported via WebPa
	 * Step39 Verification of the object object
	 * Device.WiFi.Radio.10100.AutoChannelEnable via TR69 Step40 Validation of the
	 * Object object Device.WiFi.Radio.10100.AutoChannelEnable via WebPa Step41
	 * Verification of the object object
	 * Device.WiFi.Radio.10100.AutoChannelRefreshPeriod via TR69 Step42 Validation
	 * of the Object object Device.WiFi.Radio.10100.AutoChannelRefreshPeriod via
	 * WebPa Step43 Verification of the object object
	 * Device.WiFi.Radio.10100.OperatingChannelBandwidth via TR69 Step44 Validation
	 * of the Object object Device.WiFi.Radio.10100.OperatingChannelBandwidth via
	 * WebPa Step45 Verification of the object object
	 * Device.WiFi.Radio.10100.ExtensionChannel via TR69 Step46 Validation of the
	 * Object object Device.WiFi.Radio.10100.ExtensionChannel via WebPa Step47
	 * Verification of the object object Device.WiFi.Radio.10100.GuardInterval via
	 * TR69 Step48 Validation of the Object object
	 * Device.WiFi.Radio.10100.GuardInterval via WebPa Step49 Verification of the
	 * object object Device.WiFi.Radio.10100.MCS via TR69 Step50 Validation of the
	 * Object object Device.WiFi.Radio.10100.MCS via WebPa Step51 Verification of
	 * the object object Device.WiFi.Radio.10100.TransmitPowerSupported via TR69
	 * Step52 Validation of the Object object
	 * Device.WiFi.Radio.10100.TransmitPowerSupported via WebPa Step53 Verification
	 * of the object object Device.WiFi.Radio.10100.TransmitPower via TR69 Step54
	 * Validation of the Object object Device.WiFi.Radio.10100.TransmitPower via
	 * WebPa Step55 Verification of the object object
	 * Device.WiFi.Radio.10100.IEEE80211hSupported via TR69 Step56 Validation of the
	 * Object object Device.WiFi.Radio.10100.IEEE80211hSupported via WebPa Step57
	 * Verification of the object object Device.WiFi.Radio.10100.IEEE80211hEnabled
	 * via TR69 Step58 Validation of the Object object
	 * Device.WiFi.Radio.10100.IEEE80211hEnabled via WebPa Step59 Verification of
	 * the object object Device.WiFi.Radio.10100.RegulatoryDomain via TR69 Step60
	 * Validation of the Object object Device.WiFi.Radio.10100.RegulatoryDomain via
	 * WebPa
	 * 
	 * @author Sathurya Ravi
	 * @refactor yamini.s
	...
	private void verifyRadioFrequencyObjectsForTR69(String index, int stepNumber, Dut device, String testId) {
		...
		/*
		 * Validate the TR69 response of Device.WiFi.Radio.{i}.PossibleChannels against
		 * WebPa response
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		...
		/*
		 * Validate the TR69 response of Device.WiFi.Radio.{i}.ChannelsInUse against
		 * WebPa response
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		...
		/*
		 * Validate the TR69 response of Device.WiFi.Radio.{i}.Channel against WebPa
		 * response
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		...
		/*
		 * Validate the TR69 response of Device.WiFi.Radio.{i}.AutoChannelSupported
		 * against WebPa response
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		...
		/*
		 * Validate the TR69 response of Device.WiFi.Radio.{i}.AutoChannelEnable against
		 * WebPa response
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		...
		/*
		 * Validate the TR69 response of Device.WiFi.Radio.{i}.AutoChannelRefreshPeriod
		 * against WebPa response
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		...
		/*
		 * Validate the TR69 response of Device.WiFi.Radio.{i}.OperatingChannelBandwidth
		 * against WebPa response
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		...
		/*
		 * Validate the TR69 response of Device.WiFi.Radio.{i}.ExtensionChannel against
		 * WebPa response
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		...
		/*
		 * Validate the TR69 response of Device.WiFi.Radio.{i}.GuardInterval against
		 * WebPa response
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		...
		if (response != null) {
			...
			// Checks if the response is a valid integer or not. If it is a valid integer it
			// will not throw number
			// format exception.
			if (CommonMethods.isNotNull(response)) {
				try {
		...
		/*
		 * Validate the TR69 response of Device.WiFi.Radio.{i}.MCS against WebPa
		 * response
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		...
		/*
		 * Validate the TR69 response of Device.WiFi.Radio.{i}.TransmitPowerSupported
		 * against WebPa response
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		...
		/*
		 * Validate the TR69 response of Device.WiFi.Radio.{i}.TransmitPower against
		 * WebPa response
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		...
		/*
		 * Validate the TR69 response of Device.WiFi.Radio.{i}.IEEE80211hSupported
		 * against WebPa response
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		...
		/*
		 * Validate the TR69 response of Device.WiFi.Radio.{i}.IEEE80211hEnabled against
		 * WebPa response
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		...
		/*
		 * Validate the TR69 response of Device.WiFi.Radio.{i}.RegulatoryDomain against
		 * WebPa response
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
	 ...
	 * Step 1 :
	 * </p>
	 * <li>Verify that device reboots using TR-181 parameter
	 * 'Device.X_CISCO_COM_DeviceControl.RebootDevice' via TR-69/ACS</li>
	 * <li>Set the TR-181 parameter TR-181 parameter
	 * 'Device.X_CISCO_COM_DeviceControl.RebootDevice' with value 'Device' and data
	 * type as "string' via TR-69/ACS</li>
	 * 
	 * <p>
	 * Step 2:
	 * </p>
	 * <li>Verify that device get rebooted and come up after 4 to 5 minutes</li>
	 * <li>Device should reboot and comes up online without any issues. SSH should
	 * work.s</li>
	 * 
	 * <p>
	 * Step 3:
	 ...
	 * <li>Device should log the source of trigger and logs will be backed up before
	 * initiating the reboot. Logs will be available in /nvram/logs/ or
	 * /nvram2/logs/</li>
	 * 
	 * <p>
	 * Step 4:
	 ...
	 * <li>Device should log the last reboot reason properly.Reboot reason should be
	 * something like tr69-reboot.</li>
	 * 
	 * <p>
	 * Step 5:
	 * </p>
	 * <li>Verify that TR-181 parameter returns the correct reboot reason via
	 * TR-69/ACS</li>
	 * <li>TR-181 parameter should return the proper last reboot reason via
	 * TR-69/ACS</li>
	 * 
	 * <p>
	 * Step 6:
	 * </p>
	 * <li>Verify that device logs the time required for completing the intermediate
	 * stages in BootTime.log</li>
	 * <li>Device should logs the time take for completing intermediate stages.</li>
	 * 
	 * <p>
	 * Step 7:
	 * </p>
	 * <li>Verify that device logs proper log message indicate device up after
	 * successful reboot.</li>
	 * <li>Device should logs proper log messages to indicate that device is up
	 * after successful reboot</li>
	 * 
	 * 
	 * @param device
	 * @author Arun V S
	...
	public void testToVerifyRdkbRebootUsingTr69AcsCommand(Dut device) {
		...
		try {
			...
			/*
			 * Due to bootup logs, it takes more time for searching in buffer. So clearing
			 * buffer and start buffering the trace.
			 */
			tapEnv.cleanupTraceBuffer(device);

			/**
			 * Rebooting the box using TR-181 parameter
			 * 'Device.X_CISCO_COM_DeviceControl.RebootDevice' via TR-69/ACS
			 * 
			 */
			...
			/**
			 * Retrieve TR-69 logs to identify the TR-69 reboot using trace provider, After
			 * reboot, trace get restarted which clears the buffered logs.
			 */
			...
			/**
			 * Checking if the box rebooted successfully. Make sure that the ip is not
			 * accessible
			 */
			...
			/**
			 * Waiting for 5 minutes to make sure the required services are up and running
			 * in the box
			 * 
			 */
	...
	/**
	 * Step1: Verification of the object Device.WiFi.SSID.10001.Stats.BytesSent
	 * Step2: Verification of the object Device.WiFi.SSID.10001.Stats.BytesReceived
	 * Step3: Verification of the object Device.WiFi.SSID.10001.Stats.PacketsSent
	 * Step4: Verification of the object
	 * Device.WiFi.SSID.10001.Stats.PacketsReceived Step5: Verification of the
	 * object Device.WiFi.SSID.10001.Stats.ErrorsSent Step6: Verification of the
	 * object Device.WiFi.SSID.10001.Stats.ErrorsReceived Step7: Verification of the
	 * object Device.WiFi.SSID.10001.Stats.UnicastPacketsSent Step8: Verification of
	 * the object Device.WiFi.SSID.10001.Stats.UnicastPacketsReceived Step9:
	 * Verification of the object Device.WiFi.SSID.10001.Stats.DiscardPacketsSent
	 * Step10: Verification of the object
	 * Device.WiFi.SSID.10001.Stats.DiscardPacketsReceived Step11: Verification of
	 * the object Device.WiFi.SSID.10001.Stats.MulticastPacketsSent Step12:
	 * Verification of the object
	 * Device.WiFi.SSID.10001.Stats.MulticastPacketsReceived Step13: Verification of
	 * the object Device.WiFi.SSID.10001.Stats.BroadcastPacketsSent Step14:
	 * Verification of the object
	 * Device.WiFi.SSID.10001.Stats.BroadcastPacketsReceived Step15: Verification of
	 * the object Device.WiFi.SSID.10001.Stats.UnknownProtoPacketsReceived Step16:
	 * Verification of the object Device.WiFi.SSID.10001.Stats.RetransCount Step17:
	 * Verification of the object Device.WiFi.SSID.10001.Stats.FailedRetransCount
	 * Step18: Verification of the object Device.WiFi.SSID.10001.Stats.RetryCount
	 * Step19: Verification of the object
	 * Device.WiFi.SSID.10001.Stats.MultipleRetryCount Step20: Verification of the
	 * object Device.WiFi.SSID.10001.Stats.ACKFailureCount Step21: Verification of
	 * the object Device.WiFi.SSID.10001.Stats.AggregatedPacketCount Step22:
	 * Verification of the object Device.WiFi.SSID.10101.Stats.BytesSent Step23:
	 * Verification of the object Device.WiFi.SSID.10101.Stats.BytesReceived Step24:
	 * Verification of the object Device.WiFi.SSID.10101.Stats.PacketsSent Step25:
	 * Verification of the object Device.WiFi.SSID.10101.Stats.PacketsReceived
	 * Step26: Verification of the object Device.WiFi.SSID.10101.Stats.ErrorsSent
	 * Step27: Verification of the object
	 * Device.WiFi.SSID.10101.Stats.ErrorsReceived Step28: Verification of the
	 * object Device.WiFi.SSID.10101.Stats.UnicastPacketsSent Step29: Verification
	 * of the object Device.WiFi.SSID.10101.Stats.UnicastPacketsReceived Step30:
	 * Verification of the object Device.WiFi.SSID.10101.Stats.DiscardPacketsSent
	 * Step31: Verification of the object
	 * Device.WiFi.SSID.10101.Stats.DiscardPacketsReceived Step32: Verification of
	 * the object Device.WiFi.SSID.10101.Stats.MulticastPacketsSent Step33:
	 * Verification of the object
	 * Device.WiFi.SSID.10101.Stats.MulticastPacketsReceived Step34: Verification of
	 * the object Device.WiFi.SSID.10101.Stats.BroadcastPacketsSent Step35:
	 * Verification of the object
	 * Device.WiFi.SSID.10101.Stats.BroadcastPacketsReceived Step36: Verification of
	 * the object Device.WiFi.SSID.10101.Stats.UnknownProtoPacketsReceived Step37:
	 * Verification of the object Device.WiFi.SSID.10101.Stats.RetransCount Step38:
	 * Verification of the object Device.WiFi.SSID.10101.Stats.FailedRetransCount
	 * Step39: Verification of the object Device.WiFi.SSID.10101.Stats.RetryCount
	 * Step40: Verification of the object
	 * Device.WiFi.SSID.10101.Stats.MultipleRetryCount Step41: Verification of the
	 * object Device.WiFi.SSID.10101.Stats.ACKFailureCount Step42: Verification of
	 * the object Device.WiFi.SSID.10101.Stats.AggregatedPacketCount
	 * 
	 * @author Sathurya Ravi
	 * @refactor Alan_Bivera
	 * 
	 * @param Dut device to be used for execution
	 * 
	 */
	...
	/**
	 * Step1: Verification of the write access for object Device.WiFi.Radio.1.
	 * Step2: Validate the write access of Device.WiFi.Radio.1.Stats. Step3:
	 * Validate the write access of Device.WiFi.Radio.1.Enable Step4: Validate the
	 * write access of Device.WiFi.Radio.1.Status Step5: Validate the write access
	 * of Device.WiFi.Radio.1.Alias Step6: Validate the write access of
	 * Device.WiFi.Radio.1.Name Step7: Verification of the write access for object
	 * Device.WiFi.Radio.2. Step8: Validate the write access of
	 * Device.WiFi.Radio.2.Stats. Step9: Validate the write access of
	 * Device.WiFi.Radio.2.Enable Step10: Validate the write access of
	 * Device.WiFi.Radio.2.Status Step11: Validate the write access of
	 * Device.WiFi.Radio.2.Alias Step12: Validate the write access of
	 * Device.WiFi.Radio.2.Name
	 * 
	 * @author Sathurya Ravi
	 * @refactor Govardhan
	 * 
	...
	@Test(dataProvider = DataProviderConstants.PARALLEL_DATA_PROVIDER, dataProviderClass = AutomaticsTapApi.class, alwaysRun = true, enabled = true, groups = {
			BroadBandTestGroup.WIFI, BroadBandTestGroup.TR69 })
	@TestDetails(testUID = "TC-RDKB-TR69-1015")
	public void testValidateTR69WriteAccessForWiFiSSIDObjects(Dut device) {

		// stores the test result
		boolean status = false;
		// stores the test case id
		String testId = "TC-RDKB-TR69-015";
		// stores the error message
		String message = "";
		// stores the stepNumber
		String stepNumber = "s1";
		...
		LOGGER.info("#######################################################################################");
		LOGGER.info("STARTING TEST CASE: TC-RDKB-TR69-1015");
		try {
			/** Steps 1 to 6 */
			validateWriteAccessForRadioObjects(BroadBandTestConstants.TWO_FOUR_GHZ_INDEX, testId, device,
					BroadBandTestConstants.CONSTANT_1);

			/** Steps 7 to 12 */
			validateWriteAccessForRadioObjects(BroadBandTestConstants.FIVE_GHZ_INDEX, testId, device,
					BroadBandTestConstants.CONSTANT_7);

		} catch (Exception exception) {
			message = exception.getMessage();
			status = false;
			LOGGER.error("Exception occured while validating wtite access for TR69 WiFi radio parameters " + message);
			CommonUtils.updateTestStatusDuringException(tapEnv, device, testId, stepNumber, status, message, true);
		}
		LOGGER.info("ENDING TEST CASE: TC-RDKB-TR69-1015");
		LOGGER.info("#######################################################################################");
	}

	private void validateWriteAccessForRadioObjects(int index, String testId, Dut device, int stepNumber) {

		String step = "";
		String message = "";
		String response = "";
		List<Parameter> listOfParameterInfo = null;
		boolean status = false;
		String objectName = "";
		/*
		 * Verification of the write access for object Device.WiFi.Radio.{i}.
		 */
		LOGGER.info("**********************************************************************************");
		LOGGER.info("stepNumber " + stepNumber
				+ ": DESCRIPTION: Verification of the write access for object Device.WiFi.Radio." + index + ".");
		LOGGER.info(
				"stepNumber " + stepNumber + ": ACTION: a) Execute getParameterName on the object Device.WiFi.Radio."
						+ index + ". using the TR69 Rest API," + " <TELESCOPIC_URL>" + index + ".\"");
		LOGGER.info("stepNumber " + stepNumber
				+ ": EXPECTED: The response should be the list of child objects with their write permissions ");
		LOGGER.info("**********************************************************************************");
		step = "s" + stepNumber;
		status = false;
		objectName = TR69WriteAccessParameters.WEBPA_PARAM_DEVICE_WIFI_RADIO.assignIndexAndReturn(index);
		listOfParameterInfo = tapEnv.getTr69ParameterNamebyPath(device, objectName);
		status = listOfParameterInfo != null;
		message = "The response for the parameter " + objectName + " : " + listOfParameterInfo;
		LOGGER.info("Actual Status: " + message);
		tapEnv.updateExecutionStatus(device, testId, step, status, message, true);

		/*
		 * Validate the write access of Device.WiFi.Radio.{i}.Stats.
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		LOGGER.info("stepNumber " + stepNumber + ": DESCRIPTION: Validate the write access of Device.WiFi.Radio."
				+ index + ".Stats.");
		LOGGER.info("stepNumber " + stepNumber
				+ ": ACTION: a) Traverse through the parameterList obtained in the step1 and get the write access of the object Device.WiFi.Radio."
				+ index + ".Stats.");
		LOGGER.info(" 					   b) validate the write access returned in the response.");
		LOGGER.info(
				"stepNumber " + stepNumber + ": EXPECTED: The value should be false indicating it is not writable ");
		LOGGER.info("**********************************************************************************");
		step = "s" + stepNumber;
		status = false;
		objectName = TR69WriteAccessParameters.WEBPA_PARAM_DEVICE_WIFI_RADIO_STATS.assignIndexAndReturn(index);
		response = BroadBandTr69Utils.validateParameterForWriteAccess(listOfParameterInfo, objectName);
		status = BroadBandCommonUtils.compareValues(BroadBandTestConstants.CONSTANT_TXT_COMPARISON,
				RDKBTestConstants.FALSE, response);
		message = "The response for the parameter " + objectName + ": " + response + " | Expected: "
				+ RDKBTestConstants.FALSE;
		LOGGER.info("Actual Status: " + message);
		tapEnv.updateExecutionStatus(device, testId, step, status, message, false);

		/*
		 * Validate the write access of Device.WiFi.Radio.{i}.Enable
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		LOGGER.info("stepNumber " + stepNumber + ": DESCRIPTION: Validate the write access of Device.WiFi.Radio."
		...
		LOGGER.info("stepNumber " + stepNumber
				...
				+ index + ".Enable");
		LOGGER.info(" 					   b) validate the write access returned in the response.");
		LOGGER.info("stepNumber " + stepNumber + ": EXPECTED: The value should be true indicating it is writable ");
		LOGGER.info("**********************************************************************************");
		step = "s" + stepNumber;
		status = false;
		objectName = TR69WriteAccessParameters.WEBPA_PARAM_DEVICE_WIFI_RADIO_ENABLE.assignIndexAndReturn(index);
		response = BroadBandTr69Utils.validateParameterForWriteAccess(listOfParameterInfo, objectName);
		status = BroadBandCommonUtils.compareValues(BroadBandTestConstants.CONSTANT_TXT_COMPARISON,
				RDKBTestConstants.TRUE, response);
		message = "The response for the parameter " + objectName + " Actual: " + response + " | Expected: "
				+ RDKBTestConstants.TRUE;
		LOGGER.info("Actual Status: " + message);
		tapEnv.updateExecutionStatus(device, testId, step, status, message, false);

		/*
		 * Validate the write access of Device.WiFi.Radio.{i}.Status
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		LOGGER.info("stepNumber " + stepNumber + ": DESCRIPTION: Validate the write access of Device.WiFi.Radio."
		...
		step = "s" + stepNumber;
		status = false;
		objectName = TR69WriteAccessParameters.WEBPA_PARAM_DEVICE_WIFI_RADIO_STATUS.assignIndexAndReturn(index);
		response = BroadBandTr69Utils.validateParameterForWriteAccess(listOfParameterInfo, objectName);
		status = BroadBandCommonUtils.compareValues(BroadBandTestConstants.CONSTANT_TXT_COMPARISON,
				RDKBTestConstants.FALSE, response);
		message = "The response for the parameter " + objectName + " Actual: " + response + " | Expected: "
		...
		/*
		 * Validate the write access of Device.WiFi.Radio.{i}.Alias
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		LOGGER.info("stepNumber " + stepNumber + ": DESCRIPTION: Validate the write access of Device.WiFi.Radio."
		...
		step = "s" + stepNumber;
		status = false;
		objectName = TR69WriteAccessParameters.WEBPA_PARAM_DEVICE_WIFI_RADIO_ALIAS.assignIndexAndReturn(index);
		response = BroadBandTr69Utils.validateParameterForWriteAccess(listOfParameterInfo, objectName);
		status = BroadBandCommonUtils.compareValues(BroadBandTestConstants.CONSTANT_TXT_COMPARISON,
				RDKBTestConstants.TRUE, response);
		message = "The response for the parameter " + objectName + " Actual: " + response + " | Expected: "
		...
		/*
		 * Validate the write access of Device.WiFi.Radio.{i}.Name
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		LOGGER.info("stepNumber " + stepNumber + ": DESCRIPTION: Validate the write access of Device.WiFi.Radio."
		...
		step = "s" + stepNumber;
		status = false;
		objectName = TR69WriteAccessParameters.WEBPA_PARAM_DEVICE_WIFI_RADIO_NAME.assignIndexAndReturn(index);
		response = BroadBandTr69Utils.validateParameterForWriteAccess(listOfParameterInfo, objectName);
		status = BroadBandCommonUtils.compareValues(BroadBandTestConstants.CONSTANT_TXT_COMPARISON,
				RDKBTestConstants.FALSE, response);
		message = "The response for the parameter " + objectName + " Actual: " + response + " | Expected: "
	...
	/**
	 * Step1: Verification of the write access for object Device.WiFi.AccessPoint.1.
	 * 
	 * Step2: Validate the write access of Device.WiFi.AccessPoint.1.Security.
	 * 
	 * Step3: Validate the write access of Device.WiFi.AccessPoint.1.WPS.
	 * 
	 * Step4: Validate the write access of
	 * Device.WiFi.AccessPoint.1.AssociatedDevice
	 * 
	 * Step5: Validate the write access of Device.WiFi.AccessPoint.1.Enable
	 * 
	 * Step6: Validate the write access of Device.WiFi.AccessPoint.1.Status
	 * 
	 * Step7: Validate the write access of Device.WiFi.AccessPoint.1.Alias
	 * 
	 * Step8: Validate the write access of Device.WiFi.AccessPoint.1.SSIDReference
	 * 
	 * Step9: Verification of the write access for object Device.WiFi.AccessPoint.2.
	 * 
	 * Step10: Validate the write access of Device.WiFi.AccessPoint.2.Security.
	 * 
	 * Step11: Validate the write access of Device.WiFi.AccessPoint.2.WPS.
	 * 
	 * Step12: Validate the write access of
	 * Device.WiFi.AccessPoint.2.AssociatedDevice
	 * 
	 * Step13: Validate the write access of Device.WiFi.AccessPoint.2.Enable
	 * 
	 * Step14: Validate the write access of Device.WiFi.AccessPoint.2.Status
	 * 
	 * Step15: Validate the write access of Device.WiFi.AccessPoint.2.Alias
	 * 
	 * Step16: Validate the write access of Device.WiFi.AccessPoint.2.SSIDReference
	 *
	 * Step17: Verification of the write access for object
	 * Device.WiFi.AccessPoint.3.
	 * 
	 * Step18: Validate the write access of Device.WiFi.AccessPoint.3.Security.
	 * 
	 * Step19: Validate the write access of Device.WiFi.AccessPoint.3.WPS.
	 *
	 * Step20: Validate the write access of
	 * Device.WiFi.AccessPoint.3.AssociatedDevice
	 * 
	 * Step21: Validate the write access of Device.WiFi.AccessPoint.3.Enable
	 * 
	 * Step22: Validate the write access of Device.WiFi.AccessPoint.3.Status
	 * 
	 * Step23: Validate the write access of Device.WiFi.AccessPoint.3.Alias
	 * 
	 * Step24: Validate the write access of Device.WiFi.AccessPoint.3.SSIDReference
	 * 
	 * Step25: Verification of the write access for object
	 * Device.WiFi.AccessPoint.4.
	 * 
	 * Step26: Validate the write access of Device.WiFi.AccessPoint.4.Security.
	 * 
	 * Step27: Validate the write access of Device.WiFi.AccessPoint.4.WPS.
	 * 
	 * Step28: Validate the write access of
	 * Device.WiFi.AccessPoint.4.AssociatedDevice
	 * 
	 * Step29: Validate the write access of Device.WiFi.AccessPoint.4.Enable
	 * 
	 * Step30: Validate the write access of Device.WiFi.AccessPoint.4.Status
	 * 
	 * Step31: Validate the write access of Device.WiFi.AccessPoint.4.Alias
	 * 
	 * Step32: Validate the write access of Device.WiFi.AccessPoint.4.SSIDReference
	 * 
	 * Step33: Verification of the write access for object
	 * Device.WiFi.AccessPoint.5.
	 * 
	 * Step34: Validate the write access of Device.WiFi.AccessPoint.5.Security.
	 * 
	 * Step35: Validate the write access of Device.WiFi.AccessPoint.5.WPS.
	 * 
	 * Step36: Validate the write access of
	 * Device.WiFi.AccessPoint.5.AssociatedDevice
	 * 
	 * Step37: Validate the write access of Device.WiFi.AccessPoint.5.Enable
	 * 
	 * Step38: Validate the write access of Device.WiFi.AccessPoint.5.Status
	 * 
	 * Step39: Validate the write access of Device.WiFi.AccessPoint.5.Alias
	 * 
	 * Step40: Validate the write access of Device.WiFi.AccessPoint.5.SSIDReference
	 * 
	 * Step41: Verification of the write access for object
	 * Device.WiFi.AccessPoint.6.
	 * 
	 * Step42: Validate the write access of Device.WiFi.AccessPoint.6.Security.
	 * 
	 * Step43: Validate the write access of Device.WiFi.AccessPoint.6.WPS.
	 * 
	 * Step44: Validate the write access of
	 * Device.WiFi.AccessPoint.6.AssociatedDevice
	 * 
	 * Step45: Validate the write access of Device.WiFi.AccessPoint.6.Enable
	 * 
	 * Step46: Validate the write access of Device.WiFi.AccessPoint.6.Status
	 * 
	 * Step47: Validate the write access of Device.WiFi.AccessPoint.6.Alias
	 * 
	 * Step48: Validate the write access of Device.WiFi.AccessPoint.6.SSIDReference
	 *
	 * @author Sathurya Ravi
	 *
	 * @param device device to be used for execution
	...
	@Test(dataProvider = DataProviderConstants.PARALLEL_DATA_PROVIDER, dataProviderClass = AutomaticsTapApi.class, alwaysRun = true, enabled = true, groups = {
			BroadBandTestGroup.WIFI, BroadBandTestGroup.TR69 })
	@TestDetails(testUID = "TC-RDKB-TR69-1017")
	public void testValidateTR69WriteAccessForWiFiAccessPointObjects(Dut device) {

		// stores the test result
		boolean status = false;
		// stores the test case id
		String testId = "TC-RDKB-TR69-017";
		// stores the error message
		String message = "";
		// stores the stepNumber
		String stepNumber = "s1";
		...
		try {
			/** Steps 1 to 8 */
			validateWriteAccessForAccessPointObjects(
					Integer.parseInt(BroadBandTestConstants.ACCESS_POINT_MAPPING.get("1")), testId, device,
					BroadBandTestConstants.CONSTANT_1);

			/** Steps 9 to 16 */
			validateWriteAccessForAccessPointObjects(
					Integer.parseInt(BroadBandTestConstants.ACCESS_POINT_MAPPING.get("2")), testId, device,
					BroadBandTestConstants.CONSTANT_9);

			/** Steps 17 to 24 */
			validateWriteAccessForAccessPointObjects(
					Integer.parseInt(BroadBandTestConstants.ACCESS_POINT_MAPPING.get("3")), testId, device,
					BroadBandTestConstants.CONSTANT_17);

			/** Steps 25 to 32 */
			validateWriteAccessForAccessPointObjects(
					Integer.parseInt(BroadBandTestConstants.ACCESS_POINT_MAPPING.get("4")), testId, device,
					BroadBandTestConstants.CONSTANT_25);

			/** Steps 33 to 40 */
			validateWriteAccessForAccessPointObjects(
					Integer.parseInt(BroadBandTestConstants.ACCESS_POINT_MAPPING.get("5")), testId, device,
					BroadBandTestConstants.CONSTANT_33);

			/** Steps 41 to 48 */
			validateWriteAccessForAccessPointObjects(
					Integer.parseInt(BroadBandTestConstants.ACCESS_POINT_MAPPING.get("6")), testId, device,
					BroadBandTestConstants.CONSTANT_41);

		} catch (Exception exception) {
			message = exception.getMessage();
			LOGGER.error(
					"Exception occured while validating write access for TR69 WiFi Access Point objects " + message);
			CommonUtils.updateTestStatusDuringException(tapEnv, device, testId, stepNumber, status, message, true);
		}
	}
	 ...
	 * @Refactor Sruthi Santhosh
	 */
	private void validateWriteAccessForAccessPointObjects(int index, String testId, Dut device, int stepNumber) {
		...
		String objectName = "";
		/*
		 * Verification of the write access for object Device.WiFi.AccessPoint.{i}.
		 */
		LOGGER.info("**********************************************************************************");
		LOGGER.info("stepNumber " + stepNumber
				+ ": DESCRIPTION: Verification of the write access for object Device.WiFi.AccessPoint." + index + ". ");
		LOGGER.info("stepNumber " + stepNumber
				+ ": ACTION: a) Execute getParameterName on the object Device.WiFi.AccessPoint." + index
				+ ". using the TR69 parameter Device.WiFi.AccessPoint."
				+ index + ". \"");
		LOGGER.info(" b) Validate the child object of Device.WiFi.AccessPoint." + index + ". for their write access");
		LOGGER.info("stepNumber " + stepNumber
				+ ": EXPECTED: The response should be the list of child objects with their write permissions ");
		LOGGER.info("**********************************************************************************");
		step = "s" + stepNumber;
		...
		objectName = TR69WriteAccessParameters.WEBPA_PARAM_DEVICE_WIFI_ACCESSPOINT.assignIndexAndReturn(index);
		...
		/*
		 * Validate the write access of Device.WiFi.AccessPoint.{i}.Security.
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		LOGGER.info("stepNumber " + stepNumber + ": DESCRIPTION: Validate the write access of Device.WiFi.AccessPoint."
				+ index + ".Security. ");
		LOGGER.info("stepNumber " + stepNumber
				+ ": ACTION: a) Traverse through the parameterList obtained in the step1 and get the write access of the object Device.WiFi.AccessPoint."
				+ index + ".Security.");
		LOGGER.info(" b) validate the write access returned in the response.");
		LOGGER.info(
				"stepNumber " + stepNumber + ": EXPECTED: The value should be false indicating it is not writable ");
		...
		step = "s" + stepNumber;
		status = false;
		objectName = TR69WriteAccessParameters.WEBPA_PARAM_DEVICE_WIFI_ACCESSPOINT_SECURITY.assignIndexAndReturn(index);
		response = BroadBandTr69Utils.validateParameterForWriteAccess(listOfParameterInfo, objectName);
		status = BroadBandCommonUtils.compareValues(BroadBandTestConstants.CONSTANT_TXT_COMPARISON,
				RDKBTestConstants.FALSE, response);
		message = "The response for the parameter " + objectName + " Actual: " + response + " | Expected: "
		...
		/*
		 * Validate the write access of Device.WiFi.AccessPoint.{i}.WPS.
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		LOGGER.info("stepNumber " + stepNumber + ": DESCRIPTION: Validate the write access of Device.WiFi.AccessPoint."
		...
		step = "s" + stepNumber;
		status = false;
		objectName = TR69WriteAccessParameters.WEBPA_PARAM_DEVICE_WIFI_ACCESSPOINT_WPS.assignIndexAndReturn(index);
		response = BroadBandTr69Utils.validateParameterForWriteAccess(listOfParameterInfo, objectName);
		status = BroadBandCommonUtils.compareValues(BroadBandTestConstants.CONSTANT_TXT_COMPARISON,
				RDKBTestConstants.FALSE, response);
		message = "The response for the parameter " + objectName + " Actual: " + response + " | Expected: "
		...
		/*
		 * Validate the write access of Device.WiFi.AccessPoint.{i}.AssociatedDevice
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		LOGGER.info("stepNumber " + stepNumber + ": DESCRIPTION: Validate the write access of Device.WiFi.AccessPoint."
				+ index + ".AssociatedDevice ");
		LOGGER.info("stepNumber " + stepNumber
				+ ": ACTION: a) Traverse through the parameterList obtained in the step1 and get the write access of the object Device.WiFi.AccessPoint."
				+ index + ".AssociatedDevice");
		LOGGER.info(" b) validate the write access returned in the response.");
		...
		step = "s" + stepNumber;
		status = false;
		objectName = TR69WriteAccessParameters.WEBPA_PARAM_DEVICE_WIFI_ACCESSPOINT_ASSOCIATEDDEVICE
				.assignIndexAndReturn(index);
		response = BroadBandTr69Utils.validateParameterForWriteAccess(listOfParameterInfo, objectName);
		status = BroadBandCommonUtils.compareValues(BroadBandTestConstants.CONSTANT_TXT_COMPARISON,
				RDKBTestConstants.FALSE, response);
		message = "The response for the parameter " + objectName + " Actual: " + response + " | Expected: "
		...
		/*
		 * Validate the write access of Device.WiFi.AccessPoint.{i}.Enable
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		LOGGER.info("stepNumber " + stepNumber + ": DESCRIPTION: Validate the write access of Device.WiFi.AccessPoint."
		...
		/*
		 * Validate the write access of Device.WiFi.AccessPoint.{i}.Status
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		LOGGER.info("stepNumber " + stepNumber + ": DESCRIPTION: Validate the object Device.WiFi.AccessPoint." + index
				+ ".Status");
		LOGGER.info("stepNumber " + stepNumber
				+ ": ACTION: a) Traverse through the parameterList obtained in the step1 and get the write access of the object Device.WiFi.AccessPoint."
				+ index + ".Status");
		...
		step = "s" + stepNumber;
		status = false;
		objectName = TR69WriteAccessParameters.WEBPA_PARAM_DEVICE_WIFI_ACCESSPOINT_STATUS.assignIndexAndReturn(index);
		response = BroadBandTr69Utils.validateParameterForWriteAccess(listOfParameterInfo, objectName);
		status = BroadBandCommonUtils.compareValues(BroadBandTestConstants.CONSTANT_TXT_COMPARISON,
				RDKBTestConstants.FALSE, response);
		message = "The response for the parameter " + objectName + " Actual: " + response + " | Expected: "
		...
		/*
		 * Validate the write access of Device.WiFi.AccessPoint.{i}.Alias
		 */
		++stepNumber;
		LOGGER.info("**********************************************************************************");
		LOGGER.info("stepNumber " + stepNumber + ": DESCRIPTION: Validate the object Device.WiFi.AccessPoint." + index
		...
		/*
		 * Verification of the write access for object
		...
		LOGGER.info("stepNumber " + stepNumber
				+ ": ACTION: a) Execute getParameterName on the object Device.WiFi.AccessPoint." + index
				+ ".SSIDReference using the TR69 Device.WiFi.AccessPoint"
				+ index + ".SSIDReference \"");
		LOGGER.info(" b) Validate the child object of Device.WiFi.AccessPoint." + index
				+ ".SSIDReference for their write access");
		LOGGER.info("stepNumber " + stepNumber
				+ ": EXPECTED: The response should be the list of child objects with their write permissions ");
		LOGGER.info("**********************************************************************************");
		step = "s" + stepNumber;
		status = false;
		objectName = TR69WriteAccessParameters.WEBPA_PARAM_DEVICE_WIFI_ACCESSPOINT_SSIDREFERENCE
				.assignIndexAndReturn(index);
		response = BroadBandTr69Utils.validateParameterForWriteAccess(listOfParameterInfo, objectName);
		status = BroadBandCommonUtils.compareValues(BroadBandTestConstants.CONSTANT_TXT_COMPARISON,
				RDKBTestConstants.TRUE, response);
	...
	/**
     * Step1: Verification of the write access for object Device.WiFi.SSID.1. Step2: Validate the write access of
     * Device.WiFi.SSID.1.Stats. Step3: Validate the write access of Device.WiFi.SSID.1.Enable Step4: Validate the write
     * access of Device.WiFi.SSID.1.Status Step5: Validate the write access of Device.WiFi.SSID.1.Alias Step6: Validate
     * the write access of Device.WiFi.SSID.1.Name Step7: Validate the write access of Device.WiFi.SSID.1.LastChange
     * Step8: Verification of the write access for object Device.WiFi.SSID.2. Step9: Validate the write access of
     * Device.WiFi.SSID.2.Stats. Step10: Validate the write access of Device.WiFi.SSID.2.Enable Step11: Validate the
     * write access of Device.WiFi.SSID.2.Status Step12: Validate the write access of Device.WiFi.SSID.2.Alias Step13:
     * Validate the write access of Device.WiFi.SSID.2.Name Step14: Validate the write access of
     * Device.WiFi.SSID.2.LastChange Step15: Verification of the write access for object Device.WiFi.SSID.3. Step16:
     * Validate the write access of Device.WiFi.SSID.3.Stats. Step17: Validate the write access of
     * Device.WiFi.SSID.3.Enable Step18: Validate the write access of Device.WiFi.SSID.3.Status Step19: Validate the
     * write access of Device.WiFi.SSID.3.Alias Step20: Validate the write access of Device.WiFi.SSID.3.Name Step21:
     * Validate the write access of Device.WiFi.SSID.3.LastChange Step22: Verification of the write access for object
     * Device.WiFi.SSID.4. Step23: Validate the write access of Device.WiFi.SSID.4.Stats. Step24: Validate the write
     * access of Device.WiFi.SSID.4.Enable Step25: Validate the write access of Device.WiFi.SSID.4.Status Step26:
     * Validate the write access of Device.WiFi.SSID.4.Alias Step27: Validate the write access of
     * Device.WiFi.SSID.4.Name Step28: Validate the write access of Device.WiFi.SSID.4.LastChange Step29: Verification
     * of the write access for object Device.WiFi.SSID.5. Step30: Validate the write access of Device.WiFi.SSID.5.Stats.
     * Step31: Validate the write access of Device.WiFi.SSID.5.Enable Step32: Validate the write access of
     * Device.WiFi.SSID.5.Status Step33: Validate the write access of Device.WiFi.SSID.5.Alias Step34: Validate the
     * write access of Device.WiFi.SSID.5.Name Step35: Validate the write access of Device.WiFi.SSID.5.LastChange
     * Step36: Verification of the write access for object Device.WiFi.SSID.6. Step37: Validate the write access of
     * Device.WiFi.SSID.6.Stats. Step38: Validate the write access of Device.WiFi.SSID.6.Enable Step39: Validate the
     * write access of Device.WiFi.SSID.6.Status Step40: Validate the write access of Device.WiFi.SSID.6.Alias Step41:
     * Validate the write access of Device.WiFi.SSID.6.Name Step42: Validate the write access of
     * Device.WiFi.SSID.6.LastChange
     * 
     * @author Sathurya Ravi
     * @refactor Said Hisham
     * 
    ...
    @Test(dataProvider = DataProviderConstants.PARALLEL_DATA_PROVIDER, dataProviderClass = AutomaticsTapApi.class, alwaysRun = true, enabled = true, groups = {
	    BroadBandTestGroup.WIFI, BroadBandTestGroup.TR69 })
    @TestDetails(testUID = "TC-RDKB-TR69-1016")
    public void testValidateTR69WriteAccessForWiFiObjects(Dut device) {

	// stores the test result
	boolean status = false;
	// stores the test case id
	String testId = "TC-RDKB-TR69-016";
	// stores the message
	String message = "";
	// stores the stepNumber
	String stepNumber = "s1";
	...
	try {
	    ...
	    /** Steps 1 to 7 */
	    validateWriteAccessForSsidObjects(BroadBandTestConstants.CONSTANT_10001, testId, device,
		    BroadBandTestConstants.CONSTANT_1);

	    /** Steps 8 to 14 */
	    validateWriteAccessForSsidObjects(BroadBandTestConstants.CONSTANT_10101, testId, device,
		    BroadBandTestConstants.CONSTANT_8);

	    /** Steps 15 to 21 */
	    validateWriteAccessForSsidObjects(BroadBandTestConstants.CONSTANT_10002, testId, device,
		    BroadBandTestConstants.CONSTANT_15);

	    /** Steps 22 to 28 */
	    validateWriteAccessForSsidObjects(BroadBandTestConstants.CONSTANT_10102, testId, device,
		    BroadBandTestConstants.CONSTANT_22);

	    /** Steps 29 to 35 */
	    validateWriteAccessForSsidObjects(BroadBandTestConstants.CONSTANT_10003, testId, device,
		    BroadBandTestConstants.CONSTANT_29);

	    /** Steps 36 to 42 */
	    validateWriteAccessForSsidObjects(BroadBandTestConstants.CONSTANT_10103, testId, device,
		    BroadBandTestConstants.CONSTANT_36);

	} catch (Exception exception) {
	    message = exception.getMessage();
	    LOGGER.error("Exception occured while validating write access for TR69 WiFi SSID objects " + message);
	    CommonUtils.updateTestStatusDuringException(tapEnv, device, testId, stepNumber, status, message, true);
	}
	
	LOGGER.info("ENDING TEST CASE: TC-RDKB-TR69-1016");

    }

    private void validateWriteAccessForSsidObjects(int index, String testId, Dut device, int stepNumber) {

	String step = "";
	String message = "";
	String response = "";
	List<Parameter> listOfParameterInfo = null;
	List<Parameter> listOfParameterInfoForStats = null;
	boolean status = false;
	String objectName = null;

	/*
	 * Verification of the write access for object Device.WiFi.SSID.{i}.
	 */
	LOGGER.info("**********************************************************************************");
	LOGGER.info("stepNumber " + stepNumber
		+ ": DESCRIPTION: Verification of the write access for  object Device.WiFi.SSID." + index + ".");
	LOGGER.info(
		"stepNumber " + stepNumber + ": ACTION: a) Execute getParameterName on the object Device.WiFi.SSID.");
	LOGGER.info("                      b) Validate the write access for child object of Device.WiFi.SSID." + index
		+ ". ");
	LOGGER.info("stepNumber " + stepNumber
		+ ": EXPECTED: The response should be the list of child objects with their write permissions ");
	LOGGER.info("**********************************************************************************");
	step = "s" + stepNumber;
	status = false;
	objectName = TR69WriteAccessParameters.WEBPA_PARAM_DEVICE_WIFI_SSID.assignIndexAndReturn(index);
	listOfParameterInfo = tapEnv.getTr69ParameterNamebyPath(device, objectName);
	status = listOfParameterInfo != null;
	message = "The response for the parameter " + objectName + " : " + listOfParameterInfo;
	LOGGER.info("Actual Status: " + message);
	...
	/*
	 * Validate the write access of Device.WiFi.SSID.{i}.Stats.
	 */
	++stepNumber;
	LOGGER.info("**********************************************************************************");
	LOGGER.info("stepNumber " + stepNumber + ": DESCRIPTION: Validate the write access of Device.WiFi.SSID." + index
		+ ".Stats. ");
	LOGGER.info("stepNumber " + stepNumber
		+ ": ACTION: a) Traverse through the parameterList obtained in the step1 and get the write access of the object  Device.WiFi.SSID."
		+ index + ".Stats. ");
	LOGGER.info("                      b) validate the write access returned in the response.");
	LOGGER.info(
		"stepNumber " + stepNumber + ": EXPECTED: The value should be false indicating it is not writable ");
	...
	step = "s" + stepNumber;
	status = false;
	objectName = TR69WriteAccessParameters.WEBPA_PARAM_DEVICE_WIFI_SSID_STATS.assignIndexAndReturn(index);
	listOfParameterInfoForStats = tapEnv.getTr69ParameterNamebyPath(device, objectName);
	response = BroadBandTr69Utils.validateParameterForWriteAccessForStats(listOfParameterInfoForStats, objectName);
	status = BroadBandCommonUtils.compareValues(BroadBandTestConstants.CONSTANT_TXT_COMPARISON,
		AutomaticsConstants.FALSE, response);
	message = "The response for the parameter " + objectName + ". Actual: " + response + " | Expected: "
	...
	/*
	 * Validate the write access of Device.WiFi.SSID.{i}.Enable
	 */
	++stepNumber;
	LOGGER.info("**********************************************************************************");
	LOGGER.info("stepNumber " + stepNumber + ": DESCRIPTION: Validate the write access of Device.WiFi.SSID." + index
	...
	step = "s" + stepNumber;
	status = false;
	objectName = TR69WriteAccessParameters.WEBPA_PARAM_DEVICE_WIFI_SSID_ENABLE.assignIndexAndReturn(index);
	response = BroadBandTr69Utils.validateParameterForWriteAccess(listOfParameterInfo, objectName);
	status = BroadBandCommonUtils.compareValues(BroadBandTestConstants.CONSTANT_TXT_COMPARISON,
		AutomaticsConstants.TRUE, response);
	message = "The response for the parameter " + objectName + ". Actual: " + response + " | Expected: "
	...
	/*
	 * Validate the write access of Device.WiFi.SSID.{i}.Status
	 */
	++stepNumber;
	LOGGER.info("**********************************************************************************");
	LOGGER.info("stepNumber " + stepNumber + ": DESCRIPTION: Validate the write access of Device.WiFi.SSID." + index
	...
	step = "s" + stepNumber;
	status = false;
	objectName = TR69WriteAccessParameters.WEBPA_PARAM_DEVICE_WIFI_SSID_STATUS.assignIndexAndReturn(index);
	response = BroadBandTr69Utils.validateParameterForWriteAccess(listOfParameterInfo, objectName);
	status = BroadBandCommonUtils.compareValues(BroadBandTestConstants.CONSTANT_TXT_COMPARISON,
		AutomaticsConstants.FALSE, response);
	message = "The response for the parameter " + objectName + " Actual: " + response + " | Expected: "
	...
	/*
	 * Validate the write access of Device.WiFi.SSID.{i}.Alias
	 */
	++stepNumber;
	LOGGER.info("**********************************************************************************");
	LOGGER.info("stepNumber " + stepNumber + ": DESCRIPTION: Validate the write access of Device.WiFi.SSID." + index
	...
	LOGGER.info("                      b) validate the write access returned in the response.");
	LOGGER.info(
		"stepNumber " + stepNumber + ": EXPECTED: The value should be true indicating that it is writable ");
	LOGGER.info("**********************************************************************************");
	step = "s" + stepNumber;
	status = false;
	objectName = TR69WriteAccessParameters.WEBPA_PARAM_DEVICE_WIFI_SSID_ALIAS.assignIndexAndReturn(index);
	response = BroadBandTr69Utils.validateParameterForWriteAccess(listOfParameterInfo, objectName);
	status = BroadBandCommonUtils.compareValues(BroadBandTestConstants.CONSTANT_TXT_COMPARISON,
		AutomaticsConstants.TRUE, response);
	message = "The response for the parameter " + objectName + " Actual: " + response + " | Expected: "
	...
	/*
	 * Validate the write access of Device.WiFi.SSID.{i}.Name
	 */
	++stepNumber;
	LOGGER.info("**********************************************************************************");
	LOGGER.info(
		"stepNumber " + stepNumber + ": DESCRIPTION: Validate the object Device.WiFi.SSID." + index + ".Name");
	LOGGER.info("stepNumber " + stepNumber
		+ ": ACTION: a) Traverse through the parameterList obtained in the step1 and get the write access of the object Device.WiFi.SSID."
		+ index + ".Name");
	LOGGER.info("                      b) validate the write access returned in the response.");
	...
	step = "s" + stepNumber;
	status = false;
	objectName = TR69WriteAccessParameters.WEBPA_PARAM_DEVICE_WIFI_SSID_NAME.assignIndexAndReturn(index);
	response = BroadBandTr69Utils.validateParameterForWriteAccess(listOfParameterInfo, objectName);
	status = BroadBandCommonUtils.compareValues(BroadBandTestConstants.CONSTANT_TXT_COMPARISON,
		AutomaticsConstants.FALSE, response);
	message = "The response for the parameter " + objectName + " Actual: " + response + " | Expected: "
	...
	/*
	 * Validate the write access of Device.WiFi.SSID.{i}.LastChange
	 */
	++stepNumber;
	LOGGER.info("**********************************************************************************");
	LOGGER.info("stepNumber " + stepNumber + ": DESCRIPTION: Validate the object Device.WiFi.SSID." + index
		+ ".LastChange");
	LOGGER.info("stepNumber " + stepNumber
		+ ": ACTION: a) Traverse through the parameterList obtained in the step1 and get the write access of the object Device.WiFi.SSID."
		+ index + ".LastChange");
	...
	step = "s" + stepNumber;
	status = false;
	objectName = TR69WriteAccessParameters.WEBPA_PARAM_DEVICE_WIFI_SSID_LASTCHANGE.assignIndexAndReturn(index);
	response = BroadBandTr69Utils.validateParameterForWriteAccess(listOfParameterInfo, objectName);
	status = BroadBandCommonUtils.compareValues(BroadBandTestConstants.CONSTANT_TXT_COMPARISON,
		AutomaticsConstants.FALSE, response);
	message = "The response for the parameter " + objectName + " Actual: " + response + " | Expected: "
