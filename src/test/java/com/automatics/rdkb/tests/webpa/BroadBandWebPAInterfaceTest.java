...
public class BroadBandWebPAInterfaceTest extends AutomaticsTestBase {
	/**
	 *
	 * Test Case # 1: Verify there are no reconnection of iot & config clients after
	 ...
	 * <li>S3) Verify that seshat library is initializing with updated
	 * SESHAT_URL.</li>
	 * <li>S4) Verify that seshat discovered url is updated PARODUS_URL in PARODUS
	 * log..</li>
	 * <li>S5) Verify iptable INPUT rule to accept <4090 iptable interface>
	 * interface connections".</li>
	 * <li>S6) Verify iptable FORWARD rule to accept <4090 iptable interface>
	 * interface connections.</li>
	 * <li>S7) Verify communication between parodus and webpa is through 4090
	 * interfaces.</li>
	 * <li>S8) Enable IOT service using WebPA command and verify that Webpa are
	 * using <4090 interface> interface ip to register with parodus.</li>
	 * <li>S9) Verify whether Webpa is able to communicate with parodus using set
	 * request..</li>
	 * <li>S10) Verify whether Webpa is able to communicate with parodus using get
	 * request..</li>
	...
	public void testWebpaInterface(Dut device) {
		...
		try {
			...
			// In order to check the InterfaceDevicesWifi report, there should a client
			// client to device .
			...
			/**
			 * Step 3 : Verify iptable INPUT rule to accept <iptable 4090 interface>
			...
			// Command to validate iptables INPUT rule to check 4090 interface connnections.
			// /usr/sbin/iptables -S|grep
			...
			tapEnv.updateExecutionStatus(device, testCaseId, stepNumber, status, errorMessage, false);
			/**
			 * Step 4 : Verify iptable FORWARD rule to accept <iptable 4090 interface>
			 * interface connections.
			 */
			LOGGER.info("**********************************************************************************");
			...
			sbCommand.append(BroadBandTestConstants.GREP_COMMAND);
			sbCommand.append(BroadBandTestConstants.STRING_ACCEPT);
			// Command to validate iptables FORWARD rule to check 4090 interface
			// connnections. /usr/sbin/iptables
			...
			/**
			 * Step 5 : Verify communication between parodus and webpa is through 4090
			 * interfaces.
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			/**
			 * Step 6 : Enable IOT service using WebPA command and Verify that Webpa is
			 * using <4090 interface> interface ip to register with parodus
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			tapEnv.updateExecutionStatus(device, testCaseId, stepNumber, status, errorMessage, false);
			/**
			 * Step 7 : Verify whether Webpa is able to communicate with parodus using set
			 * request.
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			// If WebPA request fails, remaining steps are not executed as other steps are
			// dependent on WebPA request .
			if (status) {
			...
			/**
			 * Step 8 : Verify whether Webpa is able to communicate with parodus using get
			 * request.
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			LOGGER.info("**********************************************************************************");
			// Network device parameter enables LMlite report logging.Enabling network
			// device parameter service with
			...
			/**
			 * Step 11 : Enable harvester report. Set polling and reporting period of the
			 * harvester parameter to 30.
			 */
			LOGGER.info("**********************************************************************************");
			LOGGER.info(
			...
			status = false;
			errorMessage = BroadBandTestConstants.EMPTY_STRING;
			// Interface device wifi parameter enables harvester report logging.Enabling
			// Interface Device wifi service
