...
public class BroadBandTelemetryPingTests extends AutomaticsTestBase {
	 ...
	 * </p>
	 * <ol>
	 * <li>PRE-CONDITION 1: Validate if the T2 settings are already present else set
	 * the settings and reboot the device</li>
	 * <li>STEP 1 : Verify if the 'telemetry2_0' process is up after enabling
	 * telemetry 2.0</li>
	 * <li>STEP 2 : Verify if the log file /rdklogs/logs/telemetry_2.txt.0 is
	 * present in Arm console</li>
	 * <li>STEP 3 : Verify if 'dcmscript.log' indicates T2 is enabled</li>
	 * <li>Step 4 : Validate TR181 parameter
	 * Device.IP.Diagnostics.X_RDKCENTRAL-COM_PingTest.PartnerID.</li>
	 * <li>Step 5 : Validate TR181 parameter
	 * Device.IP.Diagnostics.X_RDKCENTRAL-COM_PingTest.ecmMAC.</li>
	 * <li>Step 6 : Validate TR181 parameter
	 * Device.IP.Diagnostics.X_RDKCENTRAL-COM_PingTest.DeviceID.</li>
	 * <li>Step 7 : Validate TR181 parameter
	 * Device.IP.Diagnostics.X_RDKCENTRAL-COM_PingTest.DeviceModel.</li>
	 * <li>Step 8 : Validate TR181 parameter
	 * Device.IP.Diagnostics.IPPing.Interface.</li>
	 * <li>Step 9 : Validate Device.IP.Diagnostics.IPPing.Host.</li>
	 * <li>Step 10 : Validate
	 * Device.IP.Diagnostics.X_RDKCENTRAL-COM_PingTest.Run.</li>
	 * <li>Step 11: Validate TDMlog.txt.0 log file.</li>
	 * <li>Step 12 : Validate TR181 parameter
	 * Device.IP.Diagnostics.IPPing.NumberOfRepetitions.</li>
	 * <li>Step 13 : Validate TR181 parameter
	 * Device.IP.Diagnostics.IPPing.Timeout.</li>
	 * <li>Step 14 : Validate TR181 parameter
	 * Device.IP.Diagnostics.IPPing.AverageResponseTime.</li>
	 * <li>Step 15 : Validate if invalid url/host address is successfully set for
	 * TR181 param Device.IP.Diagnostics.IPPing.Host.</li>
	 * <li>Step 16 : Trigger ping test by passing invalid url or host address and
	 * Validate TR181 parameter Device.IP.Diagnostics.IPPing.DiagnosticsState.</li>
	 * <li>Step 17 : Validating TDMlog.txt.0 log file for invalid url/host address
	 * ping test.</li>
	 * </ol>
	 * 
	...
	public void testToGetNetworkLatencyAndMetadata(Dut device) {
		...
		try {
			...
			/**
			 * VERIFY IF THE LOG FILE /rdklogs/logs/telemetry2_0.txt.0 IS PRESENT IN ARM
			 * CONSOLE
			 */
			stepNumber = "s2";
			...
			/**
			 * Step 4 : Validate TR181 parameter
			...
			/**
			 * Step 5 : Validate TR181 parameter
			...
			/**
			 * Step 6 : Validate TR181 parameter
			 * Device.IP.Diagnostics.X_RDKCENTRAL-COM_PingTest.DeviceID.
			 */
			stepNumber = "s6";
			status = false;
			...
			/**
			 * Step 7 : Validate TR181 parameter
			 * Device.IP.Diagnostics.X_RDKCENTRAL-COM_PingTest.DeviceModel.
			 */
			stepNumber = "s7";
			status = false;
			...
			/**
			 * The default url configured in "stb.properties" for "pingtest.host.address" is
			 * : www.google.com To ping other urls, please update the value of
			 * "pingtest.host.address" in "stb.properties"
			 **/
			...
			sshCommand = BroadBandCommonUtils.concatStringUsingStringBuffer(BroadBandTestConstants.TEXT_DOUBLE_QUOTE,
					...
					BroadbandPropertyFileHandler.getDeviceModelFromProperties(device),
					BroadBandTestConstants.SEMI_COLON, BroadBandTraceConstants.LOG_MESSAGE_END_POINT, hostAddress,
			...
			/**
			 * Step 12 : Validate TR181 parameter
			...
			/**
			 * Step 14 : Validate TR181 parameter
			...
			/**
			 * Step 15 : Validate if invalid url/host address is successfully set for TR181
			 * param Device.IP.Diagnostics.IPPing.Host
			 */
			stepNumber = "s15";
			status = false;
			...
			LOGGER.info("**********************************************************************************");
			/**
			 * The default invalid url configured in "stb.properties" for
			 * "pingtest.invalid.host.address" is : ww.invalidurl.c To ping other urls,
			 * please update the value of "pingtest.invalid.host.address" in
			 * "stb.properties"
			 */
			status = BroadBandWebPaUtils.setAndGetParameterValuesUsingWebPa(device, tapEnv,
					BroadBandWebPaConstants.WEBPA_PARAM_TO_SET_HOST_ADDRESS, BroadBandTestConstants.CONSTANT_0,
			...
			/**
			 * Step 16 : Trigger ping test by passing invalid url or host address and
			 * Validate TR181 parameter Device.IP.Diagnostics.IPPing.DiagnosticsState.
			 */
			stepNumber = "s16";
			status = false;
			...
			/**
			 * Step 17 : Validating TDMlog.txt.0 log file for invalid url/host address ping
			 * test.
			 */
			stepNumber = "s17";
			status = false;
