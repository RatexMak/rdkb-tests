...
public class BroadBandPartnerIdTests extends AutomaticsTestBase {
	/**
	 * 
	 * Test Case # 1: Verify the Partner Id parameter in any query to XCONF - CDL,
	 * DCM, and RFC.
	 *
	 * <p>
	 * STEPS:
	 ...
	 * <li>POST-CONDITION 1. Remove Xconf url from swupdate conf file that is
	 * configured in precondition 1
	 * </ol>
	 *
	 * @author BALAJI V
	 *
