...
public class BroadBandArmConsoleAccessTest extends AutomaticsTestBase {
     ...
     * <li>4. Verify binary module uptime using BusyBox and uptime was executable</li>
	...
	boolean status = false;
	String response = null;
	String tmpPath = CommonUtils.concatStringUsingStringBuffer(BroadBandTestConstants.SLASH_SYMBOL, BroadBandTestConstants.FOLDER_TMP,
		BroadBandTestConstants.SLASH_SYMBOL);
