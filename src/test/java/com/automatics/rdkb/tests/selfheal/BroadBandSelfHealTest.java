...
public class BroadBandSelfHealTest extends AutomaticsTestBase {
     ...
     * <li>10. Update selfheal aggressive interval with negative value -1 using webpa</li>
     ...
     * 
     * <ol>
     * <li>Step 1: Verify default Self heal enabled status using SNMP MIB ".1.3.6.1.4.1.17270.44.1.1.1.0"</li>
     * <li>Step 2: Verify default numPingsPerServer value for self heal using SNMP mib
     * ".1.3.6.1.4.1.17270.44.1.1.2.0"</li>
     * <li>Step 3: Verify default minNumPingServer value for self heal using SNMP mib
     * ".1.3.6.1.4.1.17270.44.1.1.3.0"</li>
     * <li>Step 4: Verify default pingInterval value for self heal using SNMP mib ".1.3.6.1.4.1.17270.44.1.1.4.0"</li>
     * <li>Step 5: Verify default resourceUsageComputeWindow value for self heal using SNMP mib
     ...
     * <li>Step 7: Verify default avgMemoryThreshold value for self heal using SNMP mib
     ...
     * <li>Step 9: Verify default maxSubsystemResetCount value for self heal using SNMP mib
     * ".1.3.6.1.4.1.17270.44.1.1.11.0"</li>
     * <li>Step 10: Configure the maxSubsystemResetCount to any value other than default using SNMP MIB
     * (.1.3.6.1.4.1.17270.44.1.1.11.0)"</li>
     * <li>Step 11: Verify updated maxSubsytemResetCount using SNMP MIB ( .1.3.6.1.4.1.17270.44.1.1.11.0)"</li>
     * <li>Step 12: Verify updated maxSubsytemResetCount using WebPA param
     * "Device.SelfHeal.X_RDKCENTRAL-COM_MaxResetCount"</li>
     * <li>Step 13: Reboot the device and verify whether device comes up properly"</li>
	...
	try {
	    ...
	    LOGGER.info(
		    "STEP 10:ACTION: Execute command snmpset using OID .1.3.6.1.4.1.17270.44.1.1.11.0 i 10");
    ...
    /**
     * Test to Validate if the cron scheduling on ATOM side whether it is having LogUploadFrequency value _TR181
     *
     * <ol>
     * <p>
     ...
     * <li>Verify device compares current and previous wan status to determine reboot needed</li>
    ...
    /**
     * Test to verify Critical process recovery for brlan0, brlan1, erouter0, peer ping, DHCPv4client, DHCPv6client,
     * dnsmasq, Zombie process, dibbler
     * 
     * <li>1. Configure Aggressive selfheal & base selfheal interval as 2 & 3 min using Webpa</li>
     * <li>2. Verify Aggressive selfheal interval is configured as 2 min using webpa</li>
     * <li>3. Verify non-critical selfheal interval is 3 min using webpa</li>
     * <li>4. Verify selfhealAggressive file present in device & updated interval in log file</li>
     * <li>5. Make the brlan0 interface down and verify log in SelfHealAggressive file</li>
     * <li>6. Verify brlan0 is not completely up status in SelfHeal file</li>
     * <li>7. Make the brlan1 interface down and verify log in SelfHealAggressive file</li>
     * <li>8. Verify brlan1 is not completely up status in SelfHeal file</li>
     * <li>9. Verify dnsmasq process not running log message in SelfHealAggressive file</li>
     * <li>10. Verify dnsmasq process not running log message in base SelfHeal file</li>
     * <li>11. Verify dibbler is not running log message in SelfHealAggressive file</li>
     * <li>12. Verify dibbler is not running status in SelfHeal file</li>
     * <li>13. Trigger and verify dnsmasq zombie process in SelfHealAggressive file</li>
     ...
     * <li>17. Make the erouter0 interface down and verify log in SelfHealAggressive file</li>
     * <li>18. Verify erouter0 is DOWN status in SelfHeal file</li>
     * <li>19. Trigger and verify DHCPv4client not running status in SelfHealAggressive file</li>
     * <li>20. Verify DHCPv4client not running status in SelfHeal file</li>
     * <li>21. Trigger and verify DHCPv6client not running status in SelfHealAggressive file</li>
