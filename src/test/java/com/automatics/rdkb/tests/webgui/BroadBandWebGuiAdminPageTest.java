...
public class BroadBandWebGuiAdminPageTest extends BroadBandWifiBaseTest {
    ...
    /**
     *
     * Test Case : Verify Login into admin page using default password and Verify Default values in Firewall IPV4, IPV6
     * and Managed Devices Pages.
     * <p>
     * STEPS:
     * </p>
     * <ol>
     ...
     * <li>Step 1 : Connect the client setup to 2.4/5 GHZ SSID and verify connection status</li>
     ...
     * <li>Step 4 : Verify the internet connectivity in the connected wifi client using ipv4 interface</li>
     * <li>Step 5 : Verify the internet connectivity in the connected wifi client using ipv6 interface.</li>
     * <li>Step 6 : Verify login into the lan gui adimn page by using valid userid and default password</li>
     * <li>Step 7 : Verify login into the lan gui adimn page by using valid userid and valid password</li>
     * <li>Step 8 : Launch the IPv4 Firewall page from partner page</li>
     * <li>Step 9 : Verify the Default IPv4 firewall mode is set to Minimum Security (Low)</li>
     * <li>Step 10 : Launch the IPv6 FireWall page from partner page</li>
     * <li>Step 11 : Verify the Default IPv6 firewall mode is set to Typical Security (default)</li>
     * <li>Step 12 : Launch the Managed Devices under Parental Control page from partner page</li>
	...
	try {
	    ...
	    /**
	     * STEP 4 : VERIFY THE INTERNET CONNECTIVITY IN THE CLIENT WITH GIVEN GHZ SSID INTERFACE USING IPV4 .
	     */
	    stepNumber++;
	    stepNum = "S" + stepNumber;
	    status = false;
	    ...
	    /**
	     * STEP 5 : VERIFY THE INTERNET CONNECTIVITY IN THE CLIENT WITH GIVEN GHZ SSID INTERFACE USING IPV6 .
	     */
	    stepNumber++;
	    stepNum = "S" + stepNumber;
	    status = false;
	    ...
	    /**
	     * Step 6 : VERIFY LOGIN INTO THE LAN GUI ADIMN PAGE BY USING VALID USERID AND DEFAULT PASSWORD
	     */
	    stepNumber++;
	    stepNum = "S" + stepNumber;
	    status = false;
	    ...
	    /**
	     * Step 7 : VERIFY LOGIN INTO THE LAN GUI ADIMN PAGE BY USING VALID USERID AND VALID PASSWORD
	     */
	    stepNumber++;
	    stepNum = "S" + stepNumber;
	    status = false;
	    ...
	    /**
	     * Step 9 : Verify the Default IPv4 firewall mode is set to Minimum Security (Low)
	     */
	    stepNumber++;
	    stepNum = "S" + stepNumber;
	    status = false;
	    ...
	    /**
	     * Step 11 : Verify the Default IPv6 firewall mode is set to Typical Security (default)
	     */
	    stepNumber++;
	    stepNum = "S" + stepNumber;
	    status = false;
	    ...
	    /**
	     * Step 12 : Launch the Managed Devices under Parental Control page from partner page
	     */
	    stepNumber++;
	    stepNum = "S" + stepNumber;
	    status = false;
    ...
    /**
     *
     * Test Case : Verify the user admin page can be logged in using cusadmin credentials in the wired and wireless
     * connected clients and Validate negative Scenario in Admin GUI Login
     *
     * <p>
     * STEPS:
     * </p>
     ...
     * <li>PRE-CONDITION 3 : Verify the private wifi 2.4 GHz and 5 GHz ssid's are broadcasting in connected client.</li>
     * <li>Step 1 : Connect the client to 2.4 GHz Private Wi-Fi Network and verify connection status</li>
     ...
     * with 2.4 GHz</li>
     * <li>Step 7 : Verify the gateway admin page is accessible in 2.4 GHz Wi-Fi connected client and Try Entering
     * Username as "admin" and Password : (a Wrong Password)</li>
     * <li>Step 8 : Verify the gateway admin page is accessible in 2.4 GHz Wi-Fi connected client and Try Entering
     * Username as "admin" and Password : ""(Empty Password)</li>
     * <li>Step 9 : Verify the gateway admin page is accessible in 2.4 GHz Wi-Fi connected client and can be logged in
     * using admin/password credentials for Residential and cusadmin/highspeed for Commercial devices</li>
     * <li>Step 10 : Verify disconnecting the 2.4 GHz SSID</li>
     * <li>Step 11 : Connect the client to 5 GHz Private Wi-Fi Network and verify connection status</li>
     ...
     * with 5 GHz</li>
     * <li>Step 17 : Verify the gateway admin page is accessible in 5 GHz Wi-Fi connected client and Try Entering
     * Username as "admin" and Password : (a Wrong Password)</li>
     * <li>Step 18 : Verify the gateway admin page is accessible in 5 GHz Wi-Fi connected client and Try Entering
     * Username as "admin" and Password : ""(Empty Password)</li>
     * <li>Step 19 : Verify the gateway admin page is accessible in 5 GHz Wi-Fi connected client and can be logged in
     * using admin/password credentials for Residential and cusadmin/highspeed for Commercial devices</li>
     * <li>Step 20 : Verify disconnecting the 5 GHz SSID</li>
     * <li>Step 21 : verify the ethernet client is connected</li>
     * <li>Step 22 : Verify the IPv4 Address is retrieved from the client connected with Ethernet</li>
     * <li>Step 23 : Verify the IPv6 Address is retrieved from the client connected with Ethernet</li>
     * <li>Step 24 : Verify whether have connectivity using that particular interface using IPV4 for client connected
     * with ethernet</li>
     * <li>Step 25 : Verify whether have connectivity using that particular interface using IPV6 for client connected
     * with ethernet</li>
     * <li>Step 26 : Verify the gateway admin page is accessible in Ethernet connected client and Try Entering Username
     * as "admin" and Password : (a Wrong Password)</li>
     * <li>Step 27 : Verify the gateway admin page is accessible in Ethernet connected client and Try Entering Username
     * as "admin" and Password : ""(Empty Password)</li>
     * <li>Step 28 : Verify the gateway admin page is accessible in Ethernet connected client and can be logged in using
     * admin/password credentials for Residential and cusadmin/highspeed for Commercial devices</li>
	...
	try {
	    ...
	    LOGGER.info("################### COMPLETED PRE-CONFIGURATIONS ###################");
	    /**
	     * Step 1 : CONNECT THE CONNECTED CLIENT IN THE SETUP TO 2.4 GHz SSID AND VERIFY CONNECTION STATUS
	     */
	    ...
	    /**
	     * SETP 3-6 : VERIFY THE CORRECT IPV4 AND IPV6 ADDRESS FOR CLIENT CONNECTED WITH 2.4GHz AND INTERNET
	    ...
	    /**
	     * STEP 9 : VERIFY LOGIN INTO THE LAN GUI ADIMN PAGE BY USING USERID AND PASSWORD
	     */
	    stepNumber++;
	    ...
	    /**
	     * Step 11 : CONNECT THE CONNECTED CLIENT IN THE SETUP TO 5 GHz SSID AND VERIFY CONNECTION STATUS
	     */
	    stepNumber++;
	    BroadBandWiFiUtils.executeTestStepToConnectPrivateWiFi(device, testCaseId, ssidVisibleDeviceOne,
	    ...
	    /**
	     * SETP 13-16 : VERIFY THE CORRECT IPV4 AND IPV6 ADDRESS FOR CLIENT CONNECTED WITH 5 GHz AND INTERNET
	     * CONNECTIVITY USING IPV4 AND IPV6 INTERFACE.
	     */
	    stepNumber++;
	    BroadBandWiFiUtils.verifyIpv4AndIpV6ConnectionInterface(device, testCaseId, ssidVisibleDeviceOne,
	    ...
	    /**
	     * STEP 19 : VERIFY LOGIN INTO THE LAN GUI ADIMN PAGE BY USING USERID AND PASSWORD
	     */
	    stepNumber++;
	    isLoggedIn = LanSidePageNavigation.executeTestStepToLoginLanAdminWebGui(device, tapEnv,
		    ssidVisibleDeviceOne, testCaseId, stepNumber);
	    ...
	    /**
	     * SETP 22-25 : VERIFY THE CORRECT IPV4 AND IPV6 ADDRESS FOR CLIENT CONNECTED WITH ETHERNET AND INTERNET
	     * CONNECTIVITY USING IPV4 AND IPV6 INTERFACE.
	     */
	    stepNumber++;
	    ...
	    /**
	     * STEP 28 : VERIFY LOGIN INTO THE LAN GUI ADIMN PAGE BY USING USERID AND PASSWORD
	     */
	    stepNumber++;
	    isLoggedIn = LanSidePageNavigation.executeTestStepToLoginLanAdminWebGui(device, tapEnv,
     ...
     * <li>PRE-CONDITION 7 : Verify partner Id is Comcast,If not change it to comcast</li>
     ...
     * <li>Step 5 : Verify the gateway admin page is accessible in connected client and can be logged in using
     * admin/****** credential for residential or cusadmin/****** credential for commercial devices</li>
     * <li>Step 6 : Navigate to the GATEWAY > CONNECTIONS > LOCAL IP CONFIGURATION Page and verify navigation
     * status</li>
     * <li>Step 7 : Verify Retrieving the Subnet Mask value from the LanUI page and cross verify with SNMP value
     * retrieved.</li>
     * <li>Step 8 : Verify Retrieving the DHCPV4 Beginning value from the LanUI page and cross verify with SNMP value
     * retrieved.</li>
     * <li>Step 9 : Verify Retrieving the DHCPV4 Ending value from the LanUI page and cross verify with SNMP value
     * retrieved.</li>
     * <li>Step 10 : Verify Retrieving the DHCPV4 Lease Time value from the LanUI page and cross verify with SNMP value
     * retrieved.</li>
     * <li>Step 11 : Verify the correct ipv4 address for connected client device</li>
     * <li>Step 12 : Verify the internet connectivity in the client connected using IPV4</li>
     * <li>POST-CONDITION 1 : Verify lan side browser closed</li>
	...
	try {
	    ...
	    /**
	     * Step 5 : VERIFY LOGIN INTO THE LAN GUI ADIMN PAGE BY USING VALID USERID AND VALID PASSWORD
	     */
	    stepNumber++;
	    stepNum = "S" + stepNumber;
	    status = false;
	    ...
	    /**
	     * Step 8 : GET AND VERIFY THE DHCP IPV4 BEGINING ADDRESS IN LOCAL IP CONFIGURATION PAGE
	     */
	    stepNumber++;
	    stepNum = "S" + stepNumber;
	    status = false;
	    ...
	    /**
	     * Step 9 : GET AND VERIFY THE DHCP IPV4 ENDING ADDRESS IN LOCAL IP CONFIGURATION PAGE
	     */
	    stepNumber++;
	    stepNum = "S" + stepNumber;
	    status = false;
	    ...
	    /**
	     * Step 10 : GET AND VERIFY THE DHCP IPV4 LEASE TIME IN LOCAL IP CONFIGURATION PAGE
	     */
	    stepNumber++;
	    stepNum = "S" + stepNumber;
	    status = false;
    ...
    /**
     *
     * Test Case : Verify the configuration of Transmission Control Rate for 5Ghz(n) Radio after reboot.
     * 
     * <p>
     * STEPS:
     * </p>
     ...
     * <li>Step 1 : Verify login into the LAN GUI Adimn page by using valid userid and valid password</li>
     * <li>Step 2 : Navigate to the Gateway>Connection>WIFI and verify Navigation Status</li>
     * <li>Step 3 : Navigate to the Gateway>Connection>WIFI >Edit 5 Ghz and verify Navigation Status</li>
     * <li>Step 4 : Set the operation standard mode as n in LAN GUI Adimn page</li>
     * <li>Step 5 : Verify the value of operational transmission rate of the 5 GHz with operating standard as n using
     * webpa</li>
     * <li>Step 6 : Verify the value of Basic data transmission rates of the 5GHz with operating standard as n using
     * webpa</li>
     * <li>Step 7 : Verify the value of Supported data transmission rates of the 5GHz with operating standard as n using
     * webpa</li>
     * <li>Step 8 : Verify the value of Operational data transmission Rates of the 5GHz with operating standard as n
     * using webpa</li>
     * <li>Step 9 : Navigate to the Troubleshooting>Reset/Restore Gateway page and verify Navigation Status</li>
     * <li>Step 10 : Reset the device through LAN GUI Adimn page.</li>
     * <li>Step 11 : Verify the value of operational transmission rate of the 5GHz with operating standard as n after
     * reboot using webpa</li>
     * <li>Step 12 : Verify the value of Basic data transmission rates of the 5GHz with operating standard as n after
     * reboot with the value of step 6</li>
     * <li>Step 13 : Verify the value of Supported data transmission rates of the 5GHz with operating standard as n
     * after reboot with the value of step 7</li>
     * <li>Step 14 : Verify the value of Operational data transmission Rates of the 5GHz with operating standard as n
     * after reboot with the value of step 8</li>
	...
	try {
	    ...
	    /**
	     * Step 1 : VERIFY LOGIN INTO THE LAN GUI ADIMN PAGE BY USING VALID USERID AND VALID PASSWORD
	     */
	    stepNum = "S" + stepNumber;
	    status = false;
	    errorMessage = null;
	    ...
	    /**
	     * Step 2 : NAVIGATE TO THE GATEWAY > CONNECTION > WI-FI PAGE AND VERIFY NAVIGATION STATUS
	     */
	    stepNumber++;
	    stepNum = "S" + stepNumber;
	    status = false;
	    ...
	    /**
	     * Step 3-4 : NAVIGATE TO THE GATEWAY > CONNECTION > WI-FI > EDIT 5 GHZ PAGE AND SET THE OPERATION STANDARD
	     * MODE AS n IN LAN GUI ADMIN PAGE.
	     */
	    stepNumber++;
	    ...
	    /**
	     * Step 5 : VERIFY THE VALUE OF OPERATIONAL TRANSMISSION RATE OF 5 GHZ WITH OPERATIONAL STANDARD AS n USING
	     * WEBPA.
	     */
	    stepNumber = 5;
	    ...
	    /**
	     * Step 6 : VERIFY THE VALUE OF BASIC DATA TRANSMISSION RATES OF 5 GHZ WITH OPERATIONAL STANDARD AS n USING
	     * WEBPA.
	     */
	    stepNumber++;
	    ...
	    /**
	     * Step 7 : VERIFY THE VALUE OF SUPPORTED DATA TRANSMISSION RATES OF 5 GHZ WITH OPERATIONAL STANDARD AS n
	     * USING WEBPA.
	     */
	    stepNumber++;
	    ...
	    /**
	     * Step 8 : VERIFY THE VALUE OF OPERATIONAL DATA TRANSMISSION RATES OF 5 GHZ WITH OPERATIONAL STANDARD AS n
	     * USING WEBPA.
	     */
	    stepNumber++;
	    ...
	    /**
	     * Step 11 : VERIFY THE VALUE OF OPERATIONAL TRANSMISSION RATE OF 5 GHZ WITH OPERATIONAL STANDARD AS n AFTER
	     * REBOOT USING WEBPA.
	     */
	    stepNumber = 11;
	    executeTestStepToVerifyOperatingStandard(device, testCaseId, BroadBandTestConstants.BAND_5GHZ, stepNumber,
	    ...
	    /**
	     * Step 12 : VERIFY THE VALUE OF BASIC DATA TRANSMISSION RATES OF 5 GHZ WITH OPERATIONAL STANDARD AS n AFTER
	     * REBOOT WITH THE VALUE OF STEP 6.
	     */
	    stepNumber++;
	    ...
	    /**
	     * Step 13 : VERIFY THE VALUE OF SUPPORTED DATA TRANSMISSION RATES OF 5 GHZ WITH OPERATIONAL STANDARD AS n
	     * AFTER REBOOT WITH THE VALUE OF STEP 7.
	     */
	    stepNumber++;
	    ...
	    /**
	     * Step 14 : VERIFY THE VALUE OF OPERATIONAL DATA TRANSMISSION RATES OF 5 GHZ WITH OPERATIONAL STANDARD AS n
	     * AFTER REBOOT WITH THE VALUE OF STEP 8.
	     */
	    stepNumber++;
     ...
     *            Instance of{@link LanSidePageNavigation}
     * @param operStd
     *            Operating standard value for 2.4/5 GHz
     * @param broadBandCommonPage
     *            Instance of{@link BroadBandCommonPage}
     * 
     * @Refactor Sruthi Santhosh
     *
     */
	...
	/**
	 * Step : NAVIGATE TO THE GATEWAY > CONNECTION > WI-FI > EDIT 2.4/5 GHZ PAGE AND VERIFY NAVIGATION STATUS
	 */
	stepNum = "S" + stepNumber;
	status = false;
	errorMessage = null;
	...
	String operStdWepParam = wifiBand.equalsIgnoreCase(BroadBandTestConstants.BAND_2_4GHZ)
		...
		: BroadBandWebPaConstants.WEBPA_PARAM_DEVICE_WIFI_RADIO_5GHZ_OPERATING_STANDARD;
	/**
	 * Step : VERIFY THE VALUE OF OPERATIONAL TRANSMISSION RATE OF 2.4/5 GHZ USING WEBPA.
	 */
	stepNum = "S" + stepNumber;
	status = false;
	errorMessage = null;
    ...
    /**
     * Test method used to validate the basic data transmission rates for 2.4 and 5 GHz
     * 
     * @param device
     *            Instance of{@link Dut}
     * @param testCaseId
	...
	/**
	 * Step : VERIFY THE VALUE OF BASIC DATA TRANSMISSION RATES OF 2.4/5 GHZ USING WEBPA.
	 */
	stepNum = "S" + stepNumber;
	status = false;
	errorMessage = null;
    ...
    /**
     * Test method used to validate the supported data transmission rates for 2.4 and 5 GHz
     * 
     * @param device
     *            Instance of{@link Dut}
     * @param testCaseId
	...
	/**
	 * Step : VERIFY THE VALUE OF SUPPORTED DATA TRANSMISSION RATES OF 2.4/5 GHZ USING WEBPA.
	 */
	stepNum = "S" + stepNumber;
	status = false;
	errorMessage = null;
    ...
    /**
     * Test method used to validate the operational data transmission rates for 2.4 and 5 GHz
     * 
     * @param device
     *            Instance of{@link Dut}
     * @param testCaseId
	...
	String errorMessage = null;
	/**
	 * Step : NAVIGATE TO THE TROUBLESHOOTING > RESET/RESTORE GATEWAY PAGE AND VERIFY NAVIGATION STATUS.
	 */
	stepNum = "S" + stepNumber;
	status = false;
	errorMessage = null;
    ...
    /**
     * Test method used to validate the basic data transmission rates for 2.4 and 5 GHz after reboot
     * 
     * @param device
     *            Instance of{@link Dut}
     * @param testCaseId
     ...
     * @param driver
     *            Instance of{@link WebDriver}
     * @param basicDataTransmission
     *            Basic Data Transmission Rates before Reboot
     * 
     * @Refactor Sruthi Santhosh
     */
    ...
    /**
     * Test method used to validate the supported data transmission rates for 2.4 and 5 GHz after reboot
     * 
     * @param device
     *            Instance of{@link Dut}
     * @param testCaseId
     ...
     * @param driver
     *            Instance of{@link WebDriver}
     * @param supportedDataTransmission
     *            Supported Data Transmission Rates before Reboot
     * @Refactor Sruthi Santhosh
     */
	...
	String operStdWepParam = wifiBand.equalsIgnoreCase(BroadBandTestConstants.BAND_2_4GHZ)
		...
		: BroadBandWebPaConstants.WEBPA_PARAM_5_SUPPORTED_DATA_TRANSMIT_TX_RATES;
	/**
	 * Step : VERIFY THE VALUE OF SUPPORTED DATA TRANSMISSION RATES OF 2.4/5 GHZ AFTER REBOOT USING WEBPA.
	 */
	stepNum = "S" + stepNumber;
	status = false;
	errorMessage = null;
    ...
    /**
     * Test method used to validate the operational data transmission rates for 2.4 and 5 GHz after reboot
     * 
     * @param device
     *            Instance of{@link Dut}
     * @param testCaseId
     ...
     * @param driver
     *            Instance of{@link WebDriver}
     * @param oparationalDataTransmission
     *            Operational Data Transmission Rates before Reboot
     * @Refactor Sruthi Santhosh
     */
    ...
    /**
     *
     * Test Case : Verify the configuration of Transmission Control Rate for 5Ghz(a,n,ac) Radio after reboot.
     * 
     * <p>
     * STEPS:
     * </p>
     ...
     * <li>Step 2 : Navigate to the Gateway>Connection>WIFI and verify Navigation Status</li>
     * <li>Step 3 : Navigate to the Gateway>Connection>WIFI >Edit 5 Ghz and verify Navigation Status</li>
     * <li>Step 4 : Set the operation standard mode as a/n/ac in LAN GUI Adimn page</li>
     * <li>Step 5 : Verify the value of operational transmission rate of the 5 GHz with operating standard as a/n/ac
     * using webpa</li>
     * <li>Step 6 : Verify the value of Basic data transmission rates of the 5GHz with operating standard as a/n/ac
     * using webpa</li>
     * <li>Step 7 : Verify the value of Supported data transmission rates of the 5GHz with operating standard as a/n/ac
     * using webpa</li>
     * <li>Step 8 : Verify the value of Operational data transmission Rates of the 5GHz with operating standard as
     * a/n/ac using webpa</li>
     * <li>Step 9 : Navigate to the Troubleshooting>Reset/Restore Gateway page and verify Navigation Status</li>
     * <li>Step 10 : Reset the device through LAN GUI Adimn page.</li>
     * <li>Step 11 : Verify the value of operational transmission rate of the 5GHz with operating standard as a/n/ac
     * after reboot using webpa</li>
     * <li>Step 12 : Verify the value of Basic data transmission rates of the 5GHz with operating standard as a/n/ac
     * after reboot with the value of step 6</li>
     * <li>Step 13 : Verify the value of Supported data transmission rates of the 5GHz with operating standard as a/n/ac
     * after reboot with the value of step 7</li>
     * <li>Step 14 : Verify the value of Operational data transmission Rates of the 5GHz with operating standard as
     * a/n/ac after * reboot with the value of step 8</li>
     * <li>POST-CONDITION 1 : Close the browser</li>
     * <li>POST-CONDITION 2 : Set the default operating standards</li>
     * </ol>
     * 
	...
	try {
	    ...
	    /**
	     * Step 3-4 : NAVIGATE TO THE GATEWAY > CONNECTION > WI-FI > EDIT 5 GHZ PAGE AND SET THE OPERATION STANDARD
	     * MODE AS a/n/ac IN LAN GUI ADMIN PAGE.
	     */
	    stepNumber++;
	    executeTestStepToSetOperatingStandard(device, testCaseId, BroadBandTestConstants.BAND_5GHZ, stepNumber,
	    ...
	    /**
	     * Step 5 : VERIFY THE VALUE OF OPERATIONAL TRANSMISSION RATE OF 5 GHZ WITH OPERATIONAL STANDARD AS a/n/ac
	     * USING WEBPA.
	     */
	    stepNumber = 5;
	    executeTestStepToVerifyOperatingStandard(device, testCaseId, BroadBandTestConstants.BAND_5GHZ, stepNumber,
	    ...
	    /**
	     * Step 6 : VERIFY THE VALUE OF BASIC DATA TRANSMISSION RATES OF 5 GHZ WITH OPERATIONAL STANDARD AS a/n/ac
	     * USING WEBPA.
	     */
	    stepNumber++;
	    basicDataTransmission5ghz = executeTestStepToVerifyBasicDataTxRates(device, testCaseId,
	    ...
	    /**
	     * Step 7 : VERIFY THE VALUE OF SUPPORTED DATA TRANSMISSION RATES OF 5 GHZ WITH OPERATIONAL STANDARD AS
	     * a/n/ac USING WEBPA.
	     */
	    stepNumber++;
	    supportedDataTransmission5ghz = executeTestStepToVerifySupportedDataTxRates(device, testCaseId,
	    ...
	    /**
	     * Step 8 : VERIFY THE VALUE OF OPERATIONAL DATA TRANSMISSION RATES OF 5 GHZ WITH OPERATIONAL STANDARD AS
	     * a/n/ac USING WEBPA.
	     */
	    stepNumber++;
	    oparationalDataTransmission5ghz = executeTestStepToVerifyOperationalDataTxRates(device, testCaseId,
	    ...
	    /**
	     * Step 11 : VERIFY THE VALUE OF OPERATIONAL TRANSMISSION RATE OF 5 GHZ WITH OPERATIONAL STANDARD AS a/n/ac
	    ...
	    /**
	     * Step 12 : VERIFY THE VALUE OF BASIC DATA TRANSMISSION RATES OF 5 GHZ WITH OPERATIONAL STANDARD AS a/n/ac
	     * AFTER REBOOT WITH THE VALUE OF STEP 6.
	     */
	    stepNumber++;
	    executeTestStepToVerifyBasicDataTxRatesAfterReboot(device, testCaseId, BroadBandTestConstants.BAND_5GHZ,
	    ...
	    /**
	     * Step 13 : VERIFY THE VALUE OF SUPPORTED DATA TRANSMISSION RATES OF 5 GHZ WITH OPERATIONAL STANDARD AS
	     * a/n/ac AFTER REBOOT WITH THE VALUE OF STEP 7.
	     */
	    stepNumber++;
	    executeTestStepToVerifySupportedDataTxRatesAfterReboot(device, testCaseId, BroadBandTestConstants.BAND_5GHZ,
	    ...
	    /**
	     * Step 14 : VERIFY THE VALUE OF OPERATIONAL DATA TRANSMISSION RATES OF 5 GHZ WITH OPERATIONAL STANDARD AS
	     * a/n/ac AFTER REBOOT WITH THE VALUE OF STEP 8.
	     */
	    stepNumber++;
	    executeTestStepToVerifyOperationalDataTxRatesAfterReboot(device, testCaseId,
		    BroadBandTestConstants.BAND_5GHZ, stepNumber, BroadBandTestConstants.OPERATING_STANDARDS_A_N_AC,
     ...
     * @param device
     *            {@link Dut}
     * @param defaultDchpIpv4ValuesMap
     *            Its used to get the key and pair value for default dhcp v4 values
     * @return postCondStatus True ,IF all default values are set successfully. Else False
     * 
     * @Refactor Sruthi Santhosh
     */
    ...
    /**
     *
     * Test Case : Verify Admin GUI login and verify all pages are accessible in Firefox Browser for 2.4 GHz wifi
     *
     * <p>
     * STEPS:
     * </p>
     ...
     * <li>Step 2: Navigate to the Gateway > At a Glance page and verify navigation status</li>
     * <li>Step 3: Navigate to the Gateway > Connection > Status page and verify navigation status</li>
     * <li>Step 4: Navigate to the Gateway> Connection> PARTNER Network page (Residential) OR Gateway> Connection>
     * Partner Network page(Commercial) and verify Navigation Status</li>
     * <li>Step 5: Navigate to the Gateway > Connection > Local IP Configuration page and verify navigation status</li>
     * <li>Step 6: Navigate to the Gateway > Connection > Wi-Fi page and verify navigation status</li>
     * <li>Step 7: Navigate to the Gateway > Connection > MoCA page and verify navigation status</li>
     * <li>Step 8 : Navigate to the Gateway > Firewall > IPv4 page and verify navigation status</li>
     * <li>Step 9 : Navigate to the Gateway > Firewall > IPv6 page and verify navigation status</li>
     * <li>Step 10 : Navigate to the Gateway > Software page and verify navigation status</li>
     * <li>Step 11 : Navigate to the Gateway > Hardware > System Hardware page</li>
     * <li>Step 12 : Navigate to the Gateway > Hardware > LAN Ethernet page and verify navigation status</li>
     * <li>Step 13 : Navigate to the Gateway > Hardware > Wireless page and verify navigation status</li>
     * <li>Step 14 : Navigate to the Connected Devices > Devices page and verify navigation status</li>
     * <li>Step 15 : Navigate to the Parental Control > Managed Sites page and verify navigation status</li>
     * <li>Step 16 : Navigate to the Parental Control > Managed Services page and verify navigation status</li>
     * <li>Step 17 : Navigate to the Parental Control > Managed Devices page and verify navigation status</li>
     * <li>Step 18 : Navigate to the Parental Control > Reports page and verify navigation status</li>
     * <li>Step 19 : Navigate to the Advanced > Port Forwarding page and verify navigation status</li>
     * <li>Step 20 : Navigate to the Advanced > Port Triggering page and verify navigation status</li>
     * <li>Step 21 : Navigate to the Advanced > Remote Management page and verify navigation status</li>
     * <li>Step 22 : Navigate to the Advanced > DMZ page and verify navigation status</li>
     * <li>Step 23 : Navigate to the Advanced > Device Discovery page and verify navigation status</li>
     * <li>Step 24 : Navigate to the Troubleshooting > Logs page and verify navigation status</li>
     * <li>Step 25 : Navigate to the Troubleshooting > Network Diagnostic Tools page and verify navigation status</li>
     * <li>Step 26 : Navigate to the Troubleshooting > Wi-Fi Spectrum Analyzer page and verify navigation status</li>
     * <li>Step 27 : Navigate to the Troubleshooting > MOCA Diagnostics page and verify navigation status</li>
     * <li>Step 28 : Navigate to the Troubleshooting > Reset/Restore Gateway page and verify navigation status</li>
     * <li>Step 29 : Navigate to the Troubleshooting > Change Password page and verify navigation status</li>
     * <li>POST-CONDITION 1 : Close the Browser LAN Client</li>
    ...
    /**
     *
     * Test Case : Verify Admin GUI login and verify all pages are accessible in Firefox Browser for 5GHz wifi
     *
     * <p>
     * STEPS:
     * </p>
     * <ol>
     * <li>PRE-CONDITION 1 : Connect the client setup to 5 GHz SSID and verify connection status</li>
     * <li>PRE-CONDITION 2 : Verify the correct IPv4 address for client connected with 5GHz SSID</li>
     * <li>PRE-CONDITION 3 : Verify the correct IPv6 address for client connected with 5 GHz SSID</li>
     * <li>PRE-CONDITION 4 : Verify the internet connectivity in the connected 5GHz Wi-Fi client using ipv4 interface
     * </li>
     * <li>PRE-CONDITION 5 : Verify the internet connectivity in the connected 5GHz Wi-Fi client using ipv6 interface
     * </li>
     * <li>Step 1: Verify login into the LAN GUI Admin page by using valid userid and valid password</li>
     * <li>Step 2: Navigate to the Gateway > At a Glance page and verify navigation status</li>
     * <li>Step 3: Navigate to the Gateway > Connection > Status page and verify navigation status</li>
	...
	/**
	 * Step 2 : NAVIGATE TO THE GATEWAY > AT A GLANCE PAGE AND VERIFY NAVIGATION STATUS
	 */
	stepNumber++;
	stepNum = "S" + stepNumber;
	status = false;
	...
	/**
	 * Step 3 : NAVIGATE TO THE GATEWAY > CONNECTION > STATUS PAGE AND VERIFY NAVIGATION STATUS
	 */
	stepNumber++;
	stepNum = "S" + stepNumber;
	status = false;
	...
	BroadBandWebUiUtils.updateExecutionStatusForWebGuiStep(driver, tapEnv, device, testCaseId, stepNum, status,
		errorMessage, false);
	/**
	 * Step 4 : NAVIGATE TO THE GATEWAY > CONNECTION > PARTNER NETWORK PAGE FOR RESIDENTIAL OR GATEWAY > CONNECTION
	 * > PARTNER NETWORK PAGE FOR COMMERCIAL DEVICES AND VERIFY NAVIGATION STATUS
	 */
	stepNumber++;
	stepNum = "S" + stepNumber;
	status = false;
	...
	/**
	 * Step 5 : NAVIGATE TO THE GATEWAY > CONNECTION > LOCAL IP CONFIGURATION PAGE AND VERIFY NAVIGATION STATUS
	 */
	stepNumber++;
	stepNum = "S" + stepNumber;
	status = false;
	...
	/**
	 * Step 6 : NAVIGATE TO THE GATEWAY > CONNECTION > WI-FI PAGE AND VERIFY NAVIGATION STATUS
	 */
	stepNumber++;
	stepNum = "S" + stepNumber;
	status = false;
	...
	/**
	 * Step 7 : NAVIGATE TO THE GATEWAY > CONNECTION > MOCA PAGE AND VERIFY NAVIGATION STATUS
	 */
	stepNumber++;
	stepNum = "S" + stepNumber;
	status = false;
	...
	/**
	 * Step 8 : NAVIGATE TO THE GATEWAY > FIREWALL > IPV4 PAGE AND VERIFY NAVIGATION STATUS
	 */
	stepNumber++;
	stepNum = "S" + stepNumber;
	status = false;
	...
	//
	/**
	 * Step 9 : NAVIGATE TO THE GATEWAY > FIREWALL > IPV6 PAGE AND VERIFY NAVIGATION STATUS
	 */
	stepNumber++;
	stepNum = "S" + stepNumber;
	status = false;
	...
	/**
	 * Step 10 : NAVIGATE TO THE GATEWAY > SOFTWARE PAGE AND VERIFY NAVIGATION STATUS
	 */
	stepNumber++;
	stepNum = "S" + stepNumber;
	status = false;
	...
	/**
	 * Step 11 : NAVIGATE TO THE GATEWAY > HARDWARE > SYSTEM HARDWARE PAGE AND VERIFY NAVIGATION STATUS
	 */
	stepNumber++;
	stepNum = "S" + stepNumber;
	status = false;
	...
	/**
	 * Step 12 : NAVIGATE TO THE GATEWAY > HARDWARE > LAN ETHERNET PAGE AND VERIFY NAVIGATION STATUS
	 */
	stepNumber++;
	stepNum = "S" + stepNumber;
	status = false;
	...
	/**
	 * Step 13 : NAVIGATE TO THE GATEWAY > HARDWARE > WIRELESS PAGE AND VERIFY NAVIGATION STATUS
	 */
	stepNumber++;
	stepNum = "S" + stepNumber;
	status = false;
	...
	/**
	 * Step 14 : NAVIGATE TO THE CONNECTED DEVICES > DEVICES PAGE AND VERIFY NAVIGATION STATUS
	 */
	stepNumber++;
	stepNum = "S" + stepNumber;
	status = false;
	...
	/**
	 * Step 15 : NAVIGATE TO THE PARENTAL CONTROL > MANAGED SITES PAGE AND VERIFY NAVIGATION STATUS
	 */
	stepNumber++;
	stepNum = "S" + stepNumber;
	status = false;
	...
	/**
	 * Step 16 : NAVIGATE TO THE PARENTAL CONTROL > MANAGED SERVICES PAGE AND VERIFY NAVIGATION STATUS
	 */
	stepNumber++;
	stepNum = "S" + stepNumber;
	status = false;
	...
	/**
	 * Step 17 : NAVIGATE TO THE PARENTAL CONTROL > MANAGED DEVICES PAGE AND VERIFY NAVIGATION STATUS
	 */
	stepNumber++;
	stepNum = "S" + stepNumber;
	status = false;
	...
	/**
	 * Step 18 : NAVIGATE TO THE PARENTAL CONTROL > REPORTS PAGE AND VERIFY NAVIGATION STATUS
	 */
	stepNumber++;
	stepNum = "S" + stepNumber;
	status = false;
	...
	/**
	 * Step 19 : NAVIGATE TO THE ADVANCED > PORT FORWARDING PAGE AND VERIFY NAVIGATION STATUS
	 */
	stepNumber++;
	stepNum = "S" + stepNumber;
	status = false;
	...
	/**
	 * Step 20 : NAVIGATE TO THE ADVANCED > PORT TRIGGERING PAGE AND VERIFY NAVIGATION STATUS
	 */
	stepNumber++;
	stepNum = "S" + stepNumber;
	status = false;
	...
	/**
	 * Step 21 : NAVIGATE TO THE ADVANCED > REMOTE MANAGEMENT PAGE AND VERIFY NAVIGATION STATUS
	 */
	stepNumber++;
	stepNum = "S" + stepNumber;
	status = false;
	...
	/**
	 * Step 23 : NAVIGATE TO THE ADVANCED > DEVICE DISCOVERY PAGE AND VERIFY NAVIGATION STATUS
	 */
	stepNumber++;
	stepNum = "S" + stepNumber;
	status = false;
	...
	//
	/**
	 * Step 24 : NAVIGATE TO THE TROUBLESHOOTING > LOGS PAGE AND VERIFY NAVIGATION STATUS
	 */
	stepNumber++;
	stepNum = "S" + stepNumber;
	status = false;
	...
	/**
	 * Step 25 : NAVIGATE TO THE TROUBLESHOOTING > NETWORK DIAGNOSTIC TOOLS PAGE AND VERIFY NAVIGATION STATUS
	 */
	stepNumber++;
	stepNum = "S" + stepNumber;
	status = false;
	...
	/**
	 * Step 26 : NAVIGATE TO THE TROUBLESHOOTING > WI-FI SPECTRUM ANALYZER PAGE AND VERIFY NAVIGATION STATUS
	 */
	stepNumber++;
	stepNum = "S" + stepNumber;
	status = false;
	...
	/**
	 * Step 27 : NAVIGATE TO THE TROUBLESHOOTING > MOCA DIAGNOSTICS PAGE AND VERIFY NAVIGATION STATUS
	 */
	stepNumber++;
	stepNum = "S" + stepNumber;
	status = false;
	...
	/**
	 * Step 28 : NAVIGATE TO THE TROUBLESHOOTING > RESET / RESTORE GATEWAY PAGE AND VERIFY NAVIGATION STATUS
	 */
	stepNumber++;
	stepNum = "S" + stepNumber;
	status = false;
	...
	/**
	 * Step 29 : NAVIGATE TO THE TROUBLESHOOTING > CHANGE PASSWORD PAGE AND VERIFY NAVIGATION STATUS
	 */
	stepNumber++;
	stepNum = "S" + stepNumber;
	status = false;
