...
/**
 * Test class for validating the removal of support of CUSADMIN login for Residential devices
 * 
 * @author BALAJI V
 * @refactor Rakesh C N
 */
...
public class BroadBandWebGuiCusadminTest extends BroadBandWifiBaseTest {
     ...
     * <li>Pre-Condition 2: Verify the wireless client is connected and having private 2.4GHz or 5GHz WiFi Capability.
     * </li>
     ...
     * <li>Verify default password change prompt in LAN Admin GUI page.</li>
     * <li>Post-Condition 1: Verify opened browser is closed in connected client.</li>
    ...
    /**
     * Method to verify hash and default password for the test case TC-RDKB-PWD-MGMT-1001
     * 
     * @param device
     *            Dut instance
     * @param testCaseId
     *            TestCaseId
     * @param stepNumber
     *            step number of the test case id
     * @param passwordToVerify
     *            password to be verified.
     * @param isAfterFactoryReset
     *            true, to verify after factory reset
