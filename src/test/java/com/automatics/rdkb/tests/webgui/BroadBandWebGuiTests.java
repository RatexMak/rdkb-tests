...
public class BroadBandWebGuiTests extends AutomaticsTestBase {
	...
	/**
	 * Method to verify setting WiFi client ip as static ip and verify internet
	 * connectivity
	 * 
	 * <ol>
	 ...
	 * <li>Verify navigating to Connected Devices > Devices > Edit Device.</li>
	 * <li>Verify adding client ip as static ip.</li>
	 * <li>Verify the internet connectivity in the connected wifi client after
	 * setting client ip as static.</li>
	 * <li>Verify rebooting the device.</li>
	 * <li>Verify client ip is set as static ip or not.</li>
	 * </ol>
	...
	/**
	 *
	 * Test Case : Verify whether the CM can act as a DHCPv4 server for 2.4GHz Wi-Fi
	 * Client Scenario.
	 *
	 * <p>
	 * STEPS:
	 * </p>
	 * <ol>
	 * <li>PRE-CONDITION 1 : Obtain the Wi-Fi client 2.4 GHz associated with the
	 * gateway.</li>
	 * <li>PRE-CONDITION 2 : Verify the correct IPV4 address for the Wi-Fi
	 * client.</li>
	 * <li>PRE-CONDITION 3 : Verify the correct IPV6 address for the Wi-Fi
	 * client.</li>
	 * <li>PRE-CONDITION 4 : Verify the Internet Connectivity in the Connected Wi-Fi
	 * client using IPV4 interface.</li>
	 * <li>PRE-CONDITION 5 : Verify the Internet Connectivity in the Connected Wi-Fi
	 * client using IPV6 interface.</li>
	 * <li>PRE-CONDITION 6 : Get Default DHCP beginning address ,DHCP ending address
	 ...
	 * <li>Step 7: Verify and Retrieve the new DHCPv4 configuration for beginning
	 * and ending address is set using WEBPA.</li>
	 * <li>Step 8: Verify IPv4 is assigned on the Wi-Fi client</li>
	 * <li>Step 9: Verify the Internet Connectivity in the connected Wi-Fi client
	...
	/**
	 *
	 * Test Case : Verify whether the CM can act as a DHCPv4 server for 5GHz Wi-Fi
	 * Client Scenario.
	 *
	 * <p>
	 * STEPS:
	 * </p>
	 * <ol>
	 * <li>PRE-CONDITION 1 : Obtain the Wi-Fi client 5GHz associated with the
	 * gateway.</li>
	 * <li>PRE-CONDITION 2 : Verify the correct IPV4 address for the Wi-Fi
	 * client.</li>
	 * <li>PRE-CONDITION 3 : Verify the correct IPV6 address for the Wi-Fi
	...
	public void verifyDhcpV4ConfigurationChangesThroughWebGui(Dut device, String testCaseId, Dut deviceConnected) {
		 ...
		 * verifyIpv4AddressOFConnectedClientIsBetweenDhcpRange(tapEnv, device,
		 * deviceConnected);
		 */
	...
	/**
	 * Verify Internet access for clients after setting its assigned DHCP IP as
	 * reserved IP
	 * <ol>
	 * <li>Connect the client to Private Wi-Fi Network and verify connection
	 * status</li>
	 ...
	 * <li>Verify the internet is accessible in the client connected to the Private
	 * Wi-Fi Network</li>
	 * <li>Verify the Wi-Fi MAC address of connected client is retrieved
	 * successfully</li>
	 * <li>Connect the Ethernet client associated with the gateway and verify
	 * connection status</li>
	 * <li>Verify the Ethernet client connected has got the IPv4 Address between
	 * DHCP Range</li>
	 * <li>Verify the Ethernet client connected has got the IPv6 Address</li>
	 * <li>Verify the internet is accessible in the client connected to the Ethernet
	 * Client</li>
	 * <li>Verify the Ethernet MAC address of connected client is retrieved
	 * successfully</li>
	 * <li>Launch Broad band User Admin page login page and verify login status</li>
	 * <li>Launch the Connected Devices page from public wifi page</li>
	 * <li>Verify the Connected Client with Wifi Mac Address is Listed which is
	 * obtained in step5 and Click on Edit and Verify the Page Title as "Connected
	 * Devices >Devices>Edit Devices"</li>
	 * <li>Verify Selecting the Reserved IP Radio Button and verify client IPV4
	 * Obtained in step 2 should be populated in the Text Box and Click on Save
	 * Button.</li>
	 * <li>Verify the Connected Client with Ethernet Mac Address is Listed which is
	 * obtained in step10 and Click on Edit and Verify the Page Title as "Connected
	 * Devices >Devices>Edit Devices"</li>
	 * <li>Verify Selecting the Reserved IP Radio Button and verify client IPV4
	 * Obtained in step 7 should be populated in the Text Box and Click on Save
	 * Button.</li>
	 * <li>Verify the internet is accessible in the client connected to the Private
	 * Wi-Fi Network</li>
	 * <li>Verify the internet is accessible in the client connected to
	...
	public void testToSetReservedIpAndVerifyInternetAccess(Dut device) {
		...
		try {
			...
			if (isEthernetClientAvailable) {
				...
				LOGGER.info("STEP 10: ACTION : Get theEthernet MAC Address of the connected client from Inventory");
				LOGGER.info(
