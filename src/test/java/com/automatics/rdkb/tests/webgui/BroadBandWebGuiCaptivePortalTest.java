...
public class BroadBandWebGuiCaptivePortalTest extends AutomaticsTestBase {
    /**
    *
    * Test Case : Validate timestamp when SSID and Password changed in captive portal
    *
    * <p>
    * STEPS:
    * </p>
    ...
    * <li>Step 1 : Connect the client to Private Wi-Fi Network and verify connection status.</li>
    * <li>Step 2 : Verify LAN GUI admin page is redirected to captive portal page after factory reset.</li>
    * <li>Step 3 : Verify log information 'Enter_WiFi_Personalization_captive_mode' is available in ArmConsolelog.txt.0
    * log</li>
    * <li>Step 4 : Verify the private wifi 2.4 and 5 GHz ssid and password can be configured in captive portal page.
    * </li>
    * <li>Step 5 : Verify log information 'Exit_WiFi_Personalization_captive_mode' is available in ArmConsolelog.txt.0
    * log.</li>
    * <li>Step 6 : Verify log information 'SSID_name_changed' is available in WiFilog.txt.0 log</li>
    * <li>Step 7 : Connect the client to 2.4 GHz Private Wi-Fi Network and verify connection status.</li>
    ...
    * with 2.4 GHz.</li>
    * <li>Step 12 : Verify disconnecting the client connected with 2.4 GHz SSID in the setup.</li>
    * <li>Step 13 : Connect the connected client to 5 GHz Private Wi-Fi Network and verify connection status.</li>
    ...
    * with 5 GHz.</li>
    * <li>Step 18 : Verify disconnecting the client connected with 5 GHz SSID in the setup</li>
   ...
   public void testToVerifyTimestampForCaptivePortal(Dut device) {
	...
	try {
	    ...
	    /**
	     * Step 1 : CONNECT THE CLIENT TO PRIVATE WI-FI NETWORK AND VERIFY CONNECTION STATUS
	     * 
	     */
	    ...
	    /**
	     * STEP 2 : VERIFY LAN GUI ADMIN PAGE IS REDIRECTED TO CAPTIVE PORTAL PAGE AFTER FACTORY RESET.
	     */
	    stepNumber++;
	    stepNum = "S" + stepNumber;
	    status = false;
	    ...
	    /**
	     * SETP 3 : VERIFY LOG INFORMATION "ENTER_WIFI_PERSONALIZATION_CAPTIVE_MODE" IS AVAILABLE IN
	     * ARMCONSOLELOG.TXT.0
	     */
	    stepNumber++;
	    ...
	    /**
	     * STEP 4 : VERIFY THE PRIVATE WI-FI 2.4 AND 5 GHz SSID AND PASSWORD CAN BE CONFIGURED IN CAPTIVE PORTAL
	     * PAGE.
	     */
	    stepNumber++;
	    stepNum = "S" + stepNumber;
	    ...
	    /**
	     * SETP 5 : VERIFY LOG INFORMATION "EXIT_WIFI_PERSONALIZATION_CAPTIVE_MODE" IS AVAILABLE IN
	     * ARMCONSOLELOG.TXT.0
	     */
	    stepNumber++;
	    searchLogMessage = BroadBandCommonUtils.concatStringUsingStringBuffer(
	    ...
	    /**
	     * SETP 6 : VERIFY LOG INFORMATION "SSID_NAME_CHANGED" IS AVAILABLE IN WIFILOG.TXT.0
	     */
	    stepNumber++;
	    searchLogMessage = BroadBandCommonUtils.concatStringUsingStringBuffer(
	    ...
	    /**
	     * Step 7 : CONNECT THE CONNECTED CLIENT IN THE SETUP TO 2.4 GHz SSID AND VERIFY CONNECTION STATUS AFTER
	     * ACTIVATION FROM CAPTIVE PORTAL
	     */
	    stepNumber++;
	    ...
	    /**
	     * SETP 8- 11 : VERIFY THE CORRECT IPV4 AND IPV6 ADDRESS FOR CLIENT CONNECTED WITH 2.4 GHz AND INTERNET
	    ...
	    /**
	     * Step 13 : CONNECT THE CONNECTED CLIENT IN THE SETUP TO 5 GHz SSID AND VERIFY CONNECTION STATUS AFTER
	     * ACTIVATION FROM CAPTIVE PORTAL
	     */
	    stepNumber++;
	    BroadBandWiFiUtils.executeTestStepToConnectPrivateWiFi(device, testCaseId, deviceConnected,
	    ...
	    /**
	     * SETP 14- 17 : VERIFY THE CORRECT IPV4 AND IPV6 ADDRESS FOR CLIENT CONNECTED WITH 5 GHz AND INTERNET
	     * CONNECTIVITY USING IPV4 AND IPV6 INTERFACE.
	     */
	    stepNumber++;
	    BroadBandWiFiUtils.verifyIpv4AndIpV6ConnectionInterface(device, testCaseId, deviceConnected, stepNumber);
    ...
    *            Step Number
    * @param pattenMatcher
    *            Pattern Matcher for Log
    * @param searchLogMessage
    *            Search Message from Log file
    * @param logFile
    *            Log file to search
    * @refactor Govardhan
    */
