...
public class BroadbandIntranetConnectivityTest extends AutomaticsTestBase {
	...
	/**
	 * Verify the Ping operation is successful between 2.4 GHz and 5 GHz Private
	 * Wi-Fi clients
	 * <ol>
	 * <li>Verify the Private Wi-Fi SSIDs are enabled using WebPA</li>
	 * <li>Connect the client 1 to 2.4 GHz Private Wi-Fi Network and verify
	 * connection status</li>
	 * <li>Verify the IPv4 Address is retrieved from the client connected to 2.4GHz
	 * Private Wi-Fi Network</li>
	 * <li>Verify the IPv6 Address is retrieved from the client connected to 2.4GHz
	 * Private Wi-Fi Network</li>
	 * <li>Verify the internet is accessible in the client connected to 2.4 GHz
	 * Private Wi-Fi Network</li>
	 * <li>Connect the client 2 to 5 GHz Private Wi-Fi Network and verify connection
	 * status</li>
	 * <li>Verify the IP Address is retrieved from the client connected to 5GHz
	 * Private Wi-Fi Network</li>
	 * <li>Verify the IPv6 Address is retrieved from the client connected to 5 GHz
	 * Private Wi-Fi Network</li>
	 * <li>Verify the internet is accessible in the client connected to 5 GHz
	 * Private Wi-Fi Network</li>
	 * <li>Verify the Ping Connection for IPv4 Address is successful from 2.4GHz
	 * Wi-Fi client to 5GHz Wi-Fi client</li>
	 * <li>Verify the Ping Connection for IPv6 Address is successful from 2.4GHz
	 * Wi-Fi client to 5GHz Wi-Fi client</li>
	 * <li>Verify the Ping Connection for IPv4 Address is successful from 5GHz Wi-Fi
	 * client to 2.4GHz Wi-Fi client</li>
	 * <li>Verify the Ping Connection for IPv6 Address is successful from 5GHz Wi-Fi
	 * client to 2.4GHz Wi-Fi client</li>
	 * </ol>
	 * 
	...
	public void testToVerifyIntranetConnectivityBetween2GhzAnd5GhzWifiClientsUsingPing(Dut device) {
		...
		String ipv6AddressRetrievedFrom2GHzClient = null;
		String ipv6AddressRetrievedFrom5GHzClient = null;
		...
		try {
			...
			/**
			 * Step 3: Verify the IPv4 Address is retrieved from the client connected to
			 * 5GHz Private Wi-Fi Network
			 *
			 */
			testStepNumber = "s3";
			status = false;
			...
			/**
			 * Step 4: Verify the IPv6 Address is retrieved from the client connected to
			 * 5GHz Private Wi-Fi Network
			 *
			 */
			testStepNumber = "s4";
			...
			if (BroadbandPropertyFileHandler.isIpv6Enabled()) {
				...
				ipv6AddressRetrievedFrom5GHzClient = BroadBandConnectedClientUtils
			...
			result = BroadBandConnectedClientUtils.verifyInternetIsAccessibleInConnectedClientUsingCurl(tapEnv,
					connectedClient5GHzDut, BroadBandTestConstants.URL_WIKIPEDIA, BroadBandTestConstants.EMPTY_STRING);
			...
			/**
			 * Step 6: Connect the client 2 to 2.4 GHz Private Wi-Fi Network and verify
			 * connection status
			 * 
			 */
			testStepNumber = "s6";
			...
			try {
				connectedClient2GHzDut = BroadBandConnectedClientUtils.getOtherWiFiCapableClientDeviceAndConnect(device,
						tapEnv, connectedClient5GHzDut, BroadBandTestConstants.BAND_2_4GHZ);
			} catch (Exception e) {
				errorMessage = e.getMessage();
				LOGGER.error(errorMessage);
			}
			...
			/**
			 * Step 7: Verify the IPv4 Address is retrieved from the client connected to
			 * 5GHz Private Wi-Fi Network
			 *
			 */
			testStepNumber = "s7";
			...
			/**
			 * Step 8: Verify the IPv6 Address is retrieved from the client connected to
			 * 2.4GHz Private Wi-Fi Network
			 *
			 */
			testStepNumber = "s8";
			status = false;
			if (BroadbandPropertyFileHandler.isIpv6Enabled()) {
				...
				LOGGER.info(
						"STEP 8: EXPECTED: Local IPv6 Address assigned to the client should be retrieved successfully");
				ipv6AddressRetrievedFrom2GHzClient = BroadBandConnectedClientUtils
			...
			/**
			 * Step 9: Verify the internet is accessible in the client connected to 5 GHz
			 * Private Wi-Fi Network
			 * 
			 */
			testStepNumber = "s9";
			...
			result = BroadBandConnectedClientUtils.verifyInternetIsAccessibleInConnectedClientUsingCurl(tapEnv,
					connectedClient2GHzDut, BroadBandTestConstants.URL_WIKIPEDIA, BroadBandTestConstants.EMPTY_STRING);
			status = result.isStatus();
			errorMessage = result.getErrorMessage();
			if (status) {
			...
			/**
			 * Step 10: Verify the Ping Connection for IPv4 Address is successful from
			 * 2.4GHz Wi-Fi client to 5GHz Wi-Fi client
			 *
			 */
			testStepNumber = "s10";
			status = false;
			...
			/**
			 * Step 11: Verify the Ping Connection for IPv6 Address is successful from
			 * 2.4GHz Wi-Fi client to 5GHz Wi-Fi client
			 *
			 */
			testStepNumber = "s11";
			...
			/**
			 * Step 12: Verify the Ping Connection is successful from 5GHz Wi-Fi client to
			 * 2.4GHz Wi-Fi client
			 *
			 */
			testStepNumber = "s12";
			...
			/**
			 * Step 13: Verify the Ping Connection for IPv6 Address is successful from 5GHz
			 * Wi-Fi client to 2.4GHz Wi-Fi client
			 *
			 */
			testStepNumber = "s13";
			status = false;
	...
	/**
	 * Verify the Ping operation is successful between 2.4 GHz Private Wi-Fi and
	 * Ethernet client
	 * <ol>
	 ...
	 * Ethernet</li>
	 * <li>Verify the Ping Connection for IPv4 Address is successful from 2.4GHz
	 * Wi-Fi client to Ethernet Client</li>
	 * <li>Verify the Ping Connection for IPv6 Address is successful from 2.4GHz
	 * Wi-Fi client to Ethernet Client</li>
	 * <li>Verify the Ping Connection for IPv4 Address is successful from Ethernet
	 * client to 2.4GHz Wi-Fi client</li>
	 * <li>Verify the Ping Connection for IPv6 Address is successful from Ethernet
	 * client to 2.4GHz Wi-Fi client</li>
	 * </ol>
	 * 
	 * @author SATHYA KISHORE
	...
	public void testToVerifyIntranetConnectivityBetween2GhzAndEthernetClientUsingPing(Dut device) {
		...
		try {
			...
			/**
			 * Step 6: Verify the client 2 connected to ethernet has IPv4 Address assigned
			 * from DHCP
			 * 
			 */
			testStepNumber = "s6";
			...
			/**
			 * Step 9: Verify the Ping Connection for IPv4 Address is successful from 2.4GHz
			 * Wi-Fi client to Ethernet Client
			 *
			 */
			testStepNumber = "s9";
			status = false;
			 ...
			 * 2.4GHz Wi-Fi client to Ethernet Client
			 *
			 */
			testStepNumber = "s10";
			status = false;
			...
			/**
			 * Step 11: Verify the Ping Connection for IPv4 Address is successful from
			 * Ethernet client to 2.4GHz Wi-Fi client
			 *
			 */
			testStepNumber = "s11";
			status = false;
			...
			/**
			 * Step 12: Verify the Ping Connection for IPv6 Address is successful from
			 * Ethernet client to 2.4GHz Wi-Fi client
			 *
			 */
			testStepNumber = "s12";
	...
	/**
	 * Verify the Ping operation is successful between 5 GHz Private Wi-Fi and
	 * Ethernet client
	 * <ol>
	 * <li>Verify the 5 GHz Private Wi-Fi SSID is enabled using WebPA</li>
	 * <li>Connect the client 1 to 5 GHz Private Wi-Fi Network and verify connection
	 * status</li>
	 * <li>Verify the IPv4 Address is retrieved from the client connected to 5 GHz
	 * Private Wi-Fi Network</li>
	 * <li>Verify the IPv6 Address is retrieved from the client connected to 5 GHz
	 * Private Wi-Fi Network</li>
	 * <li>Verify the internet is accessible in the client connected to 5 GHz
	 ...
	 * <li>Verify the internet is accessible in the client connected to
	 * Ethernet</li>
	 * <li>Verify the Ping Connection for IPv4 Address is successful from 5 GHz
	 * Wi-Fi client to Ethernet Client</li>
	 * <li>Verify the Ping Connection for IPv6 Address is successful from 5 GHz
	 * Wi-Fi client to Ethernet Client</li>
	 * <li>Verify the Ping Connection for IPv4 Address is successful from Ethernet
	 * client to 5 GHz Wi-Fi client</li>
	 * <li>Verify the Ping Connection for IPv6 Address is successful from Ethernet
	 * client to 5 GHz Wi-Fi client</li>
	 * </ol>
	 * 
	...
	public void testToVerifyIntranetConnectivityBetween5GhzAndEthernetClientUsingPing(Dut device) {
		...
		try {
			...
			/**
			 * Step 2: Connect the client 1 to 5 GHz Private Wi-Fi Network and verify
			 * connection status
			 *
			 */
			testStepNumber = "s2";
			...
			/**
			 * Step 3: Verify the IPv4 Address is retrieved from the client connected to 5
			...
			/**
			 * Step 4: Verify the IPv6 Address is retrieved from the client connected to 5
			 * GHz Private Wi-Fi Network
			 *
			 */
			testStepNumber = "s4";
			...
			/**
			 * Step 9: Verify the Ping Connection for IPv4 Address is successful from 5 GHz
			 * Wi-Fi client to Ethernet Client
			 *
			 */
			testStepNumber = "s9";
			...
			/**
			 * Step 11: Verify the Ping Connection for IPv4 Address is successful from
			 * Ethernet client to 5 GHz Wi-Fi client
			 *
			 */
			testStepNumber = "s11";
			status = false;
	...
	/**
	 * Verify the Iperf operation is successful between 2.4 GHz and 5 GHz Private
	 * Wi-Fi clients
	 * <ol>
	 * <li>Verify the Private Wi-Fi SSIDs are enabled using WebPA</li>
	 * <li>Connect the client 1 to 2.4 GHz Private Wi-Fi Network and verify
	 ...
	 * <li>Verify the IP Address is retrieved from the client connected to 5GHz
	 * Private Wi-Fi Network</li>
	 * <li>Verify the IPv6 Address is retrieved from the client connecte to 5 GHz
	 * Private Wi-Fi Network</li>
	 * <li>Verify the internet is accessible in the client connected to 5 GHz
	 * Private Wi-Fi Network</li>
	 * <li>Verify the Iperf Server is hosted in the client connected to 2.4GHz
	 * Private Wi-Fi network</li>
	 * <li>Verify the Iperf traffic is successful from 5GHz Wi-Fi client to 2.4GHz
	 * Wi-Fi client</li>
	 * <li>Verify the Iperf Server is hosted in the client connected to 5GHz Private
	 * Wi-Fi network</li>
	 * <li>Verify the Iperf traffic is successful from 2.4GHz Wi-Fi client to 5GHz
	 * Wi-Fi client</li>
	 * </ol>
	 * 
	 * @author SATHYA KISHORE
	...
	public void testToVerifyIntranetConnectivityBetween2GhzAnd5GhzWifiClientsUsingIperf(Dut device) {
		...
		try {
			...
			status = CommonMethods.isNotNull(response1) && response1.equals(BroadBandTestConstants.TRUE)
					&& CommonMethods.isNotNull(response2) && response2.equals(BroadBandTestConstants.TRUE);
			if (!status) {
				status = BroadBandConnectedClientUtils.enableOrDisableRadiosForGivenSsidUsingWebPaCommand(
						WiFiFrequencyBand.WIFI_BAND_2_GHZ, tapEnv, device, true)
						&& BroadBandConnectedClientUtils.enableOrDisableRadiosForGivenSsidUsingWebPaCommand(
			...
			/**
			 * Step 6: Connect the client 2 to 5 GHz Private Wi-Fi Network and verify
			 * connection status
			 * 
			 */
			testStepNumber = "s6";
			...
			errorMessage = "Unable to connect to 5 GHz private Wi-Fi Network Or 5 GHz WiFi capable devices are not available";
			try {
				connectedClient5GHzDut = BroadBandConnectedClientUtils.getOtherWiFiCapableClientDeviceAndConnect(device,
						tapEnv, connectedClient2GHzDut, BroadBandTestConstants.BAND_5GHZ);
			} catch (Exception e) {
				errorMessage = e.getMessage();
				LOGGER.error(errorMessage);
			}
			...
			/**
			 * Step 10: Verify the Iperf Server is hosted in the client connected to 2.4GHz
			 * Private Wi-Fi network
			 *
			 */
			testStepNumber = "s10";
			...
			String response = tapEnv.executeCommandOnOneIPClients(connectedClient2GHzDut, commandToCheckIperfProcess);
			...
			/**
			 * Step 11: Verify the Iperf traffic is successful from 5GHz Wi-Fi client to
			 * 2.4GHz Wi-Fi client
			 *
			 */
			testStepNumber = "s11";
			...
			/**
			 * Step 12: Verify the Iperf Server is hosted in the client connected to 5GHz
			 * Private Wi-Fi network
			 *
			 */
			testStepNumber = "s12";
			...
			/**
			 * Step 13: Verify the Iperf traffic is successful from 5GHz Wi-Fi client to
			 * 2.4GHz Wi-Fi client
			 *
			 */
			testStepNumber = "s13";
	...
	/**
	 * Verify the Iperf operation is successful between 2.4 GHz Private Wi-Fi and
	 * Ethernet clients
	 * <ol>
	 * <li>Verify the 2.4 GHz Private Wi-Fi SSID is enabled using WebPA</li>
	 * <li>Connect the client 1 to 2.4 GHz Private Wi-Fi Network and verify
	 ...
	 * <li>Verify the Iperf Server is hosted in the client connected to 2.4GHz
	 * Private Wi-Fi network</li>
	 * <li>Verify the Iperf traffic is successful from Ethernet client to 2.4GHz
	 * Wi-Fi client</li>
	 * <li>Verify the Iperf Server is hosted in the client connected to
	 * Ethernet</li>
	 * <li>Verify the Iperf traffic is successful from 2.4GHz Wi-Fi client to
	 * Ethernet client</li>
	 * </ol>
	 * 
	 * @author SATHYA KISHORE
	...
	public void testToVerifyIntranetConnectivityBetween2GhzAndEthernetClientUsingIperf(Dut device) {
		...
		try {
			...
			/**
			 * Step 9: Verify the Iperf Server is hosted in the client connected to 2.4GHz
			 * Private Wi-Fi network
			 *
			 */
			testStepNumber = "s9";
			...
			/**
			 * Step 10: Verify the Iperf traffic is successful from Ethernet client to
			 * 2.4GHz Wi-Fi client
			 *
			 */
			testStepNumber = "s10";
			...
			/**
			 * Step 11: Verify the Iperf Server is hosted in the client connected to
			 * Ethernet
			 *
			 */
			testStepNumber = "s11";
			...
			/**
			 * Step 12: Verify the Iperf traffic is successful from 2.4GHz Wi-Fi client to
			 * Ethernet client
			 *
			 */
			testStepNumber = "s12";
	...
	/**
	 * Verify the Iperf operation is successful between 5 GHz Private Wi-Fi and
	 * Ethernet clients
	 * <ol>
	 * <li>Verify the 5 GHz Private Wi-Fi SSID is enabled using WebPA</li>
	 * <li>Connect the client 1 to 5 GHz Private Wi-Fi Network and verify connection
	 * status</li>
	 * <li>Verify the IPv4 Address is retrieved from the client connected to 5GHz
	 * Private Wi-Fi Network</li>
	 * <li>Verify the IPv6 Address is retrieved from the client connected to 5GHz
	 * Private Wi-Fi Network</li>
	 * <li>Verify the internet is accessible in the client connected to 5 GHz
	 * Private Wi-Fi Network</li>
	 * <li>Verify the client 2 connected to ethernet has IPv4 Address assigned from
	 ...
	 * <li>Verify the Iperf Server is hosted in the client connected to 5GHz Private
	 * Wi-Fi network</li>
	 * <li>Verify the Iperf traffic is successful from Ethernet client to 5GHz Wi-Fi
	 * client</li>
	 * <li>Verify the Iperf Server is hosted in the client connected to
	 * Ethernet</li>
	 * <li>Verify the Iperf traffic is successful from 5GHz Wi-Fi client to Ethernet
	 * client</li>
	 * </ol>
	 * 
	 * @author SATHYA KISHORE
	...
	public void testToVerifyIntranetConnectivityBetween5GhzAndEthernetClientUsingIperf(Dut device) {
		...
		try {
			...
			/**
			 * Step 9: Verify the Iperf Server is hosted in the client connected to 5GHz
			 * Private Wi-Fi network
			 *
			 */
			testStepNumber = "s9";
			...
			String commandToCheckIperfProcess = ((Device) connectedClient5GHzDut).isWindows()
					? BroadBandCommandConstants.CMD_TO_CHECK_IPERF_PROCESS_IN_WINDOWS
					: BroadBandCommandConstants.CMD_TO_CHECK_IPERF_PROCESS_IN_LINUX;
			String response = tapEnv.executeCommandOnOneIPClients(connectedClient5GHzDut, commandToCheckIperfProcess);
			status = CommonMethods.isNotNull(response) && CommonUtils.patternSearchFromTargetString(response,
					BroadBandTestConstants.PATTERN_TO_CHECK_IPERF_PROCESS);
			String processId = null;
			if (status) {
			...
			/**
			 * Step 10: Verify the Iperf traffic is successful from Ethernet client to 5GHz
			 * Wi-Fi client
			 *
			 */
			testStepNumber = "s10";
			...
			/**
			 * Step 12: Verify the Iperf traffic is successful from 5GHz Wi-Fi client to
			 * Ethernet client
			 *
			 */
			testStepNumber = "s12";
