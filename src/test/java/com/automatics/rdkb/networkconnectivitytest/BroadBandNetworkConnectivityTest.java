...
public class BroadBandNetworkConnectivityTest extends AutomaticsTestBase {
	...
	public void testNetworkConnectivityForDefaultValuesUsingWebpa(Dut device) {
		...
		try {
			...
			status = CommonMethods.isNotNull(response) && response
					.equalsIgnoreCase(BroadbandPropertyFileHandler.getResourceUsageComputeWindowFromProperty());
	...
	/**
	 * Test case is created as part of COVERAGE AUTOMATION based on the Ping Server
	 * to detect network connectivity and Connectivity test using Gateway IP
	 * 
	 * 
	...
	public void validPingServerConnectivityTest(Dut device) {
		...
		try {
			...
			if (BroadbandPropertyFileHandler.isIpv6Enabled()) {
				...
				pingServersTable.clear();
				pingServers.clear();
				ipv6PingServer = BroadBandNetworkConnectivityUtils.retrievePingServerUsingNslookUpForIpv6(device,
						tapEnv);
	...
	/**
	 * Test case is created as part of COVERAGE AUTOMATION . Ping Server to detect
	 * network connectivity and Connectivity test using Gateway IP
	 * 
	 * 
	 * TC-RDKB-NW-CONNECTIVITY-1005: Verify whether valid ping servers are set for
	 * the ping servers by Webpa and the ping success logs are captured in
	 * selfHeallog.txt.0 by snmp
	 *
	 * <ol>
	 * <li>S1)Verify adding the IPV4 ping server table 1 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.1.1.3.1).</li>
	 * <li>S2)Verify setting the IPV4 ping server1 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.1.1.2.1) 'to valid ipv4 ping server.</li>
	 * <li>S3)Verify adding the IPV4 ping server table 2 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.1.1.3.2).</li>
	 * <li>S4)Verify setting the IPV4 ping server2 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.1.1.2.2) to valid ipv4 ping server.</li>
	 * <li>S5)Verify adding the IPV4 ping server table 3 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.1.1.3.3).</li>
	 * <li>S6)Verify setting the IPV4 ping server3 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.1.1.2.3) to valid ipv4 ping server.</li>
	 * <li>S7)Verify adding the IPV6 ping server table 1 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.2.1.3.1).</li>
	 * <li>S8)Verify setting the IPV6 ping server1 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.2.1.2.1) to valid ipv6 ping server</li>
	 * <li>S9)Verify adding the IPV6 ping server table 2 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.2.1.3.2).</li>
	 * <li>S10)Verify setting the IPV6 ping server2 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.2.1.2.2) to valid ipv6 ping server.</li>
	 * <li>S11)Verify adding the IPV6 ping server table 3 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.2.1.3.3).</li>
	 * <li>S12)Verify setting the IPV6 ping server3 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.2.1.2.3) to valid ipv6 ping server.</li>
	 * <li>S13)verify whether 'Connectivity Test is Successfull' message is present
	 * in self heallog.txt.0 after the setting the Valid servers by snmp.</li>
	 * <li>S14)verify whether 'GW IP Connectivity Test Successfull' mesage is
	 * present in rdklogs/logs/selfheallog.txt.0 by snmp.</li>
	 * </ol>
	 *
	 * @author Joseph Maduram
	 * @refactor anandam
	...
	public void validPingServerConnectivityTestbySnmp(Dut device) {
		...
		try {
			...
			/**
			 * STEP 1:Verify adding the IPV4 ping server table 1 using SNMP OID
			 * (.1.3.6.1.4.1.17270.44.1.1.6.1.1.3.1).
			 * 
			 */
			...
			/**
			 * STEP 2:Verify setting the IPV4 ping server1 using SNMP OID
			 * (.1.3.6.1.4.1.17270.44.1.1.6.1.1.2.1) to valid ipv4 ping server.
			 * 
			 */
			testStepNumber = "s2";
			status = false;
			...
			/**
			 * STEP 3:Verify adding the IPV4 ping server table 2 using SNMP OID
			 * (.1.3.6.1.4.1.17270.44.1.1.6.1.1.3.2).
			 * 
			 */
			tapEnv.waitTill(BroadBandTestConstants.ONE_MINUTE_IN_MILLIS);
			testStepNumber = "s3";
			...
			/**
			 * STEP 4:Verify setting the IPV4 ping server2 using SNMP OID
			 * (.1.3.6.1.4.1.17270.44.1.1.6.1.1.2.2) to valid ipv4 ping server.
			 * 
			 */
			testStepNumber = "s4";
			status = false;
			...
			/**
			 * STEP 5:Verify adding the IPV4 ping server table 3 using SNMP OID
			 * (.1.3.6.1.4.1.17270.44.1.1.6.1.1.3.3).
			 * 
			 */
			tapEnv.waitTill(BroadBandTestConstants.ONE_MINUTE_IN_MILLIS);
			testStepNumber = "s5";
			...
			/**
			 * STEP 6:Verify setting the IPV4 ping server3 using SNMP OID
			 * (.1.3.6.1.4.1.17270.44.1.1.6.1.1.2.3) to valid ipv4 ping server.
			 * 
			 */
			testStepNumber = "s6";
			status = false;
			...
			/**
			 * STEP 7:Verify adding the IPV6 ping server table 1 using SNMP OID
			 * (.1.3.6.1.4.1.17270.44.1.1.6.2.1.3.1).
			 * 
			 */
			tapEnv.waitTill(BroadBandTestConstants.ONE_MINUTE_IN_MILLIS);
			testStepNumber = "s7";
			...
			/**
			 * STEP 8:Verify setting the IPV6 ping server1 using SNMP OID
			 * (.1.3.6.1.4.1.17270.44.1.1.6.2.1.2.1) to valid ipv6 ping server.
			 * 
			 */
			...
			if (BroadbandPropertyFileHandler.isIpv6Enabled()) {
				...
				LOGGER.info("IPv6 is not available/disabled : Skipping Step 8 and 9 ...");
				tapEnv.updateExecutionForAllStatus(device, testId, testStepNumber, ExecutionStatus.NOT_APPLICABLE,
						errorMessage, false);
			}
			...
			/**
			 * STEP 14 :verify whether "GW IP Connectivity Test Successfull" message is
			 * present in rdklogs/logs/selfheallog.txt.0 .
			 */
			testStepNumber = "s14";
			errorMessage = "Gateway connectivity success message is not logged in the self heal window";
			...
			/**
			 * STEP 15 :verify whether 'Connectivity Test is Successfull' message is present
			 * in self heallog.txt.0 in the next cycle for set ping interval time of 15 mins
			 */
			testStepNumber = "s15";
			errorMessage = "Ping server connectivity success message is not logged in the next cycle self heal window for set ping interval time of 15 mins";
	 ...
	 * 
	 * 
	 * Test Case : TC-RDKB-NW-CONNECTIVITY-1006: Verify whether Invalid Ping servers
	 * are set for the ping servers by Webpa and the ping failure logs are captured
	 * in selfHeallog.txt.0
	 *
	 * <p>
	 * STEPS:
	 * </p>
	 ...
	 * 'Device.SelfHeal.ConnectivityTest.X_RDKCENTRAL-COM_pingInterval'using
	 * WebPA.</li>
	 * <li>STEP 1.Verify adding the IPV4 ping server table 1 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.1.1.3.1).</li>
	 * <li>STEP 2.Verify setting the IPV4 ping server1 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.1.1.2.1) as '1.2.3.4'.</li>
	 * <li>STEP 3.Verify adding the IPV4 ping server table 2 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.1.1.3.2).</li>
	 * <li>STEP 4.Verify setting the IPV4 ping server2 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.1.1.2.2) as '2.3.4.5'.</li>
	 * <li>STEP 5.Verify adding the IPV4 ping server table 3 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.1.1.3.3).</li>
	 * <li>STEP 6.Verify setting the IPV4 ping server3 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.1.1.2.3) as '3.4.5.6'.</li>
	 * <li>STEP 7.Verify adding the IPV6 ping server table 1 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.2.1.3.1).</li>
	 * <li>STEP 8.Verify setting the IPV6 ping server1 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.2.1.2.1) as '2001::2002'.</li>
	 * <li>STEP 9.Verify adding the IPV6 ping server table 2 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.2.1.3.2).</li>
	 * <li>STEP 10.)Verify setting the IPV6 ping server2 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.2.1.2.2) as'2002::2003'.</li>
	 * <li>STEP 11.Verify adding the IPV6 ping server table 3 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.2.1.3.3).</li>
	 * <li>STEP 12.Verify setting the IPV6 ping server3 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.2.1.2.3) as'2003::2004'.</li>
	 * <li>STEP 13.verify whether "PING_FAILED:1.2.3.4" message is present in self
	 * heallog.txt.0 after the setting of Invalid ping servers.</li>
	 * <li>STEP 14.verify whether "PING_FAILED:2.3.4.5" message is present in self
	 * heallog.txt.0 after the setting ofInvalid ping servers.</li>
	 * <li>STEP 15.verify whether "PING_FAILED:3.4.5.6" message is present in self
	 * heallog.txt.0 after the setting ofInvalid ping servers.</li>
	 * <li>STEP 16.verify whether "PING_FAILED:2001:2002" message is present in self
	 * heallog.txt.0 after the setting ofInvalid ping servers.</li>
	 * <li>STEP 17.verify whether "PING_FAILED:2002:2003" message is present in self
	 * heallog.txt.0 after the setting ofInvalid ping servers.</li>
	 * <li>STEP 18.verify whether "PING_FAILED:2003:2004" message is present in self
	 * heallog.txt.0 after the setting ofInvalid ping servers.</li>
	 * <li>STEP 19.verify whether "Ping failure" message is present in
	 * rdklogs/logs/selfheallog.txt.0 after the setting theInvalid servers.</li>
	 * <li>STEP 20.:Verify whether 'PING_FAILED:6' message is present in
	 * rdklogs/logs/dcmscript.log after getting the pingfailure log messages</li>
	 * <li>POST-CONDITION 1 : Clear/Reset the table row of ipv4 by adding a single
	 * table row.</li>
	 * <li>POST-CONDITION 2 : Clear/Reset the table row of ipv6 by adding a single
	 * table row.</li>
	 * <li>POST-CONDITION 3 : Delete the added ipv4 ping servers in the Ping Server
	 * Table by using WEBPA DELETE command.</li>
	 * <li>POST-CONDITION 4 : Delete the added ipv6 ping servers in the Ping Server
	 * Table by using WEBPA DELETE command.</li>
	 * <li>POST-CONDITION 5 : Begin clear telemetry configuration on the
	 * device.</li>
	...
	public void invalidPingServerConnectivityTestbySnmp(Dut device) {
		...
		try {
			...
			/**
			 * STEP 2:Verify setting the IPV4 ping server 1 using SNMP OID
			 * (.1.3.6.1.4.1.17270.44.1.1.6.1.1.2.1) as '1.2.3.4'.
			 * 
			 */
			stepNumber++;
			step = "S" + stepNumber;
			...
			/**
			 * STEP 4:Verify setting the IPV4 ping server 2 using SNMP OID
			 * (.1.3.6.1.4.1.17270.44.1.1.6.1.1.2.2) as '2.3.4.5'.
			 * 
			 */
			stepNumber++;
			step = "S" + stepNumber;
			...
			/**
			 * STEP 6:Verify setting the IPV4 ping server 3 using SNMP OID
			 * (.1.3.6.1.4.1.17270.44.1.1.6.1.1.2.3) as '3.4.5.6'.
			 * 
			 */
			stepNumber++;
			step = "S" + stepNumber;
			...
			if (BroadbandPropertyFileHandler.isIpv6Enabled()) {
				...
				if (status) {
					LOGGER.info("STEP " + stepNumber
							+ " : ACTUAL : Successfully Added the IPV6 ping server table1 using SNMP");
				} else {
					LOGGER.error("STEP " + stepNumber + ": ACTUAL : " + errorMessage);
				}
				LOGGER.info("******************************************************************************");
			...
			/**
			 * STEP 8:Verify setting the IPV6 ping server1 using SNMP OID
			 * (.1.3.6.1.4.1.17270.44.1.1.6.2.1.2.1) as '2001::2002'.
			 * 
			 */
			stepNumber++;
			step = "S" + stepNumber;
			...
			if (BroadbandPropertyFileHandler.isIpv6Enabled()) {
				...
				/**
				 * STEP 10:Verify setting the IPV6 ping server2 using SNMP OID
				 * (.1.3.6.1.4.1.17270.44.1.1.6.2.1.2.2) as '2002::2003'
				 * 
				 */
				stepNumber++;
				step = "S" + stepNumber;
				...
				if (BroadbandPropertyFileHandler.isIpv6Enabled()) {
					...
					LOGGER.info(
							"STEP " + stepNumber + ":  EXPECTED : Should  be able to add the IPV6 ping server table 3");
					LOGGER.info(
							"***************************************************************************************");
					errorMessage = "Unable to Add the IPV6 ping server table3 using SNMP";
					status = BroadBandSnmpUtils.executeSnmpSetCommand(tapEnv, device,
					...
					if (status) {
						LOGGER.info("STEP " + stepNumber
								+ " : ACTUAL : Successfully Added the IPV6 ping server table3 using SNMP");
					} else {
						LOGGER.error("STEP " + stepNumber + ": ACTUAL : " + errorMessage);
					}
					LOGGER.info("******************************************************************************");
				...
				/**
				 * STEP 12:Verify setting the IPV6 ping server3 using SNMP OID
				 * (.1.3.6.1.4.1.17270.44.1.1.6.2.1.2.3) as '2003::2004'.
				 * 
				 */
				stepNumber++;
				step = "S" + stepNumber;
				...
				/**
				 * STEP 13 :verify whether "PING_FAILED:1.2.3.4" message is present in self
				 * heallog.txt.0 after the setting of Invalid ping servers.
				 */
				stepNumber++;
				step = "S" + stepNumber;
				status = false;
				...
				/**
				 * STEP 14 :verify whether "PING_FAILED:2.3.4.5" message is present in self
				 * heallog.txt.0 after the setting the Invalid ping servers.
				 */
				stepNumber++;
				step = "S" + stepNumber;
				status = false;
				...
				/**
				 * STEP 15 : Verify whether 'PING_FAILED:3.4.5.6' message is present in self
				 * heallog.txt.0 after the setting the InValid servers.
				 */
				stepNumber++;
				step = "S" + stepNumber;
				...
				/**
				 * STEP 16 :verify whether "PING_FAILED:2001:2002" message is present in self
				 * heallog.txt.0 after the setting the InValid servers.
				 */
				stepNumber++;
				step = "S" + stepNumber;
				...
				/**
				 * STEP 17 :verify whether "PING_FAILED:2002:2003" message is present in self
				 * heallog.txt.0 after the setting the InValid servers.
				 */
				stepNumber++;
				step = "S" + stepNumber;
				...
				/**
				 * STEP 18 :verify whether "PING_FAILED:2003:2004" message is present in self
				 * heallog.txt.0 after the setting the InValid servers.
				 */
				stepNumber++;
				step = "S" + stepNumber;
				...
				/**
				 * STEP 19 :verify whether "Ping failure" message is present in
				 * rdklogs/logs/selfheallog.txt.0 after the setting the Invalid servers.
				 */
				stepNumber++;
				step = "S" + stepNumber;
				...
				/**
				 * S20)Verify whether 'PING_FAILED:6' message is present in
				 * rdklogs/logs/dcmscript.log after getting the ping failure log messages
				 */
				stepNumber++;
				step = "S" + stepNumber;
			...
			/**
			 * POST-CONDITION 1: Clear/Reset the table row of ipv4 by adding a single table
			 * row
			 */
			postCondition++;
			LOGGER.info("#######################################################################################");
			...
			/**
			 * POST-CONDITION 2: Clear/Reset the table row of ipv6 by adding a single table
			 * row
			 */
			postCondition++;
			LOGGER.info("#######################################################################################");
			...
			/**
			 * POST-CONDITION 3: Delete the added ipv4 ping servers in the Ping Server Table
			 * by using WEBPA DELETE command.
			 */
			postCondition++;
			LOGGER.info("#######################################################################################");
			LOGGER.info("POST-CONDITION " + postCondition
			...
			/**
			 * POST-CONDITION 4: Delete the added ipv6 ping servers in the Ping Server Table
			 * by using WEBPA DELETE command.
			 */
			postCondition++;
			LOGGER.info("#######################################################################################");
		...
		try {
			...
			status = BroadBandCommonUtils
					.searchLogFiles(tapEnv, device, BroadBandTraceConstants.DATA_BLOCK_SIZE_LOG_MESSAGE,
							logFileSecuresyscfg, BroadBandTestConstants.ONE_MINUTE_IN_MILLIS,
							BroadBandTestConstants.THIRTY_SECOND_IN_MILLIS)
			...
			LOGGER.info(
					"STEP 2 :  ACTUAL:" + (status ? "ping DatablockSize is logged in syscfg.db file" : errorMessage));
			tapEnv.updateExecutionStatus(device, testId, testStepNumber, status, errorMessage, true);
		}
	...
	/**
	 * 
	 * TC-RDKB-NW-CONNECTIVITY-1010: Verify whether the Invalid ping servers and
	 * valid ping servers are set by SNMP and it's failure messages are logged when
	 * the ping fails in selfHeal log
	 *
	 * <ol>
	 * <li>S1)Verify adding the IPV4 ping server table 1 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.1.1.3.1).</li>
	 * <li>S2)Verify setting the IPV4 ping server 1 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.1.1.2.1) as '1.2.3.4'</li>
	 * <li>S3)Verify adding the IPV4 ping server table 2 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.1.1.3.2).</li>
	 * <li>S4)Verify setting the IPV4 ping server 2 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.1.1.2.2) as '2.3.4.5'</li>
	 * <li>S5)Verify adding the IPV4 ping server table 3 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.1.1.3.3).</li>
	 * <li>S6)Verify setting the IPV4 ping server table 3 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.1.1.2.1)</li>
	 * <li>S7)Verify adding the IPV6 ping server table 1 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.2.1.3.1).</li>
	 * <li>S8)Verify setting the IPV6 ping server 1 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.2.1.2.1) as '2001::2002'.</li>
	 * <li>S9)Verify adding the IPV6 ping server table 2 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.2.1.3.2).</li>
	 * <li>S10)Verify setting the IPV6 ping server 2 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.2.1.2.2) as '2002::2003'</li>
	 * <li>S11)Verify adding the IPV6 ping server table 3 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.2.1.3.3).</li>
	 * <li>S12)Verify setting the IPV6 ping server table 3 using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.6.1.1.2.1)</li>
	 * <li>S13)verify whether "PING_FAILED:1.2.3.4" message is present in self
	 * heallog.txt.0 after the setting the InValid servers.</li>
	 * <li>S14)verify whether 'PING_FAILED:2.3.4.5' message is present in self
	 * heallog.txt.0 after the setting the InValid servers.</li>
	 * <li>S15)verify whether 'PING_FAILED:2001::2002' message is present in self
	 * heallog.txt.0 after the setting the InValid servers.</li>
	 * <li>S16)verify whether 'PING_FAILED:2002::2003' message is present in self
	 * heallog.txt.0 after the setting the InValid servers.</li>
	 * <li>S17)verify whether 'Connectivity successfull' message is present in
	 * rdklogs/logs/selfheallog.txt.0 after the setting the Invalid servers.</li>
	 * </ol>
	 *
	 * @author Joseph Maduram
	...
	public void invalidAndValidPingServerConnectivityTestBySnmp(Dut device) {
		...
		try {
			...
			/**
			 * STEP 12:Verify setting the IPV4 ping server3 using SNMP OID
			 * (.1.3.6.1.4.1.17270.44.1.1.6.1.1.2.1) to valid ipv4 ping server.
			 * 
			 */
			testStepNumber = "s12";
			...
			/**
			 * STEP 15 :verify whether "PING_FAILED:2001::2002" message is present in self
			 * heallog.txt.0 after the setting the InValid servers.
			 */
			testStepNumber = "s15";
			status = false;
			if (BroadbandPropertyFileHandler.isIpv6Enabled()) {
				...
				try {
					...
					errorMessage = exception.getMessage();
					LOGGER.error(
							"error occured while checking the 'PING_FAILED:2001::2002' message in self heallog.txt.0  "
									+ errorMessage);
				}
				errorMessage = "'PING_FAILED:2001::2002' failure message  is not logged in the next self heal window";
			...
			/**
			 * STEP 16 :verify whether "PING_FAILED:2002::2003" message is present in self
			 * heallog.txt.0 after the setting the InValid servers.
			 */
			testStepNumber = "s16";
			status = false;
			if (BroadbandPropertyFileHandler.isIpv6Enabled()) {
				...
				try {
					...
					errorMessage = exception.getMessage();
					LOGGER.error(
							"error occured while checking the 'PING_FAILED:2002::2003' message in self heallog.txt.0  "
									+ errorMessage);
				}
				errorMessage = "'PING_FAILED:2002:2003' failure message  is not logged in the next self heal window";
			...
			/**
			 * STEP 17 :verify whether "Connectivity successfull" message is present in
			 * rdklogs/logs/selfheallog.txt.0 after the setting the Invalid servers.
			 */
			testStepNumber = "s17";
			status = false;
	 ...
	 * 
	 * 
	 * TC-RDKB-NW-CONNECTIVITY-1002: Verify the ping related default values in the
	 * device after factory resetting by SNMP.
	 *
	 * <ol>
	 ...
	 * <li>S2) Verify retrieving the value of
	 ...
	 * <li>S3) Verify retrieving the value
	 ...
	 * <li>S4) Verify retrieving the value
	 ...
	 * <li>S5) Verify retrieving the value
	 * ofDevice.SelfHeal.ResourceMonitor.X_RDKCENTRAL-COM_UsageComputeWindow to get
	 * the resourceUsageComputeWindow using SNMP OID
	 * (.1.3.6.1.4.1.17270.44.1.1.7.0)</li>
	 * <li>S6) Verify retrieving the value
	 ...
	 * <li>S7) Verify retrieving the value
	 ...
	 * <li>S8) Verify retrieving the value
	...
	public void connectivityTestDefaultSettingBySnmp(Dut device) {
		...
		try {
			...
			/**
			 * STEP 1:Verify retrieving the value of
			 * Device.SelfHeal.ConnectivityTest.X_RDKCENTRAL-COM_NumPingsPerServer using
			...
			/**
			 * STEP 2:Verify retrieving the value of
			 * Device.SelfHeal.ConnectivityTest.X_RDKCENTRAL-COM_MinNumPingServer to get the
			...
			/**
			 * STEP 3:Verify retrieving the value
			 * ofDevice.SelfHeal.ConnectivityTest.X_RDKCENTRAL-COM_pingInterval to get the
			...
			/**
			 * STEP 4:Verify retrieving the value
			 * ofDevice.SelfHeal.ConnectivityTest.X_RDKCENTRAL-COM_PingRespWaitTime to get
			...
			/**
			 * STEP 5:Verify retrieving the value of
			...
			/**
			 * STEP 6:Verify retrieving the value
			 * ofDevice.SelfHeal.ResourceMonitor.X_RDKCENTRAL-COM_AvgCPUThreshold to get the
			...
			/**
			 * STEP 7:Verify retrieving the value
			 * ofDevice.SelfHeal.ResourceMonitor.X_RDKCENTRAL-COM_AvgMemoryThreshold to get
			...
			/**
			 * STEP 8:Verify retrieving the value
			 * ofDevice.SelfHeal.X_RDKCENTRAL-COM_MaxRebootCount to get the MaxRebootCount
			...
			/**
			 * STEP 9:Verify retrieving the value
			 * ofDevice.SelfHeal.X_RDKCENTRAL-COM_MaxResetCount to get the MaxResetCount
			...
			/**
			 * STEP 10:Verify retrieving the value
			 * ofDevice.SelfHeal.ConnectivityTest.X_RDKCENTRAL-COM_pingInterval to Set the
			...
			/**
			 * STEP 11:Verify retrieving the value
			 * ofDevice.SelfHeal.ConnectivityTest.X_RDKCENTRAL-COM_pingInterval to Set the
			...
			/**
			 * STEP 12:Verify retrieving the value
			 * ofDevice.SelfHeal.ConnectivityTest.X_RDKCENTRAL-COM_pingInterval to Set the
			 * pingInterval as 1441 using SNMP OID (.1.3.6.1.4.1.17270.44.1.1.4.0)
			 */
			testStepNumber = "s12";
